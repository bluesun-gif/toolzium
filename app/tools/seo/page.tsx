...
const CATEGORY_ID = "seo";
const TITLE = "Free Online SEO Tools — Meta Tag Generator & Schema Builder | Toolzium";
const DESCRIPTION = "Boost search rankings with free SEO tools. Generate meta tags, build Open Graph previews, create JSON-LD schema markup, and generate robots.txt.";
const PATH = "/tools/seo";
