...
export default function Page() {
  ...
  return (<div className="space-y-4"><JsonLd data={appLd} /><JsonLd data={crumbsLd} /><JsonLd data={faqLd} /><NatoPhoneticPasswordClient />
      <RelatedTools currentToolUrl="/tools/util/nato-phonetic-password" />
</div>);
}
