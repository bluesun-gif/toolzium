...
export default function Page() {
  ...
  return (<div className="space-y-4"><JsonLd data={appLd} /><JsonLd data={crumbsLd} /><JsonLd data={faqLd} /><PatternTileMemoryClient />
      <RelatedTools currentToolUrl="/tools/fun/pattern-tile-memory" />
</div>);
}
