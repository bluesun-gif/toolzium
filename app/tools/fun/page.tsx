...
const CATEGORY_ID = "fun";
const TITLE = "Fun Online Tools & Games — Random Pickers & Decision Makers | Toolzium";
const DESCRIPTION = "Entertaining web utilities, random name pickers, decision makers, coin flippers, and novelty tools for fun and games.";
