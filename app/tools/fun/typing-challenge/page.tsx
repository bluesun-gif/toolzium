...
export const metadata = buildMetadata({
  title: "Speed Typing Challenge | Toolzium",
  description: "Interactive speed typing test with WPM meter and accuracy tracking.",
  path: "/tools/fun/typing-challenge",
  keywords: ["typing test", "speed typing", "wpm meter", "typing challenge"],
});
...
export default function Page() {
  ...
  return (<div className="space-y-4"><JsonLd data={appLd} /><JsonLd data={crumbsLd} /><JsonLd data={faqLd} /><TypingChallengeClient /></div>);
}
