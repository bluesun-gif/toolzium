...
export default function Page() {
  ...
  return (<div className="space-y-4"><JsonLd data={appLd} /><JsonLd data={crumbsLd} /><JsonLd data={faqLd} /><WordAssociationClient />
      <RelatedTools currentToolUrl="/tools/fun/word-association" />
</div>);
}
