...
<<<<<<< HEAD
  return (<div className="space-y-4"><JsonLd data={appLd} /><JsonLd data={crumbsLd} /><DailyPriorityActionBoardClient />
      <RelatedTools currentToolUrl="/tools/productivity/daily-priority-action-board" />
</div>);
=======
