...
export default function Page() {
  ...
  return (<div className={"space-y-4"}><JsonLd data={appLd} /><JsonLd data={crumbsLd} /><JsonLd data={faqLd} /><EisenhowerChecklistClient />
      <RelatedTools currentToolUrl="/tools/productivity/eisenhower-checklist" />
</div>);
}
