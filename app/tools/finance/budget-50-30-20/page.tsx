...
export default function Page() {
  ...
  return (<div className="space-y-4"><JsonLd data={appLd} /><JsonLd data={crumbsLd} /><JsonLd data={faqLd} /><Budget503020Client />
      <RelatedTools currentToolUrl="/tools/finance/budget-50-30-20" />
</div>);
}
