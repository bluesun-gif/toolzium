...
export default function Page() {
  ...
  return (<div className="space-y-4"><JsonLd data={appLd} /><JsonLd data={crumbsLd} /><JsonLd data={faqLd} /><InvoiceTrackerClient />
      <RelatedTools currentToolUrl="/tools/finance/invoice-tracker" />
</div>);
}
