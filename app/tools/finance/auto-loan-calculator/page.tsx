...
export default function Page() {
  ...
  return (<div className="space-y-4"><JsonLd data={appLd} /><JsonLd data={crumbsLd} /><JsonLd data={faqLd} /><AutoLoanCalculatorClient />
      <RelatedTools currentToolUrl="/tools/finance/auto-loan-calculator" />
</div>);
}
