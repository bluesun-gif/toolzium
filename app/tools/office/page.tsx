...
const CATEGORY_ID = "office";
const TITLE = "Free Online Office & Productivity Tools | Toolzium";
const DESCRIPTION = "Streamline daily business and office tasks with free online document, formatting, organization, and calculation utilities.";
const PATH = "/tools/office";
