...
export default function Page() {
  ...
  return (<div className="space-y-4"><JsonLd data={appLd} /><JsonLd data={crumbsLd} /><JsonLd data={faqLd} /><SowContractorBuilderClient />
      <RelatedTools currentToolUrl="/tools/office/sow-contractor-builder" />
</div>);
}
