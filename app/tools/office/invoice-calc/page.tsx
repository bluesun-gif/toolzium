...
export default function Page() {
  ...
  return (<div className="space-y-4"><JsonLd data={appLd} /><JsonLd data={crumbsLd} /><JsonLd data={faqLd} /><InvoiceCalcClient />
      <RelatedTools currentToolUrl="/tools/office/invoice-calc" />
</div>);
}
