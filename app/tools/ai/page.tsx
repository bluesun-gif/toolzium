...
const TITLE = "Free Online AI Tools & Content Generators | Toolzium";
const DESCRIPTION = "Powerful suite of free online AI tools. Optimize prompts, generate YouTube scripts, find startup names, write social media bios, and explain code. No signup required.";
const PATH = "/tools/ai";
