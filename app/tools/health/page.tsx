...
const TITLE = "Free Health & Fitness Calculators — BMI, Calories & Sleep | Toolzium";
const DESCRIPTION = "Track your wellness goals with science-backed health calculators. Calculate BMI, daily caloric needs, body fat percentage, and sleep cycles.";
