...
const CATEGORY_ID = "image";
const TITLE = "Free Online Image Tools — Resize, Convert, Compress & Edit | Toolzium";
const DESCRIPTION = "Fast and private online image utilities. Bulk resize images, compress PNG/JPEG/WebP, convert formats, extract color palettes, and create favicons.";
