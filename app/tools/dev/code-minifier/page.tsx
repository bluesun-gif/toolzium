...
export default function Page() {
  ...
  return (<div className="max-w-6xl mx-auto space-y-8"><JsonLd data={appLd} /><JsonLd data={crumbsLd} /><JsonLd data={faqLd} /><CodeMinifierClient />
      <RelatedTools currentToolUrl="/tools/dev/code-minifier" />
</div>);
}
