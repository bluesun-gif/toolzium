...
const CATEGORY_ID = "social";
const TITLE = "Free Social Media Content & Engagement Tools | Toolzium";
const DESCRIPTION = "Grow your social presence with AI content creators. Generate viral Twitter threads, YouTube scripts, Instagram hooks, TikTok engagement estimates, and hashtags.";
const PATH = "/tools/social";
