...
export function MarkdownStudioClient() {
  ...
  const exportHTML = () => {
    const blob = new Blob([`<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Markdown Export</title></head><body>${html}</body></html>`], {
      type: "text/html"
    });
 ...
 <textarea ref={textareaRef} className={textareaClass} rows={20} value={markdown} onChange={e => setMarkdown(e.target.value)} placeholder="Start typing your Markdown here..." />
 ...
 {!isFullscreen && <Card className={`${cardClass} ${theme === "dark" ? "bg-gray-900 text-gray-100" : "bg-background text-foreground"}`}>
 ...
 <CardContent className="p-6 prose max-w-none overflow-auto" style={{
            maxHeight: '600px'
          }}>
 ...
 <ToolHowItWorks steps={[{
        ...
        description: "Use the editor to write your content and the toolbar to quickly insert formatting elements.",
        icon: FileText
      }, {
        step: "02",
        title: "Live Preview",
        description: "Watch your formatted document update in real-time in the preview pane as you type.",
        icon: Sun
      }, {
        step: "03",
        title: "Export & Share",
        description: "Copy the raw Markdown, export the rendered HTML, or adjust the theme for optimal viewing.",
        icon: Download
      }]} />
 ...
 <ToolFeatureGuides features={[{
        icon: Bold,
        title: "Smart Toolbar",
        description: "Quickly insert Markdown syntax for bold, italic, headings, links, images, and code blocks with a single click."
      }, {
        icon: FileText,
        title: "Real-time Rendering",
        description: "Our custom client-side parser instantly converts your Markdown into beautifully styled HTML."
      }, {
        icon: Sun,
        title: "Theme Toggling",
        description: "Switch between light and dark preview themes to match your environment or test your content's readability."
      }, {
        icon: Download,
        title: "Document Statistics",
        description: "Keep track of your word count, character count, and estimated reading time as you write."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        ...
        answer: "Yes. All parsing and rendering happens locally in your browser. Your text is never sent to any server."
      }, {
        question: "Does it support GitHub Flavored Markdown?",
        answer: "It supports the most common GFM features like tables, code blocks, and task lists, along with standard Markdown syntax."
      }, {
        question: "Can I save my documents?",
        answer: "While the tool doesn't store data permanently, you can easily copy the Markdown text or export the HTML file to save your work locally."
      }, {
