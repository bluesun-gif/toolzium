...
export function PronunciationClient() {
 ...
 <textarea className={textareaClass} rows={4} value={text} onChange={e => setText(e.target.value)} placeholder="Type words or sentences here..." />
 ...
 {filteredDict.map((w: string) => <div key={w} className="p-2 bg-muted/30 rounded text-sm flex justify-between">
 ...
 {results.map((r: any, i: number) => <div key={i} className="p-4 border rounded-lg bg-muted/20">
 ...
 {r.syllables.map((s: string, idx: number) => <span key={idx}>{s}{idx < r.syllables.length - 1 ? "-" : ""}</span>)}
 </p>
 </div>)}
 </CardContent>
 </Card>
 ...
 {COMMON_MISPRONOUNCED.map((m, i) => <div key={i} className="p-4 border rounded-lg bg-destructive/5">
 ...
 <ToolHowItWorks steps={[{
        step: "01",
        title: "Enter Text",
        description: "Type any word, phrase, or sentence into the input box.",
        icon: AudioLines
      }, {
        step: "02",
        title: "View Breakdown",
        description: "See the IPA transcription, syllable splits, and part of speech for each word.",
        icon: Search
      }, {
        step: "03",
        title: "Listen & Learn",
        description: "Use the speak button to hear the correct pronunciation at your preferred speed.",
        icon: Volume2
      }]} />
 ...
 <ToolFeatureGuides features={[{
        ...
        description: "Get accurate International Phonetic Alphabet transcriptions for hundreds of common English words."
      }, {
        icon: Search,
        title: "Syllable Breakdown",
        description: "Understand how words are divided into syllables to improve your speaking rhythm and spelling."
      }, {
        icon: Volume2,
        title: "Adjustable Speech",
        description: "Listen to your text read aloud with customizable speeds and selectable system voices."
      }, {
        icon: Sliders,
        title: "Mispronunciation Guide",
        description: "Learn from common mistakes with our curated list of frequently mispronounced English words."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        ...
        answer: "IPA stands for International Phonetic Alphabet. It's a standardized system of phonetic notation that represents the precise sounds of spoken language, regardless of spelling inconsistencies."
      }, {
        question: "Does it work offline?",
        answer: "Yes. The dictionary and syllable breakdowns are built-in. The speech synthesis uses your device's native Web Speech API, requiring no external API calls."
      }, {
        question: "Can it pronounce full sentences?",
        answer: "Absolutely. Paste any paragraph into the text area, and the speech synthesizer will read it aloud at your chosen speed."
      }, {
