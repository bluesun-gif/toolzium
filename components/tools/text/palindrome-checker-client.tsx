...
export default function PalindromeCheckerClient() {
 ...
 const { isPalindrome, cleaned, reversed } = useMemo(() => {
 const cleaned = input.toLowerCase().replace(/[^a-z0-9]/g,"");
 const reversed = cleaned.split("").reverse().join("");
 const isPalindrome = cleaned.length > 0 && cleaned === reversed;
 return { isPalindrome, cleaned, reversed };
 }, [input]);
 ...
 <ToolHowItWorks
 steps={[
 { step:"01", title:"Enter Your Text", description:"Type any word, phrase, or sentence you want to check.", icon: RotateCcw },
 { step:"02", title:"Automatic Analysis", description:"The tool removes spaces, punctuation, and converts to lowercase for fair comparison.", icon: CheckCircle2 },
 { step:"03", title:"View Results", description:"See instantly whether your text is a palindrome with visual confirmation.", icon: CheckCircle2 },
 ]}
 ...
 <ToolFeatureGuides
 features={[
 { icon: RotateCcw, title:"Smart Normalization", description:"Automatically removes spaces, punctuation, and converts to lowercase for accurate comparison."},
 { icon: CheckCircle2, title:"Real-Time Checking", description:"Results update instantly as you type without needing to click a button."},
 { icon: RotateCcw, title:"Visual Comparison", description:"Shows the cleaned string and its reverse side-by-side for transparency."},
 { icon: CheckCircle2, title:"Phrase Support", description:"Works with single words, phrases, and full sentences including punctuation."},
 ]}
 >
 ...
 <ToolFaqAccordion
 faqs={[
 { question:"Does it handle spaces and punctuation?", answer:"Yes, the checker automatically removes all spaces, punctuation, and special characters, and converts to lowercase for accurate comparison."},
 { question:"Can I check numbers?", answer:"Yes, numbers work too. For example, 12321 is a numeric palindrome."},
 { question:"What about case sensitivity?", answer:"The tool ignores case, so 'Racecar' and 'racecar' are both recognized as palindromes."},
 ]}
 />
