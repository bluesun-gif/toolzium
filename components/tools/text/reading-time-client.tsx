...
export default function ReadingTimeClient() {
  ...
  const statItems = [
    ...
    { label: "Reading (200 wpm)", value: `${stats.readingTime} min`, icon: BookOpen, color: "text-blue-500" },
    { label: "Fast Reading (300 wpm)", value: `${stats.fastReadingTime} min`, icon: BookOpen, color: "text-green-500" },
    { label: "Speaking (130 wpm)", value: `${stats.speakingTime} min`, icon: Mic, color: "text-purple-500" },
