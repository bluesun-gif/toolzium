...
export default function ReadingTimeClient() {
  ...
  const statItems = [{
    ...
    label: "Reading (200 wpm)",
    value: `${stats.readingTime} min`,
    icon: BookOpen,
    color: "text-primary"
  }, {
    label: "Fast Reading (300 wpm)",
    value: `${stats.fastReadingTime} min`,
    icon: BookOpen,
    color: "text-green-500"
  }, {
    label: "Speaking (130 wpm)",
    value: `${stats.speakingTime} min`,
    icon: Mic,
    color: "text-primary"
  }, {
    label: "Estimated Pages",
    value: `${stats.pageCount} pages`,
    icon: FileText,
 ...
 <textarea value={text} onChange={e => setText(e.target.value)} rows={10} className={textareaClass} placeholder="Paste your article, speech, or book chapter here..." />
 </CardContent>
 </GlassCard>
 ...
 <div className="h-full bg-primary transition-all duration-500" style={{
              width: `${Math.min(stats.words % 250 / 250 * 100, 100)}%`
            }} />
 </div>
 </CardContent>
 </GlassCard>}
 ...
 <ToolHowItWorks steps={[{
        step: "01",
        title: "Paste Text",
        description: "Input your blog post, essay, or speech transcript into the editor.",
        icon: FileText
      }, {
        step: "02",
        title: "Analyze Metrics",
        description: "The tool instantly counts words and calculates time based on standard speeds.",
        icon: Clock
      }, {
        step: "03",
        title: "Plan Delivery",
        description: "Use the speaking time to prepare presentations or reading time for blog UX.",
        icon: BookOpen
 ...
 <ToolFeatureGuides features={[{
        ...
        description: "Provides estimates for average readers (200 wpm) and fast readers (300 wpm)."
      }, {
        icon: Mic,
        title: "Speech Timing",
        description: "Calculates how long the text will take to read aloud for podcasts and videos."
      }, {
        icon: FileText,
        title: "Page Estimation",
        description: "Converts word count into standard manuscript pages (250 words per page)."
      }, {
        icon: Clock,
        title: "Live Updates",
        description: "Metrics adjust dynamically as you write, helping you hit exact length targets."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        ...
        answer: "We use 200 words per minute (wpm) for standard reading and 300 wpm for fast reading. These are widely accepted averages for adult comprehension of digital text."
      }, {
        question: "How is speaking time calculated?",
        answer: "Speaking time is based on an average presentation speed of 130 words per minute, which allows for natural pauses, emphasis, and audience comprehension."
      }, {
