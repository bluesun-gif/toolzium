...
export default function SlugifyClient() {
 ...
 placeholder="e.g., Hello World! This is a Blog Post #1"
 className="text-base"
 />
 ...
 <ToolHowItWorks
 steps={[
 { step:"01", title:"Enter Title", description:"Type or paste the headline, article title, or phrase you want to convert.", icon: PenTool },
 { step:"02", title:"Configure Rules", description:"Choose your preferred separator and decide whether to strip out numbers.", icon: Settings },
 { step:"03", title:"Copy Clean URL", description:"Grab the generated slug and use it in your CMS, routing, or database.", icon: Zap },
 ]}
 ...
 <ToolFeatureGuides
 features={[
 { icon: Link, title:"SEO Optimized", description:"Strips punctuation and special characters that break URLs and confuse search engines."},
 { icon: Settings, title:"Custom Separators", description:"Switch between hyphens (standard for URLs) and underscores (common in filenames)."},
 { icon: Zap, title:"Live Preview", description:"See the slug update dynamically as you type your title, with zero delay."},
 { icon: PenTool, title:"Number Stripping", description:"Optionally remove digits if you want purely alphabetical slugs for evergreen content."},
 ]}
 >
 ...
 <ToolFaqAccordion
 faqs={[
 { question:"Should I use hyphens or underscores for URLs?", answer:"Google officially recommends using hyphens (-) for URL slugs. Hyphens are treated as word separators, whereas underscores (_) are treated as word joiners."},
 { question:"Does this handle accented characters like é or ñ?", answer:"The current basic implementation strips non-standard ASCII characters. For full transliteration (e.g., converting 'é' to 'e'), a more advanced slug library is required."},
 { question:"Can I use this for file names?", answer:"Yes. By switching the separator to an underscore and keeping numbers, you can generate clean, safe file names for uploaded assets."},
 ]}
 />
