...
export default function BinaryTextClient() {
 ...
 <textarea value={input} onChange={e => setInput(e.target.value)} rows={6} className="w-full rounded-lg border border-border/70 bg-background/80 p-3 text-sm outline-none focus:ring-2 focus:ring-primary/50" placeholder={mode === "text-to-binary" ? "Enter text to convert to binary..." : "Enter binary (e.g., 01001000 01100101 01101100 01101100 01101111)..."} />
 ...
 <ToolHowItWorks steps={[{
        ...
        description: "Type your text message or paste binary code into the input field.",
        icon: Binary
      }, {
        step: "02",
        title: "Select Conversion Mode",
        description: "Choose between converting text to binary or decoding binary back to text.",
        icon: ArrowRightLeft
      }, {
        step: "03",
        title: "Copy Result",
        description: "Get the converted output instantly and copy it with a single click.",
        icon: Copy
      }]} badges={["100% Free", "Client-Side", "No Signup"]} />

 <ToolFeatureGuides features={[{
        icon: Binary,
        title: "8-Bit Encoding",
        description: "Each character is converted to its 8-bit binary representation using ASCII/UTF-8 encoding."
      }, {
        icon: ArrowRightLeft,
        title: "Bidirectional Conversion",
        description: "Seamlessly switch between text-to-binary and binary-to-text modes."
      }, {
        icon: Copy,
        title: "Instant Copy",
        description: "Copy the converted binary string or decoded text with one click."
      }, {
        icon: Binary,
        title: "Real-Time Processing",
        description: "See the conversion results update live as you type."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        question: "What encoding does this tool use?",
        answer: "This tool uses standard ASCII/UTF-8 encoding. Each character is represented as an 8-bit binary number."
      }, {
        question: "Can I convert emojis to binary?",
        answer: "Yes, but emojis require multiple bytes in UTF-8 encoding. Each byte will be shown as a separate 8-bit binary group."
      }, {
