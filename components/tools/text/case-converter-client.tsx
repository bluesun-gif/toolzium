...
export default function CaseConverterClient() {
  ...
  const convert = (type: string) => {
    ...
    switch (type) {
      ...
      case "sentence":
        ...
        break;
      case "camel":
        result = text.replace(/(?:^\w|[A-Z]|\b\w)/g, (word, index) => index === 0 ? word.toLowerCase() : word.toUpperCase()).replace(/[\s_-]+/g, "");
        break;
      case "snake":
        result = text.replace(/[\s-]+/g, "_").toLowerCase();
        break;
      case "kebab":
        result = text.replace(/[\s_]+/g, "-").toLowerCase();
        break;
      case "constant":
 ...
 <textarea value={text} onChange={e => setText(e.target.value)} rows={6} className={textareaClass} placeholder="Paste or type your text here..." />
 ...
 <ToolHowItWorks steps={[{
        step: "01",
        title: "Enter Text",
        description: "Paste or type the text you want to transform into the input area.",
        icon: AlignLeft
      }, {
        step: "02",
        title: "Choose Format",
        description: "Click any of the case conversion buttons to apply the desired formatting.",
        icon: Wand2
      }, {
        step: "03",
        title: "Copy Result",
        description: "Review the converted text and copy it to your clipboard with one click.",
        icon: CheckCircle2
      }]} badges={["100% Free", "Client-Side", "No Signup"]} />

 <ToolFeatureGuides features={[{
        icon: Type,
        title: "8 Case Formats",
        description: "Supports standard text cases plus developer-friendly formats like camelCase and snake_case."
      }, {
        icon: Wand2,
        title: "Instant Conversion",
        description: "Transforms your text locally in the browser without any network delays."
      }, {
        icon: AlignLeft,
        title: "Sentence Awareness",
        description: "Sentence case intelligently capitalizes the first letter after punctuation marks."
      }, {
        icon: CheckCircle2,
        title: "Privacy First",
        description: "Your text never leaves your device, ensuring complete confidentiality."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        question: "Will this tool change my punctuation?",
        answer: "No, standard case conversions (like UPPERCASE and lowercase) preserve all punctuation. Developer cases (like camelCase) will remove spaces and special characters to create valid code identifiers."
      }, {
        question: "Is my text sent to a server?",
        answer: "Absolutely not. All text processing happens directly in your browser using JavaScript. Your data remains 100% private."
      }, {
