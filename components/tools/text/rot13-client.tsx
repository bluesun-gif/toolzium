...
export default function Rot13Client() {
 ...
 <textarea value={text} onChange={e => setText(e.target.value)} rows={6} className={textareaClass} placeholder="Type or paste text to encode/decode with ROT13..." />
 ...
 <ToolHowItWorks steps={[{
        step: "01",
        title: "Enter Message",
        description: "Type a secret message or paste an existing ROT13 encoded string.",
        icon: Lock
      }, {
        step: "02",
        title: "Auto-Transform",
        description: "The cipher automatically shifts every letter by 13 positions in the alphabet.",
        icon: RotateCw
      }, {
        step: "03",
        title: "Copy Output",
        description: "Grab the encoded or decoded text. Run it through again to reverse the process.",
        icon: Unlock
 ...
 <ToolFeatureGuides features={[{
        ...
        description: "Because the alphabet has 26 letters, encoding twice returns the original text. Encode and decode use the same function."
      }, {
        icon: Lock,
        title: "Preserves Formatting",
        description: "Numbers, punctuation, spaces, and casing are completely ignored and preserved exactly as typed."
      }, {
        icon: Zap,
        title: "Instant Processing",
        description: "Applies the mathematical shift in real-time as you type, with zero latency."
      }, {
        icon: Unlock,
        title: "Spoiler Protection",
        description: "Widely used on forums to hide puzzle answers, spoilers, and offensive jokes from casual scrollers."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        question: "Is ROT13 secure for encrypting passwords?",
        answer: "Absolutely not. ROT13 is a trivial substitution cipher that can be broken instantly by any computer or even by hand. Never use it for security purposes."
      }, {
        question: "Why are numbers and punctuation unchanged?",
        answer: "The ROT13 algorithm only operates on alphabetic characters (A-Z, a-z). All other characters are passed through untouched to preserve sentence structure."
      }, {
