...
export default function TextToListClient() {
 ...
 placeholder="Enter text separated by commas, newlines, or your custom delimiter..."
 />
 ...
 readOnly
 rows={10}
 className="w-full rounded-lg border border-border/70 bg-background/80 p-3 text-sm font-mono outline-none focus:ring-2 focus:ring-primary/50"
 />
 ...
 <ToolHowItWorks
 steps={[
 { step:"01", title:"Enter Your Text", description:"Paste or type text separated by commas, newlines, or your chosen delimiter.", icon: List },
 { step:"02", title:"Choose Settings", description:"Select the delimiter type and desired output format for your list.", icon: Wand2 },
 { step:"03", title:"Convert & Copy", description:"Click convert to generate your formatted list and copy it instantly.", icon: Copy },
 ]}
 ...
 <ToolFeatureGuides
 features={[
 { icon: List, title:"Multiple Delimiters", description:"Supports comma, newline, semicolon, and custom delimiters for maximum flexibility."},
 { icon: Wand2, title:"Four Output Formats", description:"Choose from numbered lists, bullet lists, HTML ul/li, or JSON arrays."},
 { icon: Copy, title:"Instant Conversion", description:"Process and format your text in milliseconds with one click."},
 { icon: List, title:"Smart Parsing", description:"Automatically trims whitespace and filters empty entries from your list."},
 ]}
 >
 ...
 <ToolFaqAccordion
 faqs={[
 { question:"What if my text has inconsistent spacing?", answer:"The tool automatically trims whitespace from each item, so 'apple , banana,orange' all become clean entries."},
 { question:"Can I use multiple character delimiters?", answer:"Yes, the custom delimiter option accepts any string, including multi-character sequences like '||' or '::'."},
 { question:"Does it handle empty entries?", answer:"Yes, empty entries created by consecutive delimiters are automatically filtered out."},
 ]}
 />
