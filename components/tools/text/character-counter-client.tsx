...
export default function CharacterCounterClient() {
 ...
 <textarea value={text} onChange={e => setText(e.target.value)} rows={10} className={textareaClass} placeholder="Start typing or paste your text here to see live statistics..." />
 </CardContent>
 </GlassCard>
 ...
 <ToolHowItWorks steps={[{
        step: "01",
        title: "Input Text",
        description: "Type directly into the box or paste an existing document to analyze.",
        icon: FileText
      }, {
        step: "02",
        title: "Live Analysis",
        description: "Watch the statistics update instantly with every keystroke or deletion.",
        icon: BarChart3
      }, {
        step: "03",
        title: "Review Metrics",
        description: "Use the detailed breakdown to ensure your text meets specific length requirements.",
        icon: Zap
      }]} badges={["100% Free", "Client-Side", "Instant"]} />

 <ToolFeatureGuides features={[{
        icon: Hash,
        title: "Granular Counting",
        description: "Differentiates between total characters and characters excluding whitespace."
      }, {
        icon: FileText,
        title: "Structural Metrics",
        description: "Accurately counts sentences, paragraphs, and line breaks for formatting checks."
      }, {
        icon: BarChart3,
        title: "Real-Time Updates",
        description: "No submit button required; statistics recalculate dynamically as you edit."
      }, {
        icon: Zap,
        title: "Average Word Length",
        description: "Calculates the mean length of your words to help gauge reading complexity."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        ...
        answer: "Yes, the 'Characters' metric includes all spaces and line breaks. We also provide a 'Chars (No Spaces)' metric if you need to exclude whitespace."
      }, {
        question: "How are paragraphs counted?",
        answer: "Paragraphs are counted based on double line breaks (empty lines between text blocks). Single line breaks are counted as separate lines within the same paragraph."
      }, {
