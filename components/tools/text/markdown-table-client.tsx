...
export default function MarkdownTableClient() {
 ...
 <tbody>
 {data.map((row, rowIdx) => <tr key={rowIdx}>
 {row.map((cell, colIdx) => <td key={colIdx} className="border border-border/60 p-1">
 <Input value={cell} onChange={e => updateCell(rowIdx, colIdx, e.target.value)} placeholder={rowIdx === 0 ? `Header ${colIdx + 1}` : `Cell ${rowIdx}-${colIdx + 1}`} className="text-sm" />
 </td>)}
 </tr>)}
 </tbody>
 </table>
 ...
 <ToolHowItWorks steps={[{
        ...
        description: "Use the grid editor to enter your table data row by row.",
        icon: Table
      }, {
        step: "02",
        title: "Adjust Dimensions",
        description: "Add or remove rows and columns to match your data structure.",
        icon: Plus
      }, {
        step: "03",
        title: "Copy Markdown",
        description: "Get the properly formatted Markdown table syntax instantly.",
        icon: Copy
 ...
 <ToolFeatureGuides features={[{
        ...
        description: "Interactive table editor makes it easy to enter and organize your data."
      }, {
        icon: Plus,
        title: "Dynamic Sizing",
        description: "Add or remove rows and columns on the fly to match your needs."
      }, {
        icon: Copy,
        title: "Standard Markdown",
        description: "Generates GitHub-flavored Markdown table syntax compatible with most platforms."
      }, {
        icon: Table,
        title: "Live Preview",
        description: "See your Markdown output update in real-time as you edit the table."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        question: "What Markdown flavor does this generate?",
        answer: "This tool generates GitHub-flavored Markdown (GFM) table syntax, which is widely supported across platforms."
      }, {
        question: "Can I align columns left, center, or right?",
        answer: "Currently, all columns use default left alignment. You can manually edit the separator row (---) to add colons for alignment after copying."
      }, {
