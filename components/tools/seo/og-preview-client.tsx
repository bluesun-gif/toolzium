...
<meta property="twitter:image"content="${ogImage}"/>`;
 ...
 <textarea className={textareaClass} rows={3} value={ogDescription} onChange={e => setOgDescription(e.target.value)} placeholder="A compelling description..." />
 ...
 <div className={`h-full transition-all ${seoScore === 100 ? 'bg-green-500' : seoScore >= 50 ? 'bg-yellow-500' : 'bg-red-500'}`} style={{
                    width: `${seoScore}%`
                  }} />
 </div>
 ...
 <p className="text-[10px] text-primary hover:underline cursor-pointer">{siteName || "Site Name"}</p>
 <h3 className="font-bold text-sm text-primary hover:underline cursor-pointer line-clamp-1">{ogTitle || "Your Page Title"}</h3>
 ...
 <pre className="p-4 font-mono text-xs bg-background text-cyan-400 rounded-xl border overflow-x-auto leading-relaxed">
 {metaTags}
 </pre>
 </CardContent>
 </GlassCard>
 ...
 <ToolHowItWorks steps={[{
        ...
        step: "02",
        title: "Review Visual Previews",
        description: "Instantly see how your link will render across Facebook, Twitter, Discord, and Slack to ensure visual appeal.",
        icon: Eye
      }, {
        step: "03",
 ...
 <ToolFeatureGuides features={[{
        ...
        description: "Accurately mimics the unfurling algorithms of major social networks and messaging apps to prevent broken shares."
      }, {
        icon: AlertTriangle,
        title: "Character Limit Warnings",
        description: "Real-time counters alert you when your title exceeds 60 chars or description exceeds 155 chars, preventing truncation."
      }, {
        icon: CheckCircle2,
        title: "Completeness Scoring",
        description: "A dynamic SEO score evaluates the presence and optimal length of all critical Open Graph and Twitter Card properties."
      }, {
        icon: Copy,
        title: "One-Click Export",
        description: "Generates perfectly formatted HTML meta tags for both Open Graph and Twitter Cards, ready for immediate deployment."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        question: "What is the ideal image size for OG tags?",
        answer: "The recommended size is 1200x630 pixels (1.9:1 ratio). This ensures your image looks crisp on high-DPI displays and isn't awkwardly cropped by Facebook or LinkedIn."
      }, {
        question: "Why is my description getting cut off?",
        answer: "Most platforms truncate descriptions after 155-200 characters. Our tool warns you if you exceed 155 characters to ensure your core message is always visible."
      }, {
        question: "Do I need both OG and Twitter tags?",
        answer: "While Twitter falls back to OG tags if Twitter-specific tags are missing, it is best practice to include both to guarantee correct rendering across all apps and future-proof your markup."
      }, {
