...
export default function NumberWordsClient() {
 ...
 <Input type="text" placeholder="e.g. 1234567.89" value={input} onChange={e => setInput(e.target.value)} className="text-2xl font-mono" />
 ...
 <ToolHowItWorks steps={[{
        step: "01",
        title: "Enter Digits",
        description: "Type or paste any number, including decimals, into the input field.",
        icon: Hash
      }, {
        step: "02",
        title: "Auto-Convert",
        description: "The tool instantly parses the number and generates the English word representation.",
        icon: Hash
      }, {
        step: "03",
        title: "Copy Text",
        description: "Use the copy button to grab the text for use in checks, legal documents, or invoices.",
        icon: Hash
 ...
 <ToolFeatureGuides features={[{
        ...
        description: "Accurately converts numbers up to the trillions scale with proper grouping."
      }, {
        icon: Hash,
        title: "Decimal Handling",
        description: "Processes fractional parts and appends them as 'Point' followed by the words."
      }, {
        icon: Hash,
        title: "Negative Numbers",
        description: "Correctly identifies and prefixes negative values with the word 'Negative'."
      }, {
        icon: Hash,
        title: "Real-Time Parsing",
        description: "Updates the output continuously as you type without requiring a submit button."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        ...
        answer: "Yes, decimal values are read as 'Point' followed by the numerical words for the fractional part (e.g., 12.34 becomes 'Twelve Point Thirty-Four')."
      }, {
        question: "What is the maximum number it can handle?",
        answer: "The tool supports numbers up to the Trillions scale. Extremely large numbers beyond standard JavaScript floating-point precision may lose exactness."
      }, {
