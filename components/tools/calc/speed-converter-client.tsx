...
const units = [
 { id:"km/h", label:"Kilometers per hour (km/h)", toMs: 1 / 3.6 },
 { id:"mph", label:"Miles per hour (mph)", toMs: 0.44704 },
 { id:"m/s", label:"Meters per second (m/s)", toMs: 1 },
 { id:"knots", label:"Knots (kn)", toMs: 0.514444 },
 { id:"ft/s", label:"Feet per second (ft/s)", toMs: 0.3048 },
];
...
export default function SpeedConverterClient() {
 ...
 <ToolHowItWorks 
 steps={[
 { step:"01", title:"Enter Value", description:"Type the speed value you want to convert into the input field.", icon: Gauge },
 { step:"02", title:"Select Unit", description:"Choose the source unit of your speed measurement from the dropdown menu.", icon: Gauge },
 { step:"03", title:"View Results", description:"Instantly see the converted values across all major speed units in the grid.", icon: Gauge }
 ]} 
 badges={["100% Free","Client-Side","Instant"]} 
 />

 <ToolFeatureGuides features={[
 { icon: Gauge, title:"Universal Units", description:"Supports km/h, mph, m/s, knots, and ft/s for comprehensive conversions."},
 { icon: Gauge, title:"Real-Time Calculation", description:"Results update instantly as you type without needing to click a submit button."},
 { icon: Gauge, title:"High Precision", description:"Calculations are performed with up to 4 decimal places of accuracy."},
 { icon: Gauge, title:"Privacy Focused", description:"All conversions happen locally in your browser. No data is sent to servers."}
 ]}>
 ...
 { question:"How do I convert km/h to mph?", answer:"To convert kilometers per hour to miles per hour, multiply the km/h value by 0.621371. Our tool does this automatically."},
 { question:"What is the speed of sound in these units?", answer:"The speed of sound in dry air at 20 °C is approximately 343 m/s, which is 1234.8 km/h, 767 mph, or 667 knots."},
