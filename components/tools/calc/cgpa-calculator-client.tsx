...
export default function CgpaCalculatorClient() {
 ...
 <ToolHowItWorks 
 steps={[
 { step:"01", title:"Add Courses", description:"Enter the name and credit hours for each course you have taken.", icon: GraduationCap },
 { step:"02", title:"Select Grades", description:"Choose the letter grade you received for each respective course.", icon: GraduationCap },
 { step:"03", title:"View CGPA", description:"Instantly see your calculated Cumulative Grade Point Average.", icon: GraduationCap }
 ]} 
 badges={["100% Free","Client-Side","Instant"]} 
 />

 <ToolFeatureGuides features={[
 { icon: GraduationCap, title:"Dynamic Rows", description:"Easily add or remove course rows to match your exact academic transcript."},
 { icon: GraduationCap, title:"Weighted Average", description:"Accurately calculates CGPA by weighting each grade by its credit hours."},
 { icon: GraduationCap, title:"Standard Grading", description:"Uses the standard 4.0 GPA scale with plus and minus variations."},
 { icon: GraduationCap, title:"Real-Time Updates", description:"Your CGPA updates instantly as you modify credits or grades."}
 ]}>
 ...
 { question:"What scale does this calculator use?", answer:"This tool uses the standard 4.0 unweighted GPA scale, incorporating plus and minus grades (e.g., A- = 3.7, B+ = 3.3)."},
 { question:"How do I handle lab credits?", answer:"If your lab is graded separately, add it as a distinct course row with its own credit value and grade."},
