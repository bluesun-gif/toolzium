...
"percent-change":"% change from X to Y",
 ...
 const inputLabels = {
"percent-of": { v1:"Percentage (%)", v2:"Of Value"},
"what-percent": { v1:"Value", v2:"Total"},
"percent-change": { v1:"Original Value", v2:"New Value"},
 };
 ...
 <ToolHowItWorks
 steps={[
 { step:"01", title:"Select Mode", description:"Choose the type of percentage calculation you need.", icon: Percent },
 { step:"02", title:"Enter Values", description:"Input the numbers for your calculation.", icon: Percent },
 { step:"03", title:"View Result", description:"Get your answer instantly with the option to copy it.", icon: Copy },
 ]}
 ...
 <ToolFeatureGuides
 features={[
 { icon: Percent, title:"Three Calculation Modes", description:"Find X% of Y, what % X is of Y, or percentage change between values."},
 { icon: Copy, title:"Instant Results", description:"Calculations update in real-time as you type your values."},
 { icon: Percent, title:"Clear Labels", description:"Input fields are clearly labeled based on your selected calculation mode."},
 { icon: Copy, title:"Copy Functionality", description:"Copy results with one click for use in documents or spreadsheets."},
 ]}
 >
 ...
 <ToolFaqAccordion
 faqs={[
 { question:"How do I calculate a tip?", answer:"Use 'What is X% of Y?' mode. Enter the tip percentage (e.g., 15) and the bill amount to get the tip value."},
 { question:"Can I calculate percentage decrease?", answer:"Yes, the percentage change mode handles both increases and decreases. A negative result indicates a decrease."},
 { question:"What if I divide by zero?", answer:"The calculator prevents division by zero errors and will show '—' for invalid calculations."},
 ]}
 />
