...
export default function LoanEmiClient() {
 ...
 {emiData.total > 0 && <div className="mt-6 space-y-2">
 <div className="text-sm font-medium">Amortization Breakdown</div>
 <div className="w-full h-4 bg-muted rounded-full overflow-hidden flex">
 <div className="h-full bg-primary" style={{
                width: `${parseFloat(principal) / emiData.total * 100}%`
              }} title="Principal" />
 <div className="h-full bg-destructive" style={{
                width: `${emiData.interest / emiData.total * 100}%`
              }} title="Interest" />
 </div>
 ...
 <ToolHowItWorks steps={[{
        ...
        description: "Input the total principal amount you intend to borrow.",
        icon: Landmark
      }, {
        step: "02",
        title: "Set Rate & Tenure",
        description: "Provide the annual interest rate and the loan duration in months.",
        icon: Landmark
      }, {
        step: "03",
        title: "View Breakdown",
        description: "Instantly see your monthly EMI, total interest paid, and visual amortization chart.",
        icon: Landmark
 ...
 <ToolFeatureGuides features={[{
        ...
        description: "Uses the industry-standard reducing balance formula for precise calculations."
      }, {
        icon: Landmark,
        title: "Visual Amortization",
        description: "See a color-coded bar chart comparing your principal vs. total interest paid."
      }, {
        icon: Landmark,
        title: "Flexible Tenure",
        description: "Input your loan term in months to accommodate any loan structure."
      }, {
        icon: Landmark,
        title: "Zero Data Retention",
        description: "Your financial figures are processed locally and never saved on our servers."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        ...
        answer: "EMI = [P x R x (1+R)^N] / [(1+R)^N - 1], where P is Principal, R is the monthly interest rate, and N is the number of months."
      }, {
        question: "Does this include property tax or insurance?",
        answer: "No, this calculator only computes principal and interest. For mortgages, you must separately add property taxes, homeowners insurance, and PMI to your monthly budget."
      }, {
        question: "Can I calculate for a car loan?",
        answer: "Yes, the formula applies to any amortizing loan, including auto loans, personal loans, and student loans."
      }]} />
