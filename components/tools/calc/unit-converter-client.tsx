        ...
        <div className="prose prose-sm dark:prose-invert max-w-none space-y-4">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-sm">
              ...
              <tbody>
                {[
                  ["1 Kilometer", "1,000 m", "3,280.84 ft", "39,370 in"],
                  ["1 Meter", "1 m", "3.281 ft", "39.37 in"],
                  ["1 Centimeter", "0.01 m", "0.0328 ft", "0.394 in"],
                  ["1 Foot", "0.3048 m", "1 ft", "12 in"],
                  ["1 Inch", "0.0254 m", "0.0833 ft", "1 in"],
                  ["1 Mile", "1,609.34 m", "5,280 ft", "63,360 in"],
                ].map(([from, m, ft, inch]) => (
                  <tr key={from} className="odd:bg-muted/20">
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-sm">
              ...
              <tbody>
                {[
                  ["1 Kilogram", "1 kg", "2.205 lb", "1,000 g"],
                  ["1 Pound", "0.4536 kg", "1 lb", "453.6 g"],
                  ["1 Ounce", "0.02835 kg", "0.0625 lb", "28.35 g"],
                  ["1 Stone", "6.350 kg", "14 lb", "6,350 g"],
                  ["1 Tonne", "1,000 kg", "2,204.6 lb", "1,000,000 g"],
                ].map(([from, kg, lb, g]) => (
                  <tr key={from} className="odd:bg-muted/20">
                    <td className="border p-2 font-medium text-xs">{from}</td>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-sm">
            {[
              ["°C to °F", "(°C × 9/5) + 32", "100°C = 212°F"],
              ["°F to °C", "(°F − 32) × 5/9", "98.6°F = 37°C"],
              ["°C to K", "°C + 273.15", "0°C = 273.15 K"],
            ].map(([conv, formula, example]) => (
              <div key={conv} className="flex flex-col gap-1 rounded-md border bg-muted/30 p-3">
