...
export default function BmiCalculatorClient() {
 ...
 <Input type="number" value={weight} onChange={e => setWeight(Number(e.target.value))} min={1} className="flex-1" />
 <select value={weightUnit} onChange={e => setWeightUnit(e.target.value as any)} className="rounded-lg border border-border/70 bg-background/80 px-3 text-sm">
 ...
 <div className="flex gap-2">
 <Input type="number" value={height} onChange={e => setHeight(Number(e.target.value))} min={1} className="flex-1" />
 <select value={heightUnit} onChange={e => setHeightUnit(e.target.value as any)} className="rounded-lg border border-border/70 bg-background/80 px-3 text-sm">
 ...
 {bmi !== null && <div className="space-y-4">
 ...
 <div className="absolute top-0 w-1 h-full bg-background border-2 border-black" style={{
                  left: `${bmiScalePosition}%`
                }} />
 </div>
 ...
 <ToolHowItWorks steps={[{
        step: "01",
        title: "Enter Weight",
        description: "Input your weight in kilograms or pounds.",
        icon: Heart
      }, {
        step: "02",
        title: "Enter Height",
        description: "Input your height in centimeters or feet.",
        icon: Heart
      }, {
        step: "03",
        title: "View Results",
        description: "See your BMI value, category, and position on the scale.",
        icon: Copy
 ...
 <ToolFeatureGuides features={[{
        ...
        description: "Supports both metric (kg/cm) and imperial (lbs/ft) measurements."
      }, {
        icon: Copy,
        title: "Visual BMI Scale",
        description: "See where your BMI falls on a color-coded health spectrum."
      }, {
        icon: Heart,
        title: "Health Categories",
        description: "Automatically classifies your BMI into standard health categories."
      }, {
        icon: Copy,
        title: "Instant Calculation",
        description: "BMI updates in real-time as you adjust your measurements."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        ...
        answer: "A BMI between 18.5 and 24.9 is considered normal/healthy for most adults."
      }, {
        question: "Is BMI accurate for athletes?",
        answer: "BMI may overestimate body fat in very muscular people since it doesn't distinguish between muscle and fat mass."
      }, {
