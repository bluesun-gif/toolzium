...
const scale4: Record<string, number> = {
  "A": 4.0,
  "B": 3.0,
  "C": 2.0,
  "D": 1.0,
...
const scale5: Record<string, number> = {
  "A": 5.0,
  "B": 4.0,
  "C": 3.0,
  "D": 2.0,
...
export default function GpaCalculatorClient() {
 ...
 <ToolHowItWorks steps={[{
        step: "01",
        title: "Select Scale",
        description: "Toggle between the standard 4.0 scale or the 5.0 scale used by some institutions.",
        icon: BookOpen
      }, {
        step: "02",
        title: "Enter Courses",
        description: "Input your course names, credit hours, and the grades achieved.",
        icon: BookOpen
      }, {
        step: "03",
        title: "Get GPA",
        description: "View your calculated semester GPA instantly updated on the screen.",
        icon: BookOpen
 ...
 <ToolFeatureGuides features={[{
        icon: BookOpen,
        title: "Dual Scales",
        description: "Supports both the traditional 4.0 GPA scale and the 5.0 weighted scale."
      }, {
        icon: BookOpen,
        title: "Simple Grading",
        description: "Uses standard A-F letter grades without plus/minus variations for straightforward calculation."
      }, {
        icon: BookOpen,
        title: "Credit Weighting",
        description: "Automatically applies the correct mathematical weight to each course based on its credits."
      }, {
        icon: BookOpen,
        title: "Privacy First",
        description: "Your grades and course names are never saved or transmitted to any server."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        question: "What is the difference between 4.0 and 5.0 scales?",
        answer: "The 4.0 scale typically caps an 'A' at 4.0 points, while a 5.0 scale often assigns 5.0 points to an 'A' in advanced, honors, or AP/IB courses."
      }, {
        question: "Does this include plus and minus grades?",
        answer: "This specific tool uses whole letter grades (A, B, C, D, F) to align with standard 5.0 scale reporting. For plus/minus precision, use our CGPA Calculator."
      }, {
