...
export default function VideoRatioClient() {
 ...
 {presets.map(p => <Button key={p.name} variant="outline" size="sm" onClick={() => applyPreset(p.w, p.h)}>
 {p.name}
 </Button>)}
 </div>

 {ratioData && <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
 ...
 <div className="bg-primary/40 border-2 border-primary flex items-center justify-center text-xs font-bold text-primary-foreground transition-all duration-300" style={{
 ...
 <ToolHowItWorks steps={[{
        ...
        description: "Input the pixel width and height of your video or image.",
        icon: Film
      }, {
        step: "02",
        title: "View Ratio",
        description: "Instantly see the simplified aspect ratio (e.g., 16:9) and a visual preview.",
        icon: Film
      }, {
        step: "03",
        title: "Scale Dimensions",
        description: "Enter a target width to automatically calculate the proportional height.",
        icon: Film
 ...
 <ToolFeatureGuides features={[{
        icon: Film,
        title: "GCD Algorithm",
        description: "Uses the Greatest Common Divisor to mathematically reduce resolutions to their simplest ratio."
      }, {
        icon: Film,
        title: "Visual Preview",
        description: "Generates a dynamic rectangle that visually represents the exact shape of your media."
      }, {
        icon: Film,
        title: "Quick Presets",
        description: "One-click buttons to load standard broadcast and web resolutions like 4K and 1080p."
      }, {
        icon: Film,
        title: "Proportional Scaling",
        description: "Easily resize your project to fit specific player widths without distorting the image."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        question: "What is the standard aspect ratio for YouTube?",
        answer: "The standard aspect ratio for YouTube desktop and TV viewing is 16:9 (e.g., 1920x1080 or 3840x2160)."
      }, {
        question: "How do I calculate a 9:16 vertical video?",
        answer: "Simply swap the width and height values. For example, a 1080x1920 resolution will correctly calculate to a 9:16 ratio."
      }, {
