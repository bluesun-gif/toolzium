...
export default function TipCalculatorClient() {
 ...
 {presets.map(p => <Button key={p} variant={tipPercent === p ? "default" : "outline"} size="sm" onClick={() => setTipPercent(p)}>
 {p}%
 </Button>)}
 </div>
 <input type="range" min="0" max="30" value={tipPercent} onChange={e => setTipPercent(parseInt(e.target.value))} className="w-full mt-2 accent-primary" />
 </div>
 </div>
 ...
 <ToolHowItWorks steps={[{
        step: "01",
        title: "Enter Bill",
        description: "Input the total amount of your restaurant or service bill.",
        icon: Receipt
      }, {
        step: "02",
        title: "Select Tip",
        description: "Choose a preset tip percentage or use the slider for a custom amount.",
        icon: Receipt
      }, {
        step: "03",
        title: "Split & Pay",
        description: "See exactly how much each person owes, including their share of the tip.",
        icon: Receipt
 ...
 <ToolFeatureGuides features={[{
        icon: Receipt,
        title: "Quick Presets",
        description: "One-tap buttons for standard tipping percentages like 15%, 18%, and 20%."
      }, {
        icon: Receipt,
        title: "Group Splitting",
        description: "Instantly divide the total bill and tip evenly among any number of people."
      }, {
        icon: Receipt,
        title: "Custom Slider",
        description: "Fine-tune your tip percentage with a smooth, responsive range slider."
      }, {
        icon: Receipt,
        title: "Live Updates",
        description: "Calculations happen in real-time as you adjust the inputs."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        ...
        answer: "In the United States, the standard tip for sit-down restaurant service is typically 15% to 20% of the pre-tax bill."
      }, {
        question: "Does it calculate tip on tax?",
        answer: "This calculator applies the tip percentage to the total bill amount you enter. It is generally customary to tip on the pre-tax amount, but you can enter whichever base you prefer."
      }, {
