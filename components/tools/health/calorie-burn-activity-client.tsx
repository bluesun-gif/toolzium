...
const ACTIVITIES: ActivityMET[] = [
  { name: "Running (6 mph / 10 min mile)", met: 9.8, category: "Cardio" },
  { name: "Running (8 mph / 7.5 min mile)", met: 11.8, category: "Cardio" },
  { name: "Stationary Cycling (Moderate 100W)", met: 6.8, category: "Cycling" },
  { name: "Stationary Cycling (Vigorous 150W)", met: 8.8, category: "Cycling" },
  { name: "Swimming Laps (Moderate)", met: 5.8, category: "Swimming" },
  { name: "Walking (3.5 mph brisk pace)", met: 4.3, category: "Walking" },
  { name: "Weight Lifting (Vigorous strength training)", met: 6.0, category: "Gym" },
  { name: "HIIT Workout / Circuit Training", met: 8.0, category: "Gym" },
  { name: "Basketball Game", met: 8.0, category: "Sports" },
  { name: "Soccer / Football Game", met: 7.0, category: "Sports" },
  { name: "Yoga (Vinyasa Flow)", met: 3.3, category: "Wellness" },
  { name: "Jump Rope (Moderate pace)", met: 10.0, category: "Cardio" },
];
  ...
  return (
    <div className="relative max-w-6xl mx-auto space-y-8">
      ...
      <ToolPageHeader
        ...
        description="Calculate exact calories burned across 30+ physical activities, sports, and exercise routines based on body weight and duration."
              ...
              <Select value={selectedIndex.toString()} onValueChange={(val) => setSelectedIndex(parseInt(val))}>
                ...
                <SelectContent>
                  {ACTIVITIES.map((act, idx) => (
                    <SelectItem key={act.name} value={idx.toString()}>
