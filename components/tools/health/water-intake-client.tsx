...
export function WaterIntakeClient() {
 ...
 <button
 className={cn("px-3 py-1 rounded-sm text-sm font-medium transition-colors", (unit ==="kg"?"bg-background shadow-sm":""))}
 onClick={() => setUnit("kg")}
 >
 kg
 </button>
 <button
 className={cn("px-3 py-1 rounded-sm text-sm font-medium transition-colors", (unit ==="lbs"?"bg-background shadow-sm":""))}
 onClick={() => setUnit("lbs")}
 >
 lbs
 </button>
 ...
 {differenceGlasses > 0 ? (
 <div className="text-sm text-primary/80 /80 bg-primary/10/50 dark:bg-blue-900/40 px-3 py-1 rounded-full mt-2">
      ...
      >
        <div className="prose dark:prose-invert max-w-none">
          ...
          <p>
            ...
            Whether you're a developer, designer, student, or professional, our Water Intake Calculator provides
