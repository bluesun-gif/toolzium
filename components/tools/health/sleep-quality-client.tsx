...
import { Moon, TrendingUp, Award, Calendar, Sparkles, Shield, Zap, Copy } from"lucide-react";
...
export function SleepQualityClient() {
 ...
 const [results, setResults] = useState<{ durationHours: number; efficiency: number; score: number; tips: string[] } | null>(null);
 ...
 setResults({ durationHours, efficiency, score, tips });
 };
 ...
 description="Analyze your sleep patterns, calculate efficiency, and get a sleep score."
 actions={
 ...
 {history.length > 0 && (
 <Button variant="ghost"size="sm"onClick={clearHistory} className="h-8">Clear</Button>
 )}
 </CardHeader>
 <CardContent>
 {history.length > 0 ? (
 ...
 {history.map((log, i) => (
 <div key={i} className="flex justify-between items-center text-sm p-2 rounded-md bg-muted/30 border">
 ...
 No sleep logs yet.
      ...
      >
        <div className="prose dark:prose-invert max-w-none">
          <h3>Why Use Our Sleep Quality Analyzer?</h3>
          <p>
            This free online tool is designed to help you get accurate results quickly and securely.
            Whether you're a developer, designer, student, or professional, our Sleep Quality Analyzer provides
