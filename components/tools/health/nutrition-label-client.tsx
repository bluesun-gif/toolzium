    ...
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="print-area">
          <GlassCard className="max-w-[400px] mx-auto bg-white text-black font-sans">
            <div className="p-4 border-black border-4 bg-white text-black print:border-none print:p-0">
