...
export function CyclingCalorieClient() {
 ...
 let met = 4;
 switch(intensity) {
 case"Leisure (<10 mph)": met = 4.0; break;
 case"Moderate (10-12 mph)": met = 6.8; break;
 case"Vigorous (12-14 mph)": met = 8.0; break;
 case"Racing (14-16 mph)": met = 10.0; break;
 case"Racing (16-19 mph)": met = 12.0; break;
 case"Racing (>20 mph)": met = 15.8; break;
 case"Mountain Biking": met = 8.5; break;
 case"Stationary Bike": met = 7.0; break;
 }
 ...
 description="Calculate calories burned and estimated mechanical power output during your cycling sessions."
 actions={
