...
"Currency",
 ...
 <CardDescription>
 Invoice meta, currency, parties & status.
 </CardDescription>
 </CardHeader>
 ...
 <CardDescription>
 Discounts, tax, shipping, and total.
 </CardDescription>
 </CardHeader>
 <CardContent className="grid gap-6 lg:grid-cols-3">
 ...
 <span>Discount</span>
 <span>
 - {fmtCurrency(discountAmt, data.currency, data.currencyMode)}
 </span>
 </div>
 <div className="flex justify-between">
 <span>Shipping</span>
 ...
 <span>Tax</span>
 <span>
 {fmtCurrency(taxAmt, data.currency, data.currencyMode)}
 </span>
 </div>
...
"flex justify-between",
 ...
 {/* Print Preview */}
 <GlassCard className="shadow-sm print:shadow-none print:bg-background print:border-0">
 <CardHeader>
 <CardTitle className="text-base">Preview</CardTitle>
 <CardDescription>
 This area is optimized for printing to PDF.
 </CardDescription>
 </CardHeader>
 <CardContent>
