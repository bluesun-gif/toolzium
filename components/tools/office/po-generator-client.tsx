...
export function PurchaseOrderClient() {
 ...
 <div className="space-y-8 bg-background text-black p-8 rounded border print:border-none">
 <div className="flex justify-between items-start">
 <div>
 <h1 className="text-3xl font-bold uppercase tracking-wider text-foreground">Purchase Order</h1>
 <div className="mt-2 text-sm text-muted-foreground">
 <p>PO Number: <span className="font-medium text-foreground">{poNumber}</span></p>
 <p>Date: <span className="font-medium text-foreground">{poDate}</span></p>
 <p>Terms: <span className="font-medium text-foreground">{paymentTerms}</span></p>
 </div>
 </div>
 </div>
