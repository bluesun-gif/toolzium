...
import { Truck, Plus, Copy, FileText, Sparkles, Shield, Zap } from "lucide-react";
...
export function BolGeneratorClient() {
  ...
  const [units, setUnits] = useState<HandlingUnit[]>([{
    qty: "",
    pkgType: "",
    weight: "",
    hm: false,
 ...
 <ToolPageHeader icon={Truck} title="Bill of Lading Generator" description="Generate official Bill of Lading (BOL) logistics shipping documents." actions={<>
 ...
 <CardContent className="space-y-4">
 {units.map((unit, i) => <div key={i} className="grid grid-cols-1 sm:grid-cols-5 gap-4 items-end">
 <div className="space-y-2">
 <Label>Qty</Label>
 ...
 {getBolText()}
      ...
      <ToolFeatureGuides features={[{
        ...
        <div className="prose dark:prose-invert max-w-none">
          <h3>Why Use Our Bill of Lading Generator?</h3>
          <p>
            This free online tool is designed to help you get accurate results quickly and securely.
            Whether you're a developer, designer, student, or professional, our Bill of Lading Generator provides
      ...
      <RelatedTools currentToolUrl="/tools/office/bol-generator" max={6} />
