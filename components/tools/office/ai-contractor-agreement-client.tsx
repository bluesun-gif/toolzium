...
export default function AiContractorAgreementClient() {
 ...
 {/* Output */}
 {results.length > 0 && <AiOutputDisplay title="Generated Contractor Agreement Draft Clauses" subtitle="Scope of work, IP ownership, payment terms, and non-disclosure clauses" content={results} loading={loading} onRegenerate={generateAgreement} variant="cards" />}
