...
=======
 {results.length > 0 && <AiOutputDisplay title="Generated Statement of Work (SOW) Document" subtitle="Milestone deliverables, acceptance criteria, and out-of-scope boundaries" content={results} loading={loading} onRegenerate={generateSow} variant="cards" />}
