...
export function CoverLetterClient() {
 ...
 const { name, email, phone, companyName, jobTitle, hiringManager, opening, skills, experience, closing } = details;
...
Contact: ${email ||"[Email]"} | ${phone ||"[Phone]"}`;
 ...
 const handleReset = () => {
 setDetails({
 name:"", email:"", phone:"", companyName:"", jobTitle:"", hiringManager:"",
 opening:"", skills:"", experience:"", closing:""
 });
 setTemplate("formal");
 };
 ...
 description="Build professional cover letters with customizable templates and live preview."
 actions={
 <>
