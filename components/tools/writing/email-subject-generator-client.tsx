...
SUBJECT | SCORE | REASONING`;
      ...
      setSubjects([{
        subject: `Quick update about ${purpose}`,
        score: 7,
        reasoning: "Simple and direct."
      }, {
        subject: `You may be missing this with ${purpose}`,
        score: 8,
        reasoning: "Creates curiosity."
      }, {
        subject: `The faster way to handle ${purpose}`,
        score: 7,
        reasoning: "Promises efficiency."
      }, {
        subject: `A better approach to ${purpose}`,
        score: 6,
        reasoning: "Clear but less urgent."
      }, {
        subject: `Don't ignore this if you care about ${purpose}`,
        score: 8,
        reasoning: "Uses urgency."
      }, {
        subject: `${purpose}: what you should know today`,
        score: 6,
        reasoning: "Informative tone."
      }, {
        subject: `How top teams handle ${purpose}`,
        score: 7,
        reasoning: "Uses social proof."
      }, {
        subject: `Your next step for ${purpose}`,
        score: 6,
        reasoning: "Action-oriented."
      }, {
        subject: `The ${purpose} checklist you need`,
        score: 7,
        reasoning: "Checklist framing performs well."
      }, {
        subject: `Still struggling with ${purpose}?`,
        score: 8,
        reasoning: "Pain-point question hook."
      }]);
 ...
 <input value={purpose} onChange={e => setPurpose(e.target.value)} className={inputClass} placeholder="e.g. announcing a new feature" />
 </div>
 <div className="space-y-2">
 <label className="text-xs font-medium text-muted-foreground">Audience</label>
 <input value={audience} onChange={e => setAudience(e.target.value)} className={inputClass} placeholder="e.g. SaaS founders" />
 </div>
 </div>
 ...
 {subjects.map((item, index) => <div key={`${item.subject}-${index}`} className="rounded-xl border border-border/60 bg-background/60 p-3 sm:p-4">
