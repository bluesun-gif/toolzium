...
Return ONLY the 3 summaries separated by ||| with no labels.`;
 ...
 setResult({
 concise: `${jobTitle} with ${years ||"relevant"} experience and strong skills in ${
 skills ||"core professional areas"
 }.`,
 detailed: `${jobTitle} with ${years ||"hands-on"} experience delivering practical results. Skilled in ${
 skills ||"key areas relevant to the role"
 }, with a focus on quality, collaboration, and continuous improvement.`,
 executive: `Results-driven ${jobTitle} with ${
 years ||"substantial"
 } years of experience leading initiatives, improving outcomes, and applying expertise in ${
 skills ||"strategic and operational priorities"
 }. Known for combining execution strength with clear communication and long-term value creation.`,
 });
 ...
 className={inputClass}
 placeholder="e.g. React, TypeScript, UI performance"
 />
 </div>
 </div>
