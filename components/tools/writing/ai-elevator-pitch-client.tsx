...
Return ONLY the 3 pitches separated by ||| with no labels.`;
 ...
 setResult({
 pitch30: `${idea} helps ${market ||"the right audience"} solve a key problem by ${
 value ||"delivering a faster, simpler solution"
 }.`,
 pitch60: `${idea} is designed for ${
 market ||"people who need a better solution"
 }. It addresses a real pain point by ${
 value ||"making the process faster, clearer, and more efficient"
 }. The result is a practical product that saves time and improves outcomes.`,
 pitch90: `${idea} is built for ${
 market ||"a clear target market"
 } that needs a more reliable and efficient way to get results. Instead of using slow or outdated methods, users benefit from ${
 value ||"a streamlined approach that improves the core workflow"
 ...
 placeholder="e.g. A marketplace for local freelance designers"
 />
 </div>
 ...
 className={inputClass}
 placeholder="e.g. faster hiring, lower cost"
 />
 </div>
 </div>
