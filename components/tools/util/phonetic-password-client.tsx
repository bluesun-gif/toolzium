...
import { Brain, Copy, Hash, Lock, RefreshCw, Settings, Shield, Sparkles, Zap } from "lucide-react";
...
export function PhoneticPasswordClient() {
 ...
 <div className="font-bold">{getCrackingTime(entropy)}</div>
      ...
      <ToolHowItWorks steps={[
        { step: "01", title: "Enter Password Length", description: "Set how long you want your phonetic password to be.", icon: Hash },
        { step: "02", title: "Choose Pattern", description: "Select consonant-vowel pattern for maximum memorability.", icon: Settings },
        { step: "03", title: "Generate & Copy", description: "Get a pronounceable password that's both secure and easy to remember.", icon: Copy },
      ]} badges={["Pronounceable", "Memorable", "Random"]} />

      <ToolFeatureGuides features={[
        { icon: Brain, title: "Pronounceable Passwords", description: "Generates passwords using consonant-vowel patterns that sound like real words — easy to say and remember." },
        { icon: Shield, title: "Secure & Memorable", description: "Combines memorability with real random generation for passwords you won't forget." },
        { icon: RefreshCw, title: "Unlimited Generation", description: "Generate as many options as you want until you find one you like." },
      ]}>
