      ...
      {[0, 1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
        <div
          ...
          className={
            ...
            (dots.includes(i) ? "bg-slate-800" : "bg-transparent")
          }
        />
      ))}
    </div>
                          ...
                          <div className="flex gap-2">
                            {record.values.map((v, i) => (
                              <Badge
                                key={i}
                                variant="outline"
                                className="w-6 h-6 p-0 flex items-center justify-center bg-white"
                              >
                                {v}
                              </Badge>
                            ))}
                  ...
                  <div className="space-y-2">
                    {distribution.map((d) => (
                      <div key={d.value} className="flex items-center gap-3">
                        ...
                        <div className="w-8 text-right text-sm text-slate-500">
                          {d.count}
                        </div>
                      </div>
                    ))}
