...
import { Scale, Briefcase, AlertTriangle, Plus, Trash2 } from"lucide-react";
...
export function PackingWeightClient() {
 ...
 description="Estimate your luggage weight, organize items by category, and avoid overweight baggage fees."
 actions={
 <ResetButton onClick={() => { setItems([]); setLimit(isKg ? 23 : Math.round(23 * LB_IN_KG)); }} label="Reset List"/>
 }
 />
 ...
 <div className="space-y-6">
 {CATEGORIES.filter(c => categoryTotals[c] > 0).map(category => (
 <div key={category}>
