...
import { Send, Clock, Navigation, ArrowLeftRight } from "lucide-react";
import { Separator } from "@/components/ui/separator";

// City coordinates database
const cities = [
  { id: "lhr", name: "London, UK", lat: 51.4700, lon: -0.4543 },
  { id: "jfk", name: "New York, USA", lat: 40.6413, lon: -73.7781 },
  { id: "lax", name: "Los Angeles, USA", lat: 33.9416, lon: -118.4085 },
  { id: "hnd", name: "Tokyo, Japan", lat: 35.5494, lon: 139.7798 },
  { id: "cdg", name: "Paris, France", lat: 49.0097, lon: 2.5479 },
  { id: "dxb", name: "Dubai, UAE", lat: 25.2532, lon: 55.3657 },
  { id: "syd", name: "Sydney, Australia", lat: -33.9399, lon: 151.1753 },
  { id: "sin", name: "Singapore", lat: 1.3644, lon: 103.9915 },
  { id: "yyz", name: "Toronto, Canada", lat: 43.6777, lon: -79.6248 },
  { id: "gru", name: "São Paulo, Brazil", lat: -23.4356, lon: -46.4731 },
  { id: "jnb", name: "Johannesburg, RSA", lat: -26.1367, lon: 28.2411 },
  { id: "del", name: "New Delhi, India", lat: 28.5562, lon: 77.1000 },
  { id: "peck", name: "Beijing, China", lat: 40.0799, lon: 116.6031 },
  { id: "fra", name: "Frankfurt, Germany", lat: 50.0333, lon: 8.5706 },
  { id: "mxp", name: "Milan, Italy", lat: 45.6301, lon: 8.7231 },
  ...
  return (
    <div className="space-y-6">
      <ToolPageHeader
        ...
        description="Estimate flight durations, distances, and layovers between global destinations."
        actions={
        ...
        <GlassCard className="bg-primary/5 border-primary/20 flex flex-col justify-center">
          ...
          <CardContent className="space-y-8">
            <div className="text-center space-y-2">
              ...
              {isRoundTrip && (
                <div className="text-sm font-medium text-primary uppercase tracking-wider">Round Trip Total</div>
              )}
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-background/80 p-4 rounded-lg flex flex-col items-center text-center space-y-2">
                ...
                <span className="text-xs text-muted-foreground">{(totalDist * 0.621371).toLocaleString(undefined, {maximumFractionDigits: 0})} miles</span>
              </div>
              <div className="bg-background/80 p-4 rounded-lg flex flex-col items-center text-center space-y-2">
