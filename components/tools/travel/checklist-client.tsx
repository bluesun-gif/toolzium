...
export function TravelChecklistClient() {
 ...
 arr.forEach((text, i) => {
 list.push({ id: `${cat}-${i}`, text, checked: false, category: cat });
 });
 });
 
 // Add specific items based on type
 if (type ==="Business") {
 list.push({ id: `ext-1`, text:"Laptop", checked: false, category:"Electronics"});
 list.push({ id: `ext-2`, text:"Business Cards", checked: false, category:"Documents"});
 } else if (type ==="Beach") {
 list.push({ id: `ext-1`, text:"Swimsuit", checked: false, category:"Clothing"});
 list.push({ id: `ext-2`, text:"Sunscreen", checked: false, category:"Toiletries"});
 } else if (type ==="Winter") {
 list.push({ id: `ext-1`, text:"Winter Coat", checked: false, category:"Clothing"});
 list.push({ id: `ext-2`, text:"Gloves", checked: false, category:"Clothing"});
 }
 ...
 setItems([...items, { id: `custom-${Date.now()}`, text: newItem, checked: false, category: newCategory }]);
 setNewItem("");
 };
 ...
 description="Pre-trip checklist generator. Auto-generate and manage packing items."
 actions={
 <>
