...
import { Bike, Car, Crosshair, Footprints, Map as MapIcon, MapPin, MoveRight, Navigation2, RefreshCcw, Route, Sparkles, Shield, Zap, Copy } from"lucide-react";
 ...
 use a maps app.
      ...
      >
        <div className="prose dark:prose-invert max-w-none">
          <h3>Why Use Our Distance & ETA?</h3>
          <p>
            This free online tool is designed to help you get accurate results quickly and securely.
            Whether you're a developer, designer, student, or professional, our Distance & ETA provides
      ...
      <RelatedTools currentToolUrl="/tools/travel/distance" max={6} />
