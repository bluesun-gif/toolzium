...
export default function UuidGeneratorClient() {
 ...
 <div className="space-y-2">
 {uuids.map((uuid, idx) => <div key={uuid} className="flex flex-col sm:flex-row sm:items-center gap-2 rounded-lg border border-border/60 bg-background/60 p-3">
 ...
 <ToolHowItWorks steps={[{
        ...
        description: "Select how many UUIDs you need, from 1 to 10 at a time.",
        icon: Hash
      }, {
        step: "02",
        title: "Generate",
        description: "Click the button to create RFC 4122 v4 UUIDs using your browser's secure random source.",
        icon: RefreshCw
      }, {
        step: "03",
        title: "Copy",
        description: "Copy individual UUIDs or the entire list at once for use in your project.",
        icon: Fingerprint
 ...
 <ToolFeatureGuides features={[{
        icon: Fingerprint,
        title: "RFC 4122 v4",
        description: "Generates standards-compliant version 4 UUIDs with correct version and variant bits."
      }, {
        icon: Hash,
        title: "Batch Generation",
        description: "Create up to 10 UUIDs in a single click for bulk seeding or testing."
      }, {
        icon: Zap,
        title: "CSPRNG",
        description: "Uses crypto.randomUUID() or crypto.getRandomValues() for true randomness."
      }, {
        icon: RefreshCw,
        title: "Private",
        description: "All generation happens in your browser. No network calls, no logging."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        ...
        answer: "The probability is astronomically small. You would need to generate roughly 2^61 UUIDs to have a 50% chance of a single collision. In practice, collisions are effectively impossible."
      }, {
        question: "What is the difference between UUID v4 and v7?",
        answer: "v4 is fully random and great for general use. v7 embeds a Unix timestamp in the first 48 bits, making UUIDs sortable by time — useful for database performance."
      }, {
        question: "Can I use UUIDs as database primary keys?",
        answer: "Yes, they are widely used as PKs, especially in distributed systems. Consider storing them as BINARY(16) instead of strings to save space and improve index performance."
      }, {
