...
export default function Base64EncoderClient() {
 ...
 return mode ==="encode"
 ?"⚠️ Unable to encode input. Check for unsupported characters."
 ...
 description="Encode text to Base64 or decode Base64 strings instantly in your browser. No data leaves your device."
 />
 ...
 <ToolHowItWorks
 steps={[
 { step:"01", title:"Choose Mode", description:"Select whether you want to encode plain text to Base64 or decode an existing Base64 string.", icon: Binary },
 { step:"02", title:"Paste Your Data", description:"Drop your text into the input box. Conversion happens instantly as you type.", icon: RefreshCw },
 { step:"03", title:"Copy Result", description:"Copy the encoded or decoded output with a single click and use it anywhere.", icon: ArrowRight },
 ]}
 ...
 <ToolFeatureGuides
 features={[
 { icon: Binary, title:"UTF-8 Safe", description:"Correctly handles multibyte Unicode characters, emojis, and non-ASCII text without corruption."},
 { icon: Lock, title:"Private by Default", description:"All encoding and decoding runs entirely in your browser. Nothing is ever sent to a server."},
 { icon: Zap, title:"Instant Conversion", description:"Output updates live as you type thanks to reactive memoized computation."},
 { icon: Shield, title:"Error Handling", description:"Invalid Base64 input is detected and flagged immediately without crashing the interface."},
 ]}
 >
 ...
 <ToolFaqAccordion
 faqs={[
 { question:"Is Base64 encoding the same as encryption?", answer:"No. Base64 is an encoding scheme, not encryption. It can be trivially reversed by anyone. Never use it to protect sensitive data."},
 { question:"Why does my decoded output look garbled?", answer:"This usually happens with non-ASCII characters. Our tool uses UTF-8 safe encoding and decoding to handle Unicode and emojis correctly."},
 { question:"Can I encode files like images?", answer:"This tool handles text input. For binary files like images, you would first need to convert the file bytes to a Base64 string, which is commonly done with FileReader in the browser."},
 { question:"Is my data safe?", answer:"Yes. All processing happens locally in your browser using the native btoa() and atob() functions. No data is transmitted to any server."},
 ]}
 />
