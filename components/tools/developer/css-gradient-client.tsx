...
export default function CssGradientClient() {
 ...
 description="Build beautiful linear and radial CSS gradients with a live preview and ready-to-copy code."
 />
 ...
 className="h-10 w-12 cursor-pointer rounded border border-border/70 bg-transparent"
 />
 <Input
 value={color1}
 onChange={(e) => setColor1(e.target.value)}
 ...
 className={`px-4 py-2 text-sm font-medium ${type ==="linear"?"bg-primary text-primary-foreground":"bg-background/80 hover:bg-muted/40"}`}
 >
 Linear
 </button>
 <button
 onClick={() => setType("radial")}
 className={`px-4 py-2 text-sm font-medium ${type ==="radial"?"bg-primary text-primary-foreground":"bg-background/80 hover:bg-muted/40"}`}
 >
 Radial
 </button>
 </div>
 ...
 <ToolHowItWorks
 steps={[
 { step:"01", title:"Pick Two Colors", description:"Use the native pickers or type HEX values to define the start and end of your gradient.", icon: Sparkles },
 { step:"02", title:"Choose Type & Direction", description:"Switch between linear and radial, and pick a direction for linear gradients.", icon: Move },
 { step:"03", title:"Copy the CSS", description:"Copy the generated rule and paste it into your stylesheet or Tailwind arbitrary value.", icon: Layers },
 ]}
 ...
 <ToolFeatureGuides
 features={[
 { icon: Layers, title:"Linear & Radial", description:"Supports both gradient types with full control over direction and shape."},
 { icon: Eye, title:"Live Preview", description:"See exactly how your gradient will render before copying the code."},
 { icon: Sparkles, title:"Native Pickers", description:"Uses the browser color picker for quick, intuitive color selection."},
 { icon: Move, title:"8 Directions", description:"All standard linear gradient directions are available out of the box."},
 ]}
 >
 ...
 <ToolFaqAccordion
 faqs={[
 { question:"Can I add more than two colors?", answer:"This generator focuses on two-color gradients. To add more stops, simply insert extra color values between the two colors in the generated CSS, separated by commas."},
 { question:"Do gradients work in all browsers?", answer:"Yes. Linear and radial gradients are supported in all modern browsers including Chrome, Firefox, Safari, and Edge. No vendor prefixes are needed today."},
 { question:"Can I use this with Tailwind?", answer:"Yes. Paste the generated CSS into a custom utility, or use Tailwind's arbitrary value syntax like bg-[linear-gradient(to_right,#6366f1,#ec4899)]."},
 ]}
 />
