...
export default function HtmlEntityClient() {
 ...
 description="Convert special characters to safe HTML entities and back. Prevent XSS and preserve formatting."
 />
 ...
 placeholder={mode ==="encode"? '<script>alert("xss")</script>' :"&lt;p&gt;Hello &amp; welcome&lt;/p&gt;"}
 />
 ...
 <ToolHowItWorks
 steps={[
 { step:"01", title:"Select Encode or Decode", description:"Choose whether to convert raw characters into HTML entities or reverse the process.", icon: Code },
 { step:"02", title:"Paste Your Text", description:"Drop in HTML source code, user-submitted content, or encoded strings.", icon: RefreshCw },
 { step:"03", title:"Copy the Result", description:"Use the safe output in templates, emails, or anywhere untrusted text is rendered.", icon: ArrowRight },
 ]}
 ...
 <ToolFeatureGuides
 features={[
 { icon: Code, title:"Five Core Entities", description:"Handles &, <, >, double quotes, and single quotes — the characters that break HTML structure."},
 { icon: Shield, title:"XSS Prevention", description:"Escaping user input before rendering prevents cross-site scripting attacks."},
 { icon: Globe, title:"Numeric Decoding", description:"Decodes both named entities and numeric references like &#169; and &#x00A9;."},
 { icon: Zap, title:"Live Conversion", description:"Instant transformation as you type without any external dependencies."},
 ]}
 >
 ...
 <ToolFaqAccordion
 faqs={[
 { question:"Do I need to escape everything or just the five core characters?", answer:"For text content, escaping the five core characters is sufficient. Inside attribute values, you should also be careful with attribute delimiters. For URLs inside href/src, use URL encoding instead."},
 { question:"Is HTML entity encoding enough to prevent XSS?", answer:"Encoding is one layer of defense. You must also validate input, use Content Security Policy headers, avoid innerHTML with user data, and sanitize rich content with libraries like DOMPurify."},
 { question:"What's the difference between &apos; and &#39;?", answer:"&apos; is XML/XHTML but not part of HTML4. &#39; (numeric) works universally across all HTML versions and is therefore the safer choice."},
 ]}
 />
