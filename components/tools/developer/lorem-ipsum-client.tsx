...
import { AlignLeft, FileText, Clock, RefreshCw, Copy, Settings } from "lucide-react";
...
export default function LoremIpsumClient() {
 ...
 <ToolPageHeader icon={AlignLeft} title="Lorem Ipsum Generator" description="Generate placeholder text in words, sentences, or paragraphs for mockups and layouts." />
 ...
 <select value={count} onChange={e => setCount(parseInt(e.target.value, 10))} className="w-full rounded-lg border border-border/70 bg-background/80 p-2.5 text-sm outline-none focus:ring-2 focus:ring-primary/50">
 ...
 <select value={unit} onChange={e => setUnit(e.target.value as UnitType)} className="w-full rounded-lg border border-border/70 bg-background/80 p-2.5 text-sm outline-none focus:ring-2 focus:ring-primary/50">
 ...
 {stats && <div className="flex flex-wrap gap-4 text-xs text-muted-foreground">
 ...
 <ToolHowItWorks steps={[{
        step: "01",
        title: "Choose Amount",
        description: "Select how many units of text you need, from 1 to 10.",
        icon: FileText
      }, {
        step: "02",
        title: "Pick the Unit",
        description: "Decide whether you want individual words, sentences, or full paragraphs.",
        icon: AlignLeft
      }, {
        step: "03",
        title: "Generate & Copy",
        description: "Click generate and copy the placeholder text directly into your design or draft.",
        icon: RefreshCw
 ...
 <ToolFeatureGuides features={[{
        icon: AlignLeft,
        title: "Three Units",
        description: "Generate placeholder text as words, sentences, or paragraphs depending on your layout needs."
      }, {
        icon: FileText,
        title: "Classic Source",
        description: "Uses the traditional Lorem Ipsum passage dating back to Cicero's writings in 45 BC."
      }, {
        icon: Clock,
        title: "Instant Generation",
        description: "No network calls or waiting — output is produced the moment you click."
      }, {
        icon: RefreshCw,
        title: "Live Stats",
        description: "Shows word, character, and paragraph counts so you know exactly how much text you have."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        ...
        answer: "It comes from sections 1.10.32 and 1.10.33 of 'de Finibus Bonorum et Malorum' (The Extremes of Good and Evil) by Cicero, written in 45 BC. The passage was discovered by Richard McClintock in 1914."
      }, {
        question: "Is it safe to use Lorem Ipsum in client mockups?",
        answer: "Yes, it is universally recognized as placeholder text. Just make sure you replace it with real content before the final release."
      }, {
        question: "Can I use this for production content?",
        answer: "No. Lorem Ipsum is meaningless text intended only for design placeholders. Always use real content for published material."
      }]} />
    </div>
    </div>
);
