...
export default function ColorConverterClient() {
 ...
 <div className="h-40 w-full rounded-xl border border-border/60 shadow-inner transition-colors" style={{
              backgroundColor: normalizedHex ?? "#000000"
            }} />
 <div className="grid grid-cols-[auto_1fr] gap-3 items-center">
 <input type="color" value={normalizedHex ?? "#000000"} onChange={e => setHexInput(e.target.value)} className="h-12 w-16 cursor-pointer rounded-lg border border-border/70 bg-transparent" />
 <Input value={hexInput} onChange={e => setHexInput(e.target.value)} placeholder="#3b82f6 or 3b82f6" className="font-mono" />
 </div>
 {!normalizedHex && <p className="text-xs text-red-500">Invalid HEX value. Use 3 or 6 hex characters.</p>}
 </CardContent>
 </GlassCard>
 ...
 <ToolHowItWorks steps={[{
        ...
        description: "Use the native color picker or type a HEX value directly into the input field.",
        icon: Droplet
      }, {
        step: "02",
        title: "See Live Preview",
        description: "The swatch updates instantly so you can verify the exact color you selected.",
        icon: Eye
      }, {
        step: "03",
        title: "Copy Any Format",
        description: "Grab HEX, RGB, or HSL strings and paste them into your CSS, Tailwind config, or design tool.",
        icon: Palette
 ...
 <ToolFeatureGuides features={[{
        icon: Palette,
        title: "Three Formats",
        description: "Instantly convert between HEX, RGB, and HSL — the three most common color representations."
      }, {
        icon: Eye,
        title: "Live Swatch",
        description: "Visual feedback ensures you pick exactly the color you intend."
      }, {
        icon: Droplet,
        title: "3 & 6 Digit HEX",
        description: "Accepts shorthand (#fff) and full (#ffffff) HEX notation automatically."
      }, {
        icon: Zap,
        title: "Native Color Picker",
        description: "Uses the browser's built-in color input for an intuitive selection experience."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        ...
        answer: "They encode the same information. HEX uses base-16 notation (#RRGGBB) while RGB uses decimal triplets (rgb(r, g, b)). #ff8800 is identical to rgb(255, 136, 0)."
      }, {
        question: "When should I use HSL?",
        answer: "HSL is best when you want to generate color variations. For example, reducing lightness gives a darker shade, and changing hue rotates the color around the wheel."
      }, {
