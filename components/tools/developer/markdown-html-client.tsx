...
export default function MarkdownHtmlClient() {
 ...
 <ToolPageHeader icon={FileCode} title="Markdown to HTML Converter" description="Convert Markdown syntax to clean HTML with live preview. No external libraries required." />
 ...
 <textarea value={input} onChange={e => setInput(e.target.value)} rows={14} className="w-full rounded-lg border border-border/70 bg-background/80 p-3 font-mono text-sm outline-none focus:ring-2 focus:ring-primary/50" placeholder="# Heading&#10;&#10;**bold** and *italic*" />
 ...
 <CardContent className="p-3 sm:p-4 space-y-3">
 <div className="prose prose-sm dark:prose-invert max-h-80 overflow-y-auto rounded-lg border border-border/60 bg-background/60 p-4" dangerouslySetInnerHTML={{
              __html: html
            }} />
 </CardContent>
 </GlassCard>
 ...
 <ToolHowItWorks steps={[{
        ...
        description: "Type or paste any markdown text into the input area.",
        icon: Code
      }, {
        step: "02",
        title: "See Live HTML",
        description: "The converter parses headings, lists, bold, italic, code, and links instantly.",
        icon: Eye
      }, {
        step: "03",
        title: "Copy the Source",
        description: "Copy the generated HTML and paste it into your website, email, or CMS.",
        icon: FileCode
 ...
 <ToolFeatureGuides features={[{
        ...
        description: "Supports H1, H2, H3 headings and unordered lists using the dash syntax."
      }, {
        icon: Code,
        title: "Inline Formatting",
        description: "Converts **bold**, *italic*, `code`, and [link](url) syntax into proper HTML."
      }, {
        icon: Eye,
        title: "Live Preview",
        description: "See the rendered HTML alongside the raw source so you can verify output immediately."
      }, {
        icon: Zap,
        title: "No Dependencies",
        description: "Runs entirely with native JavaScript — no external markdown libraries required."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        question: "Is this converter safe against XSS?",
        answer: "Yes. The input is HTML-escaped before any transformations are applied, so injected tags cannot break out of the rendered output."
      }, {
        question: "Does it support tables or blockquotes?",
        answer: "This converter focuses on core syntax. Tables, blockquotes, and fenced code blocks are not supported. Use a full CommonMark library for those."
      }, {
        question: "Can I use this in production?",
        answer: "Absolutely, for small snippets and controlled inputs. For full user-generated content, combine it with a sanitizer like DOMPurify."
      }]} />
