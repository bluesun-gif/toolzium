...
export default function PdfSignFillClient() {
 ...
 if (placedSig) {
 if (
 clickX >= placedSig.x && clickX <= placedSig.x + placedSig.width &&
 clickY >= placedSig.y && clickY <= placedSig.y + placedSig.height
 ) {
 setIsDragging(true);
 setDragOffset({ x: clickX - placedSig.x, y: clickY - placedSig.y });
 return;
 }
 }
 };
 ...
 description="Add a real signature to any PDF. Type, draw, or upload your signature — then click or drag it anywhere on the page."
 />
 ...
 />
 {sigDataUrl && (
 <div className="border rounded-xl p-3 bg-background/5">
 ...
 <div className="overflow-auto border-2 border-border rounded-xl bg-gray-100"style={{ maxHeight:"70vh"}}>
 <div
 ref={previewRef}
 className="relative cursor-crosshair select-none mx-auto"
 style={{ width: pdfPageWidth, height: pdfPageHeight }}
 ...
 alt="Signature"
 className="absolute border-2 border-primary/60 rounded cursor-move bg-background/30 backdrop-blur-[1px]"
 style={{
 left: placedSig.x,
 top: placedSig.y,
 ...
 {!placedSig && sigDataUrl && (
 <div className="absolute top-2 left-2 bg-primary text-primary-foreground text-xs px-3 py-1.5 rounded-full font-bold shadow animate-pulse pointer-events-none">
 ...
 <ToolHowItWorks
 steps={[
 { step:"01", title:"Upload PDF", description:"Select the PDF document you want to sign or fill.", icon: Upload },
 { step:"02", title:"Create Signature", description:"Type, draw, or upload an image of your signature.", icon: Pen },
 { step:"03", title:"Click & Download", description:"Click anywhere on the preview to place the signature, then save.", icon: Download }
 ]}
 ...
 <ToolFeatureGuides
 features={[
 { icon: FileSignature, title:"Sign Documents", description:"Quickly sign contracts, invoices, and forms from your browser."},
 { icon: Hand, title:"Click & Drag", description:"Easily position your signature with pixel-perfect accuracy."},
 { icon: ShieldCheck, title:"Private & Secure", description:"All processing happens locally on your device. We never upload your PDFs."},
 { icon: Type, title:"Type or Draw", description:"Use our built-in signature generator or draw your own with your mouse."},
 { icon: ImageIcon, title:"Image Upload", description:"Upload a pre-made transparent PNG or JPG signature."},
 { icon: Zap, title:"Lightning Fast", description:"No server uploads mean instantaneous document rendering and downloading."}
 ]}
 >
 ...
 <ToolFaqAccordion
 faqs={[
 { question:"Is my PDF uploaded to a server?", answer:"No, all PDF manipulation and rendering happens securely in your web browser. Your files are never sent to or stored on our servers."},
 { question:"How do I ensure the signature is in the right place?", answer:"Once you have generated your signature, simply click anywhere on the document preview to place it. You can then click and drag the signature to precisely adjust its position."},
 { question:"Can I sign multiple pages?", answer:"Currently, you can add a signature to the page you have selected. If you need to sign multiple pages, you can apply your signature to one page, download the document, and then re-upload it to sign another page."},
 { question:"What formats can I upload for my signature?", answer:"If you choose the 'Upload Image' option, you can upload PNG and JPG files. We recommend using a PNG with a transparent background for the best results."},
 { question:"Can I use this on my mobile device?", answer:"Yes! The tool works on mobile devices. You can use your touchscreen to draw a signature and place it on your document."},
 { question:"Is this tool completely free?", answer:"Yes, our PDF Sign & Fill tool is 100% free with no hidden fees or watermarks added to your downloaded documents."}
 ]}
 />
