...
export default function PdfRotateClient() {
 ...
 <input type="file" accept="application/pdf" onChange={handleFileChange} className="hidden" id="pdf-rotate-upload" />
 ...
 {file && <div className="space-y-4 pt-2">
 <div className="space-y-2">
 <label className="text-xs font-bold text-foreground block">Rotation Direction & Angle:</label>
 <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
 <Button type="button" variant={rotationAngle === 90 ? "default" : "outline"} onClick={() => setRotationAngle(90)} className="gap-2 font-semibold">
 <RotateCw className="h-4 w-4" />
 90° Right
 </Button>
 <Button type="button" variant={rotationAngle === 180 ? "default" : "outline"} onClick={() => setRotationAngle(180)} className="gap-2 font-semibold">
 <RotateCw className="h-4 w-4" />
 180° Flip
 </Button>
 <Button type="button" variant={rotationAngle === 270 ? "default" : "outline"} onClick={() => setRotationAngle(270)} className="gap-2 font-semibold">
 ...
 <Button onClick={rotatePdf} disabled={rotating} className="gap-2 font-bold h-11 px-6 shadow-md">
