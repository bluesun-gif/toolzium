...
export default function PdfProtectClient() {
 ...
 <input type="file" accept="application/pdf" onChange={handleFileChange} className="hidden" id="pdf-protect-upload" />
 ...
 <Input type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="Set document password..." className="h-11 font-medium" />
 </div>

 <div className="flex justify-end">
 <Button onClick={protectPdf} disabled={protecting || !password.trim()} className="gap-2 font-bold h-11 px-6 shadow-md">
 ...
 <ToolHowItWorks title="How to Protect a PDF Document" steps={[{
        step: "Step 1",
        title: "Upload PDF",
 ...
 <ToolFeatureGuides title="Why Use Our PDF Protector?" features={[{
