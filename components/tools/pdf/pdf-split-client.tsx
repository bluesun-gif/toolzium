...
export default function PdfSplitClient() {
 ...
 {totalPages > 0 && <div className="text-xs text-primary font-bold">Total Pages: {totalPages}</div>}
 </label>
 </div>
 ...
 <Input type="text" value={pageRange} onChange={e => setPageRange(e.target.value)} placeholder="e.g. 1-3, 5" className="h-11 font-medium" />
 </div>

 <div className="flex justify-end">
 <Button onClick={splitPdf} disabled={splitting || !file} className="gap-2 font-bold h-11 px-6 shadow-md">
 ...
 <ToolHowItWorks title="How to Split and Extract PDF Pages" badges={["100% Free", "Client-Side Privacy", "Page Selection"]} steps={[{
        step: "Step 1",
