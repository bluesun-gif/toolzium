...
export function ColorSwapperClient() {
 ...
 description="Swap specific colors in your images locally in your browser."
 actions={
 <ResetButton onClick={handleReset} label="Reset Image"/>
 }
 />
 ...
 <CardContent>
 {!imageSrc ? (
 <div className="aspect-video bg-muted/20 rounded-xl flex flex-col items-center justify-center text-muted-foreground border border-dashed">
 ...
 {resultSrc ? (
 <img src={resultSrc} alt="Result"className="w-full rounded-lg shadow-sm border max-h-[400px] object-contain bg-muted/20"/>
 ) : (
 <div className="w-full h-full min-h-[200px] rounded-lg shadow-sm border flex items-center justify-center bg-muted/10 text-muted-foreground text-sm">
 Waiting to process...
 </div>
 )}
 </div>
