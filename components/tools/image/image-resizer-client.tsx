...
import { Scaling, Upload, Download, RefreshCw, Trash2, Image as ImageIcon, Sparkles, Crop, Maximize2, CheckCircle2, Zap, Shield, Copy } from"lucide-react";
...
const SOCIAL_PRESETS: SocialPreset[] = [
 // Facebook
 { platform:"Facebook", label:"Facebook Portrait Post", w: 1080, h: 1350, ratio:"4:5", badgeColor:"bg-blue-600/10 text-primary border-blue-600/30"},
 { platform:"Facebook", label:"Facebook Square Post", w: 1080, h: 1080, ratio:"1:1", badgeColor:"bg-blue-600/10 text-primary border-blue-600/30"},
 { platform:"Facebook", label:"Facebook Cover Banner", w: 1640, h: 924, ratio:"16:9", badgeColor:"bg-blue-600/10 text-primary border-blue-600/30"},
 { platform:"Facebook", label:"Facebook Story / Reel", w: 1080, h: 1920, ratio:"9:16", badgeColor:"bg-blue-600/10 text-primary border-blue-600/30"},
 // Instagram
 ...
 // X / Twitter
 { platform:"Twitter", label:"X (Twitter) Post", w: 1200, h: 675, ratio:"16:9", badgeColor:"bg-slate-700/10 text-slate-700 dark:text-slate-300 border-border/30"},
 { platform:"Twitter", label:"X Header Banner", w: 1500, h: 500, ratio:"3:1", badgeColor:"bg-slate-700/10 text-slate-700 dark:text-slate-300 border-border/30"},
 // Pinterest & YouTube
      ...
      >
        <div className="prose dark:prose-invert max-w-none">
          ...
          <p>
            ...
            Whether you're a developer, designer, student, or professional, our Social Media Image Resizer & Aspect Ratio Tool provides
