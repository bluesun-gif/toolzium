...
const keywords = [
  "placeholder image", "dummy image", "placeholder img", "lorem image", "test image", "filler image", "placeholder image generator", "dummy image generator", "placeholder picture", "sample image", "blank image generator", "image placeholder online", "placeholder image maker", "Toolzium", "online tools"
];

const PRESETS = [
  { label: "Avatar (150x150)", w: 150, h: 150 },
  { label: "Ad (300x250)", w: 300, h: 250 },
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <ToolPageHeader
        ...
        description="Generate placeholder images with custom dimensions, colors, and text. Create dummy images for mockups, wireframes, and development."
        icon={ImageIcon}
      />
        ...
        <div className="lg:col-span-7">
          <GlassCard className="h-full flex flex-col">
            ...
            <CardContent className="flex-1 flex flex-col items-center justify-center p-6 bg-muted/20 overflow-hidden min-h-[400px]">
              <div className="relative max-w-full max-h-full overflow-auto rounded-lg border border-border shadow-sm flex items-center justify-center bg-white">
                <canvas
                  ref={canvasRef}
