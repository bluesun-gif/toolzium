...
const pairings = [{
  ...
  url: "https://fonts.googleapis.com/css2?family=Playfair+Display:wght@700&family=Source+Sans+Pro:wght@400&display=swap"
}, {
  id: "3",
  category: "Classic",
  heading: "Merriweather",
  body: "Open Sans",
  url: "https://fonts.googleapis.com/css2?family=Merriweather:wght@700&family=Open+Sans:wght@400&display=swap"
}, {
  id: "4",
  category: "Minimal",
  heading: "Inter",
  ...
  heading: "Oswald",
  body: "Lora",
  url: "https://fonts.googleapis.com/css2?family=Lora:wght@400&family=Oswald:wght@700&display=swap"
}, {
  id: "6",
  category: "Playful",
  heading: "Pacifico",
  body: "Quicksand",
  url: "https://fonts.googleapis.com/css2?family=Pacifico&family=Quicksand:wght@400&display=swap"
}, {
  id: "7",
  category: "Classic",
  heading: "Lora",
  body: "Merriweather",
  url: "https://fonts.googleapis.com/css2?family=Lora:wght@700&family=Merriweather:wght@400&display=swap"
}, {
  id: "8",
  category: "Modern",
  heading: "Poppins",
  body: "PT Sans",
  url: "https://fonts.googleapis.com/css2?family=Poppins:wght@700&family=PT+Sans:wght@400&display=swap"
}, {
  id: "9",
  category: "Bold",
  heading: "Bebas Neue",
  body: "Montserrat",
  url: "https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Montserrat:wght@400&display=swap"
}, {
  id: "10",
  category: "Minimal",
  heading: "Work Sans",
  body: "Open Sans",
  url: "https://fonts.googleapis.com/css2?family=Work+Sans:wght@600&family=Open+Sans:wght@400&display=swap"
}];
