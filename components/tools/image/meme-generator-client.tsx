...
export default function MemeGeneratorClient() {
 ...
 description="Create custom memes instantly in your browser. Upload your own image, edit texts, customize fonts, and download watermark-free memes."
 />
 ...
 <canvas
 ref={canvasRef}
 className="max-w-full h-auto rounded-lg shadow-md border bg-card"
 />
 ...
 className={cn("relative aspect-video rounded-md overflow-hidden border-2 transition", (imageSrc === tpl.url ?"border-primary scale-95":"border-transparent hover:border-muted-foreground"))}
 >
