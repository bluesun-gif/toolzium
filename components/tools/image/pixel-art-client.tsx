...
import { Pen, Eraser, Download, Grid, Undo2, MousePointer, Sparkles, Shield, Zap, Copy } from"lucide-react";
...
export function PixelArtClient() {
 ...
 description="Create, edit and download your own pixel art online."
 actions={
 <ActionButton onClick={handleDownload} icon={Download} label="Export PNG"/>
 }
 />
 ...
 className="w-12 h-12 p-1 bg-background border rounded cursor-pointer"
 />
 ...
 <div 
 className="relative bg-background shadow-lg rounded-sm overflow-hidden touch-none"
 style={{ width: '100%', maxWidth: '512px', aspectRatio: '1/1' }}
 >
 <canvas
 ref={canvasRef}
 width={512}
 ...
 />
      ...
      >
        <div className="prose dark:prose-invert max-w-none">
          ...
          <p>
            ...
            Whether you're a developer, designer, student, or professional, our c provides
      ...
      <RelatedTools currentToolUrl="/tools/image/pixel-art" max={6} />
