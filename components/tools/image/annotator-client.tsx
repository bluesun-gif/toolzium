...
export function AnnotatorClient() {
 ...
 description="Add shapes, arrows, text, and highlights to your images before sharing."
 actions={
 <>
 ...
 placeholder="Click on image to place"
 />
 </div>
 )}
 ...
 <div 
 key={c}
 className="w-6 h-6 rounded-full cursor-pointer border shadow-sm"
 ...
 className={cn(
"max-w-full shadow-lg border rounded-sm",
