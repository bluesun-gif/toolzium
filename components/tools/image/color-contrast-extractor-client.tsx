...
export function ColorContrastClient() {
  ...
  const Badge = ({ label, passed }: { label: string, passed: boolean }) => (
    <div className={"flex items-center gap-2 px-3 py-1 rounded-full text-sm font-medium " + (passed ? "bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200" : "bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-200")}>
  ...
  return (
    <div className="space-y-6">
      <ToolPageHeader
        ...
        description="Check WCAG contrast ratios and accessibility."
        icon={CheckCircle}
        actions={
          <ResetButton onClick={() => { setTextColor("#FFFFFF"); setBgColor("#000000"); setBorderColor("#444444"); }} />
        }
      />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <GlassCard>
          ...
          <CardContent>
            <div
              className="p-8 rounded-lg shadow-inner flex flex-col gap-6 transition-colors duration-200"
            ...
            >
              ...
              <div className="flex flex-wrap gap-4 items-center">
                ...
                <button
                  className="px-4 py-2 font-medium rounded-md shadow-sm border-2"
              ...
              <div
                ...
                style={{ backgroundColor: "rgba(0,0,0,0.1)", borderColor: borderColor }}
              >
