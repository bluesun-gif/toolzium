...
export function RetirementClient() {
 ...
 <div className="text-3xl font-bold text-primary">${totalAtRetirement.toLocaleString(undefined, {
 ...
 <div className="text-3xl font-bold">${monthlyIncome.toLocaleString(undefined, {
                      maximumFractionDigits: 0
                    })}</div>
 </div>
 </div>
 ...
 <span className="font-medium">${totalContributed.toLocaleString(undefined, {
                      maximumFractionDigits: 0
                    })}</span>
 </div>
 <Separator />
 ...
 <span className="font-medium text-green-600">${totalInterest.toLocaleString(undefined, {
                      maximumFractionDigits: 0
                    })}</span>
 </div>
 </div>
 ...
 <ToolHowItWorks steps={[{
        ...
        icon: TrendingUp
      }]} badges={["Retirement projection", "Compound growth", "Free & private"]} />
 ...
 <tbody>
 {[["30", "1× salary", "$60,000"], ["35", "2× salary", "$120,000"], ["40", "3× salary", "$180,000"], ["45", "4× salary", "$240,000"], ["50", "6× salary", "$360,000"], ["55", "7× salary", "$420,000"], ["60", "8× salary", "$480,000"], ["67", "10× salary", "$600,000"]].map(([age, bench, target]) => <tr key={age} className="odd:bg-muted/20">
 ...
 <tbody>
 {[["401(k) Traditional", "$23,000 (+$7,500 catch-up)", "Pre-tax contributions", "Reducing current tax burden"], ["Roth 401(k)", "$23,000 combined", "After-tax; tax-free withdrawals", "Expecting higher taxes in retirement"], ["Traditional IRA", "$7,000 (+$1,000 catch-up)", "May be pre-tax", "No workplace plan access"], ["Roth IRA", "$7,000 (+$1,000 catch-up)", "After-tax; tax-free growth", "Under income limits"], ["SEP-IRA", "Up to $69,000", "Pre-tax", "Self-employed / freelancers"]].map(([acct, limit, tax, best]) => <tr key={acct} className="odd:bg-muted/20">
