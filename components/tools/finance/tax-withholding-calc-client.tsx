        ...
        <GlassCard>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="gross-income" type="number" value={grossIncome} onChange={e => setGrossIncome(e.target.value)} placeholder="75000" />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input id="extra-withholding" type="number" value={extraWithholding} onChange={e => setExtraWithholding(e.target.value)} placeholder="0" />
            </div>
          </CardContent>
        </GlassCard>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-3 text-center">
              <div className="p-4 rounded-xl bg-primary/10 border border-primary/20">
                ...
                <div className="text-2xl font-bold text-primary mt-1">${payPeriodNet.toLocaleString("en-US", {
              ...
              <div className="p-4 rounded-xl bg-muted/60 border border-border">
                ...
                <div className="text-2xl font-bold text-foreground mt-1">${payPeriodTax.toLocaleString("en-US", {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2
                  })}</div>
            ...
            <div className="space-y-2 pt-2 text-sm border-t border-border">
              <div className="flex justify-between py-1">
                ...
                <span className="font-semibold">${payPeriodGross.toLocaleString("en-US", {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2
                  })}</span>
              </div>
