...
export function SavingsSpendingClient() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      localStorage.setItem("savings-spending-data", JSON.stringify({
        income,
        expenses
      }));
    }
  ...
  return <div className="relative max-w-6xl mx-auto space-y-8"><ToolBackground /><div className="relative z-10">
      ...
      <ToolPageHeader title="Savings vs Spending Analyzer & 50/30/20 Budget Calculator" description="Analyze your monthly income against categorized expenses, calculate your net savings rate, and benchmark against the 50/30/20 rule." icon={Wallet} actions={<ResetButton onClick={handleReset} label="Reset Budget" />} />
        ...
        <GlassCard>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="monthly-income" type="number" value={income || ""} onChange={e => setIncome(Number(e.target.value) || 0)} placeholder="e.g. 4000" className="h-11 font-bold text-foreground" />
            </div>
          ...
          <GlassCard>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-1.5">
                ...
                <div className="h-2 w-full bg-muted/60 rounded-full overflow-hidden">
                  <div className="h-full bg-blue-500 rounded-full transition-all duration-300" style={{
                    width: `${Math.min(100, actualNeedsPct)}%`
                  }} />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="h-2 w-full bg-muted/60 rounded-full overflow-hidden">
                  <div className="h-full bg-amber-500 rounded-full transition-all duration-300" style={{
                    width: `${Math.min(100, actualWantsPct)}%`
                  }} />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="h-2 w-full bg-muted/60 rounded-full overflow-hidden">
                  <div className="h-full bg-emerald-500 rounded-full transition-all duration-300" style={{
                    width: `${Math.min(100, actualSavingsPct)}%`
                  }} />
                </div>
              </div>
            </CardContent>
