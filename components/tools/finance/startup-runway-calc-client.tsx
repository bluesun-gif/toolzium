...
=======
 {aiAnalysis.length > 0 && <AiOutputDisplay title="AI Startup Runway & Cash Burn Audit" subtitle="Fundraising lead time recommendations & Default Alive milestone strategies" content={aiAnalysis} loading={loading} onRegenerate={auditRunwayWithAi} variant="prose" />}
      ...
      <ToolHowItWorks steps={[{
        ...
        description: "Enter cash, burn, revenue in the fields above — everything calculates live as you type.",
        icon: Sparkles
      }, {
        step: "02",
        title: "Review the Result",
        description: "Instantly see your runway months and burn rate, with breakdowns and visual cues.",
        icon: Zap
      }, {
        step: "03",
        ...
        <div className="prose dark:prose-invert max-w-none">
          <h3>Why Use the AI Startup Runway & Net Burn Rate Calculator?</h3>
          <p>
            Founders use runway — months of cash left — to time fundraising before hitting zero.
          </p>
          <p>
