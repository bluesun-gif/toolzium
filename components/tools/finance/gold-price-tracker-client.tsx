...
const CURRENCIES = [
 ...
 { value:"SAR", label:"SAR (Riyal - Saudi)", symbol:"SAR"},
];
...
export default function GoldPriceTrackerClient() {
 ...
 description="Live spot prices for 24K, 22K, and 18K Gold, Silver, and Platinum across global currencies with instant karat weight calculator."
 />
 ...
 label=""
 value={currency}
 onValueChange={(val) => setCurrency(String(val ||"USD"))}
 ...
 disabled={isLoading}
 className="h-10 gap-2 shrink-0 font-semibold"
 >
 ...
 label="Weight Unit"
 value={weightUnit}
 onValueChange={(val) => setWeightUnit(String(val ||"gram"))}
 options={[
 ...
 value={karat}
 onValueChange={(val) => setKarat(String(val ||"24k"))}
 options={[
 { value:"24k", label:"24K Gold (99.9% Pure)"},
 { value:"22k", label:"22K Gold (91.6% Pure)"},
 { value:"18k", label:"18K Gold (75.0% Pure)"},
