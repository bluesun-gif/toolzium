...
=======
      <ToolHowItWorks steps={[{
        ...
        description: "Pick currency and karat in the fields above — everything calculates live as you type.",
        icon: Sparkles
      }, {
        step: "02",
        title: "Review the Result",
        description: "Instantly see your live gold value for your weight, with breakdowns and visual cues.",
        icon: Zap
      }, {
        step: "03",
        ...
        icon: Sparkles,
        title: "Real-time spot rates",
        description: "Real-time spot rates"
      }, {
        icon: Shield,
        ...
        <div className="prose dark:prose-invert max-w-none">
          <h3>Why Use the Real-Time Gold & Metals Price Tracker?</h3>
          <p>
            Buyers and jewelers use live spot rates to price gold by weight and purity in their own currency.
          </p>
          <p>
