...
=======
      <ToolHowItWorks steps={[{
        ...
        description: "Add invoices with statuses in the fields above — everything calculates live as you type.",
        icon: Sparkles
      }, {
        step: "02",
        title: "Review the Result",
        description: "Instantly see your outstanding, paid, and overdue totals, with breakdowns and visual cues.",
        icon: Zap
      }, {
        step: "03",
        ...
        <div className="prose dark:prose-invert max-w-none">
          <h3>Why Use the Invoice Payment Tracker?</h3>
          <p>
            Small businesses use this to track who owes what and spot overdue invoices before cash gets tight.
          </p>
          <p>
