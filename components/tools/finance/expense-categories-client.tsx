...
export function ExpenseCategoriesClient() {
 ...
 <div 
 className={cn("h-full", (isOver ? 'bg-red-500' : 'bg-primary'))} 
 ...
 <AlertTriangle className="w-3 h-3"/> Over budget by ${(spent - budget).toFixed(2)}
      ...
      >
        <div className="prose dark:prose-invert max-w-none">
          <h3>Why Use Our Expense Categorizer?</h3>
          <p>
            This free online tool is designed to help you get accurate results quickly and securely.
            Whether you're a developer, designer, student, or professional, our Expense Categorizer provides
