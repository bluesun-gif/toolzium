...
=======
      <ToolHowItWorks steps={[{
        ...
        description: "Enter wattage, hours, and rate in the fields above — everything calculates live as you type.",
        icon: Sparkles
      }, {
        step: "02",
        title: "Review the Result",
        description: "Instantly see your daily, monthly, and annual running cost, with breakdowns and visual cues.",
        icon: Zap
      }, {
        step: "03",
        ...
        icon: Sparkles,
        title: "Per-appliance cost",
        description: "Per-appliance cost"
      }, {
        icon: Shield,
        ...
        <div className="prose dark:prose-invert max-w-none">
          <h3>Why Use the Electricity Cost Calculator?</h3>
          <p>
            Households use this to find which appliances quietly inflate the power bill and where to cut first.
          </p>
          <p>
