        ...
        <GlassCard>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="gross-salary" type="number" value={grossAnnualSalary} onChange={e => setGrossAnnualSalary(e.target.value)} placeholder="85000" />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input id="k401" type="number" value={k401Contribution} onChange={e => setK401Contribution(e.target.value)} placeholder="5" />
            </div>

            <div className="space-y-2">
              <Label htmlFor="health">Monthly Health Insurance Premium ($)</Label>
              <Input id="health" type="number" value={healthInsurance} onChange={e => setHealthInsurance(e.target.value)} placeholder="150" />
            </div>
          </CardContent>
        </GlassCard>
        ...
        <GlassCard>
          ...
          <CardContent className="space-y-4">
            <div className="p-4 rounded-xl bg-primary/10 border border-primary/20 text-center">
              ...
              <div className="text-3xl font-extrabold text-primary mt-1">${netPaycheck.toLocaleString("en-US", {
            ...
            <div className="space-y-2 text-sm border-t border-border pt-3">
              ...
              <div className="flex justify-between py-2 border-t border-border font-bold">
                ...
                <span className="text-primary">${netAnnual.toLocaleString("en-US", {
                    maximumFractionDigits: 0
                  })}</span>
              </div>
            </div>
