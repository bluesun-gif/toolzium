...
export function EssayConclusionGeneratorClient() {
  ...
  const generateConclusions = async () => {
    ...
    try {
      const response = await fetch("/api/ai/generate", {
        ...
        body: JSON.stringify({ prompt, type: "list" })
      });
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 p-4">
      <ToolPageHeader
        icon={Sparkles}
        title="AI Essay Conclusion Generator"
        description="Craft powerful, memorable endings for your essays. Synthesize your arguments and leave a lasting impression on your readers."
      />
        ...
        <CardContent className="p-4 sm:p-6 space-y-6">
          <div className="space-y-2">
            ...
            <Input 
              ...
              placeholder="e.g., Remote work significantly improves employee retention in the tech sector." 
            />
          </div>
      ...
      <ToolHowItWorks
        steps={[
          { step: "01", title: "Input Core Elements", description: "Provide your thesis statement and a summary of your main arguments. This ensures the conclusion stays focused.", icon: Edit3 },
          { step: "02", title: "Select Style", description: "Choose the essay type and tone to match your assignment requirements, from formal academic to persuasive.", icon: Sparkles },
          { step: "03", title: "Review & Refine", description: "Get 3 unique variations. Edit them directly in the browser to fine-tune the phrasing before copying.", icon: BarChart2 }
        ]}
      ...
      <ToolFeatureGuides
        features={[
          { icon: Sparkles, title: "Synthesizing Arguments", description: "The AI doesn't just repeat your points; it weaves them together to show how they support your thesis." },
          { icon: BarChart2, title: "Strength Indicator", description: "Our algorithm rates each conclusion based on thesis restatement, argument coverage, and impact." },
          { icon: Edit3, title: "Inline Editing", description: "Click any generated text to manually edit and refine it. The perfect blend of AI speed and human polish." },
          { icon: RefreshCw, title: "Multiple Variations", description: "Never settle for the first draft. Generate 3 distinct options to find the one that resonates most." }
        ]}
      >
      ...
      <ToolFaqAccordion
        faqs={[
          { question: "Will this tool be detected as AI plagiarism?", answer: "The tool generates drafts and ideas. We strongly recommend using the output as a starting point and editing it heavily with your own voice, specific examples from your essay, and unique phrasing to ensure originality." },
          { question: "How does the Strength Indicator work?", answer: "It analyzes the text for keywords related to your thesis and main points, checks the length, and looks for transition words that signal a strong conclusion. It is a guide, not a guarantee of a grade." },
          { question: "Can I use this for college applications?", answer: "Yes, but be careful. Admissions essays require a very personal and authentic voice. Use the tool to structure your thoughts, but ensure the final words are deeply personal to you." },
          { question: "What if the AI hallucinates facts?", answer: "Conclusions should generally synthesize existing arguments rather than introduce new facts. However, always review the output to ensure it doesn't invent quotes or statistics not present in your original essay." },
          { question: "Is there a limit to how many times I can generate?", answer: "No, you can generate as many variations as you need to find the perfect ending for your paper." }
        ]}
      />
