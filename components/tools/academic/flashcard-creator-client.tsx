...
const SAMPLE_DECK: Flashcard[] = [{
  id: "1",
  front: "API",
  back: "Application Programming Interface - a set of rules for building software.",
  status: "unseen"
}, {
  id: "2",
  front: "JSON",
  ...
  id: "3",
  front: "React",
  back: "A JavaScript library for building user interfaces, maintained by Meta.",
  status: "unseen"
}, {
  id: "4",
  front: "State",
  back: "Data that changes over time in an application, triggering UI updates.",
  status: "unseen"
}, {
  id: "5",
  front: "Props",
  back: "Read-only data passed from parent to child components.",
  status: "unseen"
}, {
  id: "6",
  front: "DOM",
  back: "Document Object Model - the tree structure of an HTML page.",
  status: "unseen"
}, {
  id: "7",
  front: "SSR",
  back: "Server-Side Rendering - generating HTML on the server for each request.",
  status: "unseen"
}, {
  id: "8",
  front: "Hydration",
  back: "The process of attaching event listeners to static HTML on the client.",
  status: "unseen"
}, {
  id: "9",
  front: "Hook",
  back: "A function that lets you 'hook into' React state and lifecycle features.",
  status: "unseen"
}, {
  id: "10",
  front: "Virtual DOM",
  back: "A lightweight copy of the DOM used to optimize rendering performance.",
  status: "unseen"
}];
export function FlashcardCreatorClient() {
  ...
  const markCard = (status: "known" | "unknown") => {
    ...
    setDeck(prev => prev.map(c => c.id === currentCard.id ? {
      ...c,
      status
    } : c));
 ...
 {mode === "create" ? <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
 ...
 <textarea className={`${textareaClass} min-h-[100px] mt-2`} value={bulkText} onChange={e => setBulkText(e.target.value)} placeholder="React | A JS library&#10;Vue | A progressive framework" />
 ...
 {deck.map(card => <div key={card.id} className="p-3 bg-muted/30 rounded border border-border/50 flex justify-between items-start group">
 ...
 </div> : <div className="max-w-2xl mx-auto space-y-6">
 {!isFinished ? <>
 ...
 {currentCard ? <div className="relative w-full h-[400px] cursor-pointer [perspective:1000px]" onClick={handleFlip}>
 ...
 </div> : <div className="text-center p-12">No cards available to study.</div>}

 {isFlipped && <div className="flex gap-4 mt-8 justify-center">
 ...
 <ToolHowItWorks steps={[{
        ...
        description: "Add cards one by one or bulk import from a text file. Organize your study material efficiently.",
        icon: Layers
      }, {
        step: "02",
        title: "Enter Study Mode",
        description: "The system prioritizes unseen cards. Click the card to flip it and reveal the answer.",
        icon: Brain
      }, {
        step: "03",
        title: "Self-Assess",
        description: "Mark cards as 'Known' or 'Don't Know'. The spaced repetition logic brings difficult cards back more often.",
        icon: Shuffle
 ...
 <ToolFeatureGuides features={[{
        ...
        description: "Quickly build decks from existing notes using the pipe-delimited import format, or export your deck to share."
      }, {
        icon: Brain,
        title: "Smart Queue",
        description: "The study mode automatically prioritizes cards you haven't seen or marked as 'unknown' to optimize learning."
      }, {
        icon: Shuffle,
        title: "3D Flip Animation",
        description: "A smooth, satisfying card flip interaction mimics the feel of physical flashcards for better engagement."
      }, {
        icon: Edit,
        title: "Deck Management",
        description: "Edit, delete, and organize your cards in the creation view. Your deck is saved in the browser session."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        question: "How do I bulk import cards?",
        answer: "In the Create mode, use the text area at the bottom. Format your lines as 'Front | Back' (e.g., 'Apple | A red fruit'). The tool will parse every line containing a pipe character."
      }, {
        question: "Is my deck saved if I refresh the page?",
        answer: "Currently, the deck is stored in the browser's active memory (React state). If you refresh, it will revert to the sample deck. We recommend exporting to JSON to save your work."
      }, {
        question: "Can I add images to cards?",
        answer: "The current version supports text-only for maximum compatibility and speed. Image support is planned for a future update."
      }, {
        question: "What happens when I finish the deck?",
        answer: "You will see a summary screen showing your mastery percentage. You can choose to restart the session to review the cards you missed."
      }, {
