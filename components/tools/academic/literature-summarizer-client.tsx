  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 p-4">
      <ToolPageHeader
        ...
        description="Transform dense research papers, journal articles, and academic passages into structured abstracts, bullet points, and critical key takeaways."
      />
        ...
        <Card className={cardClass}>
          ...
          <CardContent className="p-4 sm:p-6 space-y-4">
            <textarea
              ...
              placeholder="Paste research paper abstract, methodology section, or literature text here..."
              value={text}
      ...
      <ToolHowItWorks
        steps={[
          { step: "01", title: "Paste Research Text", description: "Insert any journal article, thesis excerpt, or literature review section into the input workspace.", icon: FileText },
          { step: "02", title: "Configure Format", description: "Choose between Key Takeaways, Structured Abstracts, Bullet Points, or Critical Analysis modes.", icon: Sliders },
          { step: "03", title: "Generate & Export", description: "Receive instant structured summaries ready to copy into your annotated bibliography or notes.", icon: CheckCircle2 }
        ]}
      ...
      <ToolFeatureGuides
        features={[
          { icon: BookOpen, title: "Academic Precision", description: "Extracts core hypotheses, methodologies, and conclusions without omitting key scholarly context." },
          { icon: Layers, title: "Multi-Format Output", description: "Switch between concise executive bullet lists and comprehensive literature analysis styles." },
          { icon: Sparkles, title: "Zero Latency", description: "Process dense research materials instantly within your browser with complete privacy." },
          { icon: CheckCircle2, title: "Citation Ready", description: "Easily integrate generated summaries into your research notes, Zotero, or literature matrices." }
        ]}
      >
      ...
      <ToolFaqAccordion
        faqs={[
          { question: "Can I summarize full PDFs or books at once?", answer: "You can paste large text sections into the input box. For best results, summarize section by section (such as Abstract, Introduction, or Methodology)." },
          { question: "Is my research text saved or tracked?", answer: "No. All text processing is executed entirely in your browser's memory. No input data is stored or logged on any server." },
          { question: "Does this tool work for non-academic texts?", answer: "Yes! While optimized for scholarly literature and research papers, it effectively summarizes news articles, technical documentation, and long reports." },
          { question: "Is there a word count limit?", answer: "There is no strict character limit. However, passages between 100 and 3,000 words yield the most balanced and structured summaries." }
        ]}
      />
