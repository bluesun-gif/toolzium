...
const GAME_CATEGORIES = [
  { value: "valorant", label: "🎯 Valorant / Competitive FPS" },
  { value: "gta", label: "🚗 GTA V / NoPixel Roleplay (RP)" },
  { value: "minecraft", label: "⛏️ Minecraft Survival & Hardcore SMP" },
  { value: "fortnite", label: "⚡ Fortnite Victory Royale / Tournaments" },
  { value: "justchatting", label: "💬 Just Chatting, Q&A & IRL Streams" },
  { value: "league", label: "⚔️ League of Legends Ranked Grind" },
];
...
export default function TwitchTitleClient() {
  ...
  const generateTwitchTitles = async () => {
    ...
    try {
      const prompt = `Generate 6 high-CTR, engaging Twitch stream title hooks for '${game}'. ${
        customGoal ? `Include stream goal '${customGoal}'.` : ""
      } Include chat command tags (e.g. !rank !sens !specs), uppercase emotional hooks, and sub incentives. Output 1 title per line. No markdown formatting.`;
      ...
      setTitles([
        "🔥 ROAD TO RADIANT OR WE DON'T SLEEP! (!rank !sens !pc)",
        "🎯 100% HEADSHOT RATE ONLY | SUB GIFT GIVEAWAY AT 50 SUBS (!sub)",
        "🔴 RANKED GRIND UNTIL I LOSE MY MIND | !discord !spotify",
        "⚡ ZERO DEATH CHALLENGE DAY 3 (!specs !settings)",
        "💬 CHILL VIBES & Q&A | ASKING ME ANYTHING (!discord)",
        "⚔️ RANK 1 LEADERBOARD GRIND | HIGH ELO GAMEPLAY (!rank)",
      ]);
  ...
  return (
    <div className="relative max-w-6xl mx-auto space-y-8">
      ...
      <ToolPageHeader
        ...
        description="Generate high-converting Twitch stream titles, viewer engagement hooks, and command tags (!rank !sens) with live AI."
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="e.g. 50 Sub Hype Train, Rank Up to Immortal"
              />
            </div>
          </div>
