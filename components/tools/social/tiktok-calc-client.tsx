  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto px-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <GlassCard className="p-5 space-y-2 text-center border-indigo-500/30 bg-indigo-500/5">
          ...
          <p className="text-3xl font-extrabold text-indigo-500">${estimatedSponsorPost}</p>
        </GlassCard>
      </div>
    </div>
  );
