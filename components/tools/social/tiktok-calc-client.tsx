...
export default function TiktokCalcClient() {
 ...
 <Input type="number" value={followers} onChange={e => setFollowers(Number(e.target.value))} className="h-11 font-bold text-base" />
 </div>
 ...
 <Input type="number" value={views} onChange={e => setViews(Number(e.target.value))} className="h-11 font-bold text-base" />
 </div>
 ...
 <Input type="number" value={likes} onChange={e => setLikes(Number(e.target.value))} className="h-11 font-bold text-base" />
 </div>
 ...
 <Input type="number" value={comments} onChange={e => setComments(Number(e.target.value))} className="h-11 font-bold text-base" />
 </div>
 </div>
 </GlassCard>
