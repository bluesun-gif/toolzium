  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto px-4">
      <ToolPageHeader
        ...
        description="Generate episode intro scripts, guest interview question frameworks, sponsor reads, and publishing show notes using live AI."
      />
      ...
      <GlassCard className="p-6 space-y-4">
        <div className="space-y-2">
          ...
          <Input
            ...
            placeholder="e.g. How Remote Work Changed Company Culture"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="e.g. Jane Doe (Founder at TechCorp)"
              className="h-11"
            />
          </div>
        ...
        <div className="flex justify-end pt-2">
          <Button
            onClick={generatePodcastOutline}
      ...
      {results.length > 0 && (
        <AiOutputDisplay
          title="Generated Podcast Script & Show Notes"
          subtitle="Intro monologue, guest questions, and publication show notes"
          content={results}
          loading={loading}
          onRegenerate={generatePodcastOutline}
          variant="cards"
        />
      )}
    </div>
