...
export function PortReferenceClient() {
 ...
 <Input placeholder="Search by port or service..." value={search} onChange={e => setSearch(e.target.value)} className="pl-9" />
 </div>
 ...
 {filteredPorts.map(p => <tr key={p.port} className="hover:bg-muted/30 transition-colors">
