...
export function WifiQrClient() {
 ...
 <Input placeholder="e.g. My Home Network" value={ssid} onChange={e => setSsid(e.target.value)} />
 </div>
 ...
 {encryption !== "nopass" && <div className="space-y-2">
 <Label>Password</Label>
 <Input type="password" placeholder="Network password" value={password} onChange={e => setPassword(e.target.value)} />
 </div>}
 ...
 <div ref={printRef} className="bg-background p-6 rounded-xl shadow-sm border flex flex-col items-center">
 {qrUrl ? <>
 ...
 <ActionButton onClick={handleDownload} icon={Download} label="Download PNG" disabled={!qrUrl} variant="default" />
 <ActionButton onClick={handlePrint} icon={Printer} label="Print Code" disabled={!qrUrl} />
 </div>
 </CardContent>
 </GlassCard>
 </div>
