...
export function DnsGeneratorClient() {
 ...
 <div className="space-y-4">
 {records.map(record => <div key={record.id} className="p-4 border rounded-md relative flex flex-col gap-3 bg-muted/30">
 ...
 {record.type === 'MX' && <div className="space-y-1">
 ...
 {records.length === 0 && <div className="text-center p-8 border border-dashed rounded-lg text-muted-foreground text-sm">
