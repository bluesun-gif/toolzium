...
type Unit = { id: string; name: string; multiplier: number; isByte: boolean };

const UNITS: Unit[] = [
 { id:"bps", name:"Bits per second (bps)", multiplier: 1, isByte: false },
 { id:"kbps", name:"Kilobits per second (Kbps)", multiplier: 1000, isByte: false },
 { id:"mbps", name:"Megabits per second (Mbps)", multiplier: 1000000, isByte: false },
 { id:"gbps", name:"Gigabits per second (Gbps)", multiplier: 1000000000, isByte: false },
 { id:"tbps", name:"Terabits per second (Tbps)", multiplier: 1000000000000, isByte: false },
 { id:"Bps", name:"Bytes per second (B/s)", multiplier: 8, isByte: true },
 { id:"KBps", name:"Kilobytes per second (KB/s)", multiplier: 8000, isByte: true },
 { id:"MBps", name:"Megabytes per second (MB/s)", multiplier: 8000000, isByte: true },
 { id:"GBps", name:"Gigabytes per second (GB/s)", multiplier: 8000000000, isByte: true },
];

const PRESETS = [
 { name:"Dial-up", value: 56, unit:"kbps"},
 { name:"DSL", value: 25, unit:"mbps"},
 { name:"Cable", value: 100, unit:"mbps"},
 { name:"5G", value: 500, unit:"mbps"},
 { name:"Fiber", value: 1, unit:"gbps"},
];

const FILES = [
 { name:"MP3 Song (5MB)", bytes: 5 * 1000000 },
 { name:"Small App (100MB)", bytes: 100 * 1000000 },
 { name:"HD Movie (1GB)", bytes: 1 * 1000000000 },
 { name:"Large Game (50GB)", bytes: 50 * 1000000000 },
];
...
export function SpeedConverterClient() {
 ...
 description="Convert bandwidth speeds and estimate download times for common file sizes."
 />
 ...
 return (
 <div key={file.name} className="flex justify-between items-center p-3 bg-muted rounded-md">
 ...
 {baseBps > 0 ? (baseBps / u.multiplier).toLocaleString(undefined, { maximumFractionDigits: 6 }) : 0}
 </span>
 </div>
 ))}
 </div>
