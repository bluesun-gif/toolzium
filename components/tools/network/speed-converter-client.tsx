...
import { Activity, ArrowLeftRight, Copy, Download, Gauge, Settings, Shield, Sparkles, Zap } from "lucide-react";
...
export function SpeedConverterClient() {
 ...
 {baseBps > 0 ? (baseBps / u.multiplier).toLocaleString(undefined, {
      ...
      <ToolHowItWorks steps={[
        { step: "01", title: "Enter Speed", description: "Type any speed value — mph, km/h, m/s, knots, Mach number, or light speed.", icon: Gauge },
        { step: "02", title: "Choose Unit", description: "Select your source unit from the dropdown menu.", icon: Settings },
        { step: "03", title: "See All Conversions", description: "Instantly see the equivalent speed in every other unit simultaneously.", icon: Zap },
      ]} badges={["10+ Units", "Real-Time", "Scientific"]} />

      <ToolFeatureGuides features={[
        { icon: Gauge, title: "10+ Speed Units", description: "Convert between mph, km/h, m/s, ft/s, knots, Mach, and even light speed." },
        { icon: Zap, title: "Real-Time Results", description: "All conversions update instantly as you type — no submit needed." },
        { icon: Shield, title: "Precise Calculations", description: "Uses exact conversion factors for scientific and engineering accuracy." },
      ]}>
