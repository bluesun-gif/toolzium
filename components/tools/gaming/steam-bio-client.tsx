...
export function SteamBioClient() {
  ...
  return (
    <div className="relative space-y-6">
      ...
      <div className="relative z-10 space-y-6">
        <ToolPageHeader
          icon={Gamepad2}
          title="Steam Profile Bio & Custom Text Generator"
        ...
        <RelatedTools currentToolUrl="/tools/gaming/steam-bio" max={6} />
      </div>
    </div>
  );
}

export default SteamBioClient;
