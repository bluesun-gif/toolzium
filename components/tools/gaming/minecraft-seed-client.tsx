...
const MINECRAFT_STYLES = [
  ...
  { value: "cyber", label: "⚡ Sci-Fi & Cyberpunk SMP" },
];
...
export default function MinecraftSeedClient() {
  ...
  const generateWorldNames = async () => {
    ...
    try {
      const prompt = `Generate 10 creative Minecraft world titles and SMP server names for a '${style}' world theme. ${
        keyword ? `Incorporate theme keyword '${keyword}'.` : ""
      } Include Minecraft emojis. Output 1 name per line. No markdown formatting.`;
      ...
      setWorldNames([
        "Aetheria Kingdom SMP 🏰",
        "Eldoria Hardcore Survival 🌲",
        "Sakura Blossom Village 🌸",
        "Obsidian Nether Citadel 🔥",
        "Astral Horizon SMP ⚡",
        "Verdant Isle Survival 🌿",
        "Ironclad Keep Fortress 🛡️",
        "Whispering Woods SMP 🍃",
      ]);
  ...
  return (
    <div className="relative max-w-6xl mx-auto space-y-8">
      ...
      <ToolPageHeader
        ...
        description="Generate fantasy Minecraft world titles, 100 Days Hardcore SMP names, and cottagecore village ideas with live AI."
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="e.g. Cherry, Obsidian, Frost, Dragon"
              />
            </div>
          </div>
