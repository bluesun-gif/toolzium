...
export default function MlbbNameClient() {
  ...
  const generateMlbbNames = async () => {
    ...
    try {
      ...
      const baseWords: string[] = data.results && data.results.length > 0
        ? data.results
        : ["Viper", "Slayer", "Mythic", "Phantom", "Shadow", "Apex", "Vortex", "Titan", "Venom", "Spectre", "Ghost", "Overlord", "Zero", "Nexus", "Draco"];
  ...
  return (
    <div className="relative max-w-6xl mx-auto space-y-8">
      ...
      <ToolPageHeader
        icon={Swords}
        title="Mobile Legends (MLBB) 100+ Fancy Name & Symbol Generator"
        description="Generate 100+ cool Japanese Kanji, Gothic symbols, squad tags, and fancy font nicknames for Mobile Legends Bang Bang with AI."
        ...
        <CardContent className="space-y-4">
          <div className="flex flex-col sm:flex-row gap-3">
            <Input
              ...
              placeholder="e.g. Viper, Slayer, Mythic, Phantom"
      ...
      {allNames.length > 0 && (
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
            {filteredNames.slice(0, visibleCount).map((name, idx) => (
