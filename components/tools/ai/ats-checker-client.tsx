...
"Include quantitative metrics (e.g. 'Increased speed by 35%')."
 ...
 <h1 className="text-xl sm:text-2xl font-black text-foreground">AI Resume ATS Keyword & Format Scanner</h1>
 ...
 <p className="text-xs sm:text-sm text-muted-foreground mt-1">Calculate your resume's ATS match score against target job descriptions, discover missing keywords, and optimize for hiring screeners.</p>
 </div>
 </div>
 ...
 <textarea
 className="w-full rounded-xl border border-border bg-background p-3 text-sm outline-none focus:ring-2 focus:ring-emerald-500 min-h-[140px] font-sans text-foreground"
 ...
 <textarea
 className="w-full rounded-xl border border-border bg-background p-3 text-sm outline-none focus:ring-2 focus:ring-emerald-500 min-h-[100px] font-sans text-foreground"
...
"bg-red-50 text-red-700 border-red-200"
 ...
 <p className="text-xs max-w-xs mt-1 text-muted-foreground">Paste your resume text on the left to calculate your ATS match percentage and identify missing keywords.</p>
 </GlassCard>
 )}
 </div>
 </div>
