  ...
  return (
    <div className="mx-auto max-w-6xl px-2 sm:px-4 py-4 sm:py-6 space-y-4 sm:space-y-6 max-w-full overflow-hidden">
      ...
      <div className="grid gap-4 sm:gap-6 lg:grid-cols-12 min-h-[500px] max-w-full">
        ...
        <div className="lg:col-span-5 flex flex-col max-w-full">
            ...
            <CardContent className="p-3 sm:p-4 space-y-3 flex-1 flex flex-col justify-between max-w-full">
              ...
              <div className="space-y-1">
                ...
                <Input
                  ...
                  className="text-xs bg-muted/20 h-9 rounded-xl max-w-full"
                />
              </div>
              ...
              <div className="space-y-1">
                ...
                <Textarea
                  ...
                  className="text-xs min-h-[80px] bg-muted/20 resize-none p-3 rounded-xl max-w-full"
                />
              </div>
        ...
        <div className="lg:col-span-7 flex flex-col max-w-full">
          <Card className="border border-primary/30 shadow-lg bg-card/70 backdrop-blur-md rounded-2xl flex-1 flex flex-col justify-between overflow-hidden max-w-full">
            <CardHeader className="border-b border-border/40 bg-muted/20 p-3 sm:p-4">
              <div className="flex items-center justify-between gap-2">
                <CardTitle className="text-xs sm:text-sm font-semibold flex items-center gap-2 text-primary tracking-tight truncate">
                ...
                {result && (
                  ...
                  >
                    ...
                    {copiedSection === "Full Product Copy" ? "Copied All" : "1-Click Copy All"}
                  </Button>
                )}
              </div>
            </CardHeader>
            ...
            <CardContent className="p-3 sm:p-4 flex-1 flex flex-col justify-between max-w-full overflow-hidden">
              ...
              {result && (
                <div className="space-y-3 max-w-full overflow-y-auto max-h-[420px] pr-1">
                  {/* SEO Title */}
                  <div className="p-3 rounded-xl border bg-muted/20 space-y-1 max-w-full">
                  ...
                  {/* Key Feature Bullets */}
                  <div className="p-3 rounded-xl border bg-muted/20 space-y-1.5 max-w-full">
                    <span className="text-[10px] font-semibold uppercase tracking-wider text-muted-foreground">
