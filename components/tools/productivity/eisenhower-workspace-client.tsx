  ...
  return (
    <div className={"space-y-6"}>
      ...
      <div className={"grid md:grid-cols-2 gap-4 h-[600px] md:h-[700px]"}>
        ...
        <QuadrantView id="q2" title="Schedule (Important, Not Urgent)" colorClass="text-blue-500" />
        <QuadrantView id="q3" title="Delegate (Urgent, Not Important)" colorClass="text-orange-500" />
        <QuadrantView id="q4" title="Eliminate (Not Urgent & Not Important)" colorClass="text-gray-500" />
      </div>
    </div>
  );
}
