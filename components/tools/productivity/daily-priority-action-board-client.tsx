  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {renderBucket("schedule", "Schedule Later (Not Urgent, Important)", "text-blue-500", "bg-blue-500/5")}
        {renderBucket("delegate", "Delegate (Urgent, Not Important)", "text-amber-500", "bg-amber-500/5")}
        {renderBucket("eliminate", "Eliminate (Not Urgent, Not Important)", "text-gray-500 dark:text-gray-400", "bg-gray-500/5")}
      </div>
    </div>
  );
}
