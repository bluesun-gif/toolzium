...
export function FocusTimerClient() {
 ...
 <ToolPageHeader icon={Timer} title="Focus Timer" description="Distraction-free focus timer with customizable sessions" actions={<ResetButton onClick={() => {
        setSessionsCompleted(0);
        setTotalFocusTime(0);
        localStorage.removeItem("focusTimer_sessions");
        localStorage.removeItem("focusTimer_total");
      }} label="Reset Stats" />} />
...
export default FocusTimerClient;
