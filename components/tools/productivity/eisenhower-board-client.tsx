...
const QUADRANTS = {
  ...
  2: { title: "Schedule", desc: "Not Urgent & Important", color: "border-blue-500/50 bg-blue-500/10", head: "text-blue-500" },
  3: { title: "Delegate", desc: "Urgent & Not Important", color: "border-yellow-500/50 bg-yellow-500/10", head: "text-yellow-500" },
  4: { title: "Eliminate", desc: "Not Urgent & Not Important", color: "border-gray-500/50 bg-gray-500/10", head: "text-gray-500" }
};
