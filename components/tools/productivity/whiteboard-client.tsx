...
export default function WhiteboardClient() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-8 flex flex-col h-[calc(100vh-80px)]">
      <ToolPageHeader
        title="Online Whiteboard"
        description="A simple, fast whiteboard for sketching, diagrams, and brainstorming."
      />
      ...
      <Card className="mt-6 flex flex-col flex-1 border-zinc-200 dark:border-zinc-800 overflow-hidden shadow-xl min-h-[500px]">
        ...
        <div className="flex flex-wrap items-center gap-2 border-b bg-zinc-50 dark:bg-zinc-950 p-3">
          ...
          {/* Tools */}
          <div className="flex items-center gap-1 bg-white dark:bg-zinc-900 rounded-md border p-1 shadow-sm">
          ...
          {/* Brush Size */}
          <div className="flex items-center gap-3 bg-white dark:bg-zinc-900 rounded-md border px-3 py-2 shadow-sm shrink-0 flex-1 sm:flex-none sm:w-48">
            <div 
        ...
        <div 
          ref={containerRef} 
          className="flex-1 w-full bg-zinc-200 dark:bg-zinc-800 overflow-hidden relative"
          style={{ touchAction: 'none' }} // Prevent browser handling of touch
        >
          <canvas
            ref={canvasRef}
            className="absolute top-0 left-0 bg-white cursor-crosshair shadow-inner"
