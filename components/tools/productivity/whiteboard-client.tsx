...
export default function WhiteboardClient() {
 ...
 return (
      <div className="relative mx-auto max-w-5xl px-4 py-8 flex flex-col h-[calc(100vh-80px)]">
      <GridPattern />
 ...
 <button
 key={c}
 className={cn("w-8 h-8 rounded-full border-2 \\"+ (color === c ? 'border-primary ring-2 ring-primary/30' : 'border-transparent hover:scale-110') +"transition-all")}
 ...
 <canvas
 ref={canvasRef}
 className="absolute top-0 left-0 bg-background cursor-crosshair shadow-inner"
