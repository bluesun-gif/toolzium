...
export function EisenhowerPlannerClient() {
 ...
 const [newTaskTexts, setNewTaskTexts] = useState<Record<QuadrantType, string>>({ q1:"", q2:"", q3:"", q4:""});
 ...
 value={newTaskTexts[type]} 
 onChange={(e) => setNewTaskTexts({...newTaskTexts, [type]: e.target.value})}
 ...
 <select 
 className="text-xs bg-transparent border rounded px-1 h-6 outline-none"
 value={type}
 onChange={(e) => moveTask(task.id, e.target.value as QuadrantType)}
 >
 ...
 description="Organize your tasks by urgency and importance to maximize your productivity."
 actions={
 <div className="flex gap-2">
