...
const STATEMENTS = [{
  cat: "Science",
  statements: ["Water boils at 100°C at sea level.", "Venus is hotter than Mercury.", "Humans use only 10% of their brains."],
  lie: 2,
  exp: "The 10% brain myth is false; we use virtually every part of the brain."
}, {
  cat: "History",
  statements: ["Cleopatra lived closer to the Moon landing than the Pyramids.", "Ninjas historically wore black pajamas.", "Oxford University is older than the Aztec Empire."],
  lie: 1,
  exp: "Ninjas actually dressed like commoners to blend in; the black suit is from Kabuki theater."
}, {
  cat: "Nature",
  statements: ["Bananas are botanically berries.", "Bats are blind.", "A group of crows is called a murder."],
  lie: 1,
  exp: "Bats are not blind; many species have excellent eyesight and use echolocation as a supplement."
}, {
  cat: "Geography",
  statements: ["Mount Everest is the tallest mountain from base to peak.", "Russia has a larger surface area than Pluto.", "The Nile is the longest river in the world."],
  lie: 0,
  exp: "Mauna Kea in Hawaii is taller from base to peak, though Everest has the highest altitude."
}, {
  cat: "Animals",
  statements: ["Ostriches bury their heads in the sand.", "A shrimp's heart is in its head.", "Sloths can hold their breath longer than dolphins."],
  lie: 0,
  exp: "Ostriches do not bury their heads in sand; they dig shallow nests for eggs and turn them."
}, {
  cat: "Space",
  statements: ["A day on Venus is longer than its year.", "The Sun is a star.", "There is no gravity in space."],
  lie: 2,
  exp: "There is microgravity, but gravity exists everywhere in space, keeping planets in orbit."
}, {
  cat: "Food",
  statements: ["Honey never spoils.", "Carrots were originally purple.", "Searing meat seals in the juices."],
  lie: 2,
  exp: "Searing meat does not seal in juices; it creates flavor via the Maillard reaction but can cause moisture loss."
}, {
  cat: "Human Body",
  statements: ["Deoxygenated blood is blue.", "Your stomach lining regenerates every few days.", "Fingerprints are unique to every individual."],
  lie: 0,
  exp: "Blood is always red; deoxygenated blood is dark red, not blue. Veins look blue due to light scattering."
}, {
  cat: "Tech",
  statements: ["The first computer bug was an actual insect.", "CAPTCHA stands for Completely Automated Public Turing test.", "Wi-Fi stands for Wireless Fidelity."],
  lie: 2,
  exp: "Wi-Fi doesn't stand for anything; it's a marketing term created by a branding agency."
}, {
  cat: "Literature",
  statements: ["Shakespeare wrote 'To be or not to be'.", "Frankenstein is the name of the monster.", "Sherlock Holmes never said 'Elementary, my dear Watson'."],
  lie: 1,
  exp: "Frankenstein is the doctor; the monster is unnamed. The phrase is often misattributed."
}, {
  cat: "Math",
  statements: ["A circle has infinite corners.", "0.999... equals exactly 1.", "Pi is a rational number."],
  lie: 2,
  exp: "Pi is irrational; its decimal representation never ends or repeats."
}, {
  cat: "Geography",
  statements: ["Canada has more lakes than the rest of the world combined.", "Australia is wider than the Moon.", "Iceland is completely covered in ice."],
  lie: 2,
  exp: "Iceland has a relatively mild climate and is mostly green, while Greenland is mostly ice."
}, {
  cat: "Nature",
  statements: ["Trees can communicate via underground fungi.", "Sharks are mammals.", "Bamboo can grow up to 3 feet in a single day."],
  lie: 1,
  exp: "Sharks are fish, lacking the mammary glands that define mammals."
}, {
  cat: "History",
  statements: ["The Great Wall of China is visible from the moon.", "Romans used urine to whiten teeth.", "Napoleon was exceptionally short."],
  lie: 0,
  exp: "The Great Wall is not visible from the moon with the naked eye."
}, {
  cat: "Science",
  statements: ["Diamonds are made of compressed carbon.", "Lightning never strikes the same place twice.", "Sound travels faster than light."],
  lie: 1,
  exp: "Lightning frequently strikes the same place twice, especially tall structures like the Empire State Building."
}];
