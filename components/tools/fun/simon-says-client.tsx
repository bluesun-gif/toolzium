...
const COLORS = [
 { id: 0, name:"red", bg:"bg-red-600", active:"bg-red-400 shadow-[0_0_30px_10px_rgba(248,113,113,0.5)]"},
 { id: 1, name:"green", bg:"bg-green-600", active:"bg-green-400 shadow-[0_0_30px_10px_rgba(74,222,128,0.5)]"},
 { id: 2, name:"blue", bg:"bg-blue-600", active:"bg-blue-400 shadow-[0_0_30px_10px_rgba(96,165,250,0.5)]"},
 { id: 3, name:"yellow", bg:"bg-yellow-500", active:"bg-yellow-300 shadow-[0_0_30px_10px_rgba(253,224,71,0.5)]"}
];
...
export default function SimonSaysClient() {
 ...
 disabled={isShowing || !isPlaying || gameOver}
 className={`rounded-2xl transition-all duration-100 border-4 border-border/50 ${
 activeColor === color.id ? color.active : color.bg
 } ${!isPlaying && !gameOver ?"opacity-50":"opacity-90 hover:opacity-100"}`}
 />
 ))}
 </div>
 ...
 <Button onClick={stopGame} variant="destructive"className="flex-1 gap-2"size="lg">
 ...
 <ToolHowItWorks 
 steps={[
 { step:"01", title:"Start the Game", description:"Click Start to begin at Level 1 with a single color flash.", icon: Play },
 { step:"02", title:"Memorize & Repeat", description:"Watch the sequence, then click the colors in the exact same order.", icon: Gamepad2 },
 { step:"03", title:"Survive the Speed", description:"Each round adds a new color and speeds up. Beat your high score!", icon: Trophy }
 ]} 
 badges={["100% Free","Client-Side","Fun"]} 
 />

 <ToolFeatureGuides features={[
 { icon: Gamepad2, title:"Classic Gameplay", description:"Authentic Simon Says mechanics with progressive difficulty scaling."},
 { icon: Trophy, title:"Local High Scores", description:"Your highest level is saved locally so you can track your progress over time."},
 { icon: Play, title:"Dynamic Speed", description:"The delay between flashes shrinks as you advance, testing your reaction time."},
 { icon: RotateCcw, title:"Instant Restart", description:"Game over? Jump right back in with a single click to try again."}
 ]}>
 ...
 { question:"Does the game get faster?", answer:"Yes! The time delay between each color flash decreases as you reach higher levels, requiring faster reactions."},
 { question:"Where is my high score saved?", answer:"Your high score is saved in your browser's local storage. It will persist even if you close the tab, but it is not shared online."},
