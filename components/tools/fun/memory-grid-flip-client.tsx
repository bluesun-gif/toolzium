...
export function MemoryGridFlipClient() {
 ...
 <div className={`absolute inset-0 w-full h-full rounded-xl bg-background dark:bg-gray-800 flex items-center justify-center text-3xl sm:text-4xl shadow-inner border-2 transition-all duration-300 ${card.matched ? 'border-green-500 ring-4 ring-green-400/50 scale-95' : 'border-gray-200 dark:border-gray-700'}`}>
 {card.emoji}
 </div>
 ) : (
 <div className="absolute inset-0 w-full h-full rounded-xl bg-gradient-to-br from-primary to-primary flex items-center justify-center text-white font-bold text-2xl shadow-lg hover:scale-105 transition-transform border-2 border-primary/50/50">
 ?
 </div>
 )}
 </div>
