...
const QUESTIONS = [{
  ...
  q: "What animal has the longest neck?",
  options: ["Camel", "Ostrich", "Giraffe", "Alpaca"],
  answer: 2
}, {
  q: "Which animal is known to eat bamboo almost exclusively?",
  options: ["Koala", "Panda", "Sloth", "Gorilla"],
  answer: 1
}, {
  q: "What bird wears a 'tuxedo' and cannot fly?",
  options: ["Puffin", "Ostrich", "Penguin", "Kiwi"],
  answer: 2
}, {
  q: "Which reptile can change its color to blend in?",
  options: ["Iguana", "Chameleon", "Gecko", "Crocodile"],
  answer: 1
}, {
  q: "What is the largest primate?",
  options: ["Orangutan", "Chimpanzee", "Gorilla", "Baboon"],
  answer: 2
}, {
  ...
  q: "What snake is known for its hood?",
  options: ["Python", "Cobra", "Viper", "Anaconda"],
  answer: 1
}, {
  q: "Which Australian animal carries its young in a pouch?",
  options: ["Koala", "Kangaroo", "Wombat", "Platypus"],
  answer: 1
}, {
  q: "What animal is known for moving very slowly and hanging upside down?",
  options: ["Sloth", "Koala", "Snail", "Tortoise"],
  answer: 0
}, {
  q: "Which animal has a trunk?",
  options: ["Rhinoceros", "Hippo", "Elephant", "Tapir"],
  answer: 2
}, {
  q: "What animal looks like a horse with stripes?",
  options: ["Okapi", "Zebra", "Quagga", "Donkey"],
  answer: 1
}, {
  q: "Which animal has a horn on its nose?",
  options: ["Elephant", "Rhinoceros", "Triceratops", "Narwhal"],
  answer: 1
}, {
  q: "What insect is known for making honey?",
  options: ["Wasp", "Ant", "Bee", "Fly"],
  answer: 2
}, {
  q: "Which arachnid spins webs to catch prey?",
  options: ["Scorpion", "Tick", "Spider", "Mite"],
  answer: 2
}, {
  q: "What insect is notorious for biting and spreading disease?",
  options: ["Mosquito", "Butterfly", "Beetle", "Grasshopper"],
  answer: 0
}, {
  q: "Which insect starts as a caterpillar?",
  options: ["Dragonfly", "Butterfly", "Ladybug", "Cricket"],
  answer: 1
}, {
  ...
  q: "Which animal produces ink to escape predators?",
