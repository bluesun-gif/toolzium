...
import { HelpCircle, Shuffle, Play } from "lucide-react";
...
const questions = [{
  ...
  a: "Be a famous musician",
  b: "Be a famous scientist"
}, {
  ...
  b: "Eat only tacos for a year"
}, {
  a: "Have a personal chef",
  b: "Have a personal masseuse"
}, {
  a: "Never wait in line again",
  b: "Never hit a red light again"
}, {
  a: "Know how you die",
  b: "Know when you die"
}, {
  a: "Be an unknown superhero",
  b: "Be a famous villain"
}, {
  a: "Live in a treehouse",
  b: "Live in a submarine"
}, {
  a: "Have no sense of taste",
  ...
  b: "Speak all human languages fluently"
}, {
  a: "Fight 100 duck-sized horses",
  b: "Fight 1 horse-sized duck"
}, {
  a: "Have free WiFi everywhere",
  b: "Have free coffee everywhere"
}, {
  a: "Live to be 200 years old",
  b: "Live to be 100 but with perfect health"
}, {
  a: "Be able to control fire",
  b: "Be able to control water"
}, {
  ...
  a: "Be stranded on a desert island",
  b: "Be stranded in deep space"
}, {
  a: "Always feel slightly tired",
  b: "Always feel slightly hungry"
}, {
  a: "Have a dragon as a pet",
  b: "Have a phoenix as a pet"
}];
export default function WouldYouRatherClient() {
 ...
 <Button variant={chosen === "a" ? "default" : "outline"} className={`h-40 text-xl font-bold transition-all ${!chosen ? "hover:scale-105" : ""}`} onClick={() => vote("a")}>
 {q.a}
 </Button>
 <Button variant={chosen === "b" ? "default" : "outline"} className={`h-40 text-xl font-bold transition-all ${!chosen ? "hover:scale-105" : ""}`} onClick={() => vote("b")}>
 {q.b}
 </Button>
 </div>

 {chosen && <div className="space-y-4 mt-6 animate-in fade-in duration-500">
 ...
 <div className="h-full bg-secondary" style={{
                width: `${bPercent}%`
              }} />
 </div>
 ...
 <ToolHowItWorks steps={[{
        step: "01",
        title: "Read Prompt",
        description: "Review the two challenging or amusing scenarios presented to you.",
        icon: HelpCircle
      }, {
        step: "02",
        title: "Make Choice",
        description: "Click the option you would prefer to experience or endure.",
        icon: HelpCircle
      }, {
        step: "03",
        title: "See Results",
        description: "Discover how the simulated community voted and move on to the next dilemma.",
        icon: HelpCircle
 ...
 <ToolFeatureGuides features={[{
        ...
        description: "A hand-picked list of engaging scenarios designed to provoke thought and laughter."
      }, {
        icon: HelpCircle,
        title: "No Repeats",
        description: "The algorithm shuffles the deck so you won't see the same question twice until the cycle resets."
      }, {
        icon: HelpCircle,
        title: "Simulated Polls",
        description: "View a randomized statistical breakdown of how others might vote on the same dilemma."
      }, {
        icon: HelpCircle,
        title: "Party Friendly",
        description: "Perfect for road trips, parties, or icebreakers where conversation needs a spark."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        question: "Are the community votes real?",
        answer: "To maintain privacy and avoid requiring a backend database, the community votes shown are mathematically simulated to mimic realistic distributions for entertainment purposes."
      }, {
        question: "Can I submit my own questions?",
        answer: "Currently, the tool uses a fixed, curated list to ensure quality and appropriateness for all ages."
      }, {
        question: "Will the questions eventually repeat?",
        answer: "Yes, once you have cycled through all 30 questions in the deck, the randomizer will reshuffle and begin the cycle anew."
      }]} />
    </div>
    </div>
);
