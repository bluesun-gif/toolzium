...
export function WordAssociationClient() {
 ...
 {!isPlaying && chain.length === 0 ? <div className="text-center space-y-4 py-8">
 ...
 <Input value={input} onChange={e => setInput(e.target.value)} placeholder="Type associated word..." className="h-12 text-lg" autoFocus disabled={!isPlaying} />
 ...
 {chain.map((word, i) => <React.Fragment key={i}>
 ...
 {!isPlaying && chain.length > 1 && <div className="text-center pt-4">
 ...
 <ToolHowItWorks steps={[{
        ...
        description: "Focus on the current word displayed in the center stage.",
        icon: BookOpen
      }, {
        step: "02",
        title: "Type a Link",
        description: "Enter any word you associate with the prompt before the 15s timer expires.",
        icon: Timer
      }, {
        step: "03",
        title: "Build the Chain",
        description: "Accumulate points and maintain your streak by forging long semantic timelines.",
        icon: Flame
 ...
 <ToolFeatureGuides features={[{
        ...
        description: "Faster responses yield higher time bonuses, rewarding rapid cognitive retrieval."
      }, {
        icon: Flame,
        title: "Streak Tracking",
        description: "Monitor your consecutive successful links to push your personal bests."
      }, {
        icon: Sparkles,
        title: "Creative Fallback",
        description: "Unique, out-of-the-box associations are accepted and rewarded to encourage lateral thinking."
      }, {
        icon: BookOpen,
        title: "Semantic Database",
        description: "Powered by a curated dictionary of hundreds of verified conceptual links across categories."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        ...
        answer: "Base points are awarded for every valid link, plus a time bonus based on how many seconds remain on the 15-second clock."
      }, {
        question: "What if my word isn't in the database?",
        answer: "If your word is longer than 2 letters and not a repeat, the game accepts it as a 'creative association' but awards fewer points."
      }, {
        question: "Can I use the same word twice?",
        answer: "No. Every word in the chain must be entirely unique to force your brain to explore new semantic pathways."
      }, {
