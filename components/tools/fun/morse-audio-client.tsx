...
export default function MorseAudioClient() {
 ...
 <textarea value={text} onChange={e => setText(e.target.value)} className="w-full rounded-lg border border-border/70 bg-background/80 p-3 text-sm outline-none focus:ring-2 focus:ring-primary/50 h-24 resize-none" placeholder="Type your message here..." />
 </div>
 ...
 <input type="range" min="5" max="30" value={wpm} onChange={e => setWpm(parseInt(e.target.value))} className="w-full accent-primary" disabled={isPlaying} />
 </div>
 ...
 <ToolHowItWorks steps={[{
        ...
        description: "Type any message into the text area to see it instantly translated.",
        icon: Radio
      }, {
        step: "02",
        title: "Adjust the Speed",
        description: "Use the slider to set the Words Per Minute (WPM) playback speed.",
        icon: Volume2
      }, {
        step: "03",
        title: "Listen & Copy",
        description: "Hit play to hear authentic Morse beeps, or copy the code to share.",
        icon: Copy
 ...
 <ToolFeatureGuides features={[{
        ...
        description: "Watch your text convert to dots and dashes instantly as you type."
      }, {
        icon: Volume2,
        title: "Web Audio API",
        description: "Generates pure sine wave tones directly in your browser with zero latency."
      }, {
        icon: Play,
        title: "Adjustable WPM",
        description: "Control the playback speed from a slow 5 WPM up to a rapid 30 WPM."
      }, {
        icon: Copy,
        title: "One-Click Copy",
        description: "Easily copy the generated Morse string to your clipboard for use elsewhere."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        ...
        answer: "WPM stands for Words Per Minute. It is the standard measurement for Morse code transmission speed. 15 WPM is considered a standard conversational pace."
      }, {
        question: "Why can't I hear any sound?",
        answer: "Modern browsers require user interaction before playing audio. Ensure you have clicked the 'Play Audio' button and that your device is not muted."
      }, {
