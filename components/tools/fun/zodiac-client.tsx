...
export default function ZodiacClient() {
 ...
 <select value={day} onChange={e => setDay(parseInt(e.target.value))} className="w-full rounded-lg border border-border/70 bg-background/80 p-2 text-sm outline-none focus:ring-2 focus:ring-primary/50">
 ...
 <ToolHowItWorks steps={[{
        step: "01",
        title: "Select Month",
        description: "Choose the month of your birth from the dropdown menu.",
        icon: Star
      }, {
        step: "02",
        title: "Select Day",
        description: "Pick the exact day you were born to pinpoint your astrological window.",
        icon: Star
      }, {
        step: "03",
        title: "Read Profile",
        description: "Instantly view your zodiac sign, symbol, element, and personality traits.",
        icon: Star
 ...
 <ToolFeatureGuides features={[{
        icon: Star,
        title: "All 12 Signs",
        description: "Includes complete data for Aries through Pisces, including cusp dates."
      }, {
        icon: Star,
        title: "Dynamic Calendar",
        description: "Automatically adjusts the number of days based on the selected month."
      }, {
        icon: Star,
        title: "Astrological Data",
        description: "Displays ruling planets and elemental associations (Fire, Earth, Air, Water)."
      }, {
        icon: Star,
        title: "Instant Profiling",
        description: "Provides a quick summary of the core personality traits associated with your sign."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        question: "What if I was born on a cusp?",
        answer: "If your birthday falls on the exact day a sign changes (e.g., March 20), astrologers often recommend checking your exact birth time and location, as the sun may have shifted mid-day."
      }, {
        question: "Is this my Sun, Moon, or Rising sign?",
        answer: "This calculator determines your Sun sign, which is based solely on your birth month and day. Moon and Rising signs require your exact birth time and location."
      }, {
        question: "Why are the elements important?",
        answer: "The four elements (Fire, Earth, Air, Water) group the signs into fundamental temperaments, explaining why certain signs naturally get along better than others."
      }]} />
