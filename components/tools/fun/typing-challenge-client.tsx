...
export default function TypingChallengeClient() {
 ...
 {Object.keys(PARAGRAPHS).map(d => <Button key={d} variant={difficulty === d ? "default" : "outline"} size="sm" onClick={() => reset(d as "short" | "medium" | "long")}>
 ...
 <textarea ref={inputRef} value={typedText} onChange={handleInput} rows={4} disabled={!!endTime} className="w-full rounded-lg border border-border/70 bg-background/80 p-3 text-sm outline-none focus:ring-2 focus:ring-primary/50 font-mono" placeholder="Start typing the text above exactly as it appears..." autoFocus />

 {endTime && <div className="flex justify-center">
 ...
 <ToolHowItWorks steps={[{
        step: "01",
        title: "Choose Length",
        description: "Select short, medium, or long text difficulty.",
        icon: Keyboard
      }, {
        step: "02",
        title: "Start Typing",
        description: "Begin typing the displayed text exactly as shown.",
        icon: Keyboard
      }, {
        step: "03",
        title: "Review Stats",
        description: "Track your WPM and accuracy live as you type.",
        icon: Keyboard
 ...
 <ToolFeatureGuides features={[{
        ...
        description: "Characters turn green for correct and red for errors instantly."
      }, {
        icon: Keyboard,
        title: "WPM Calculator",
        description: "Uses standard word length calculations for accurate speed metrics."
      }, {
        icon: Keyboard,
        title: "Error Detection",
        description: "Shows a dot (·) when you miss a space to help correct habits."
      }, {
        icon: Keyboard,
        title: "Multiple Lengths",
        description: "Three difficulty tiers to test both sprint and endurance typing."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        ...
        answer: "WPM = (Characters Typed / 5) / Minutes. This standardizes all words to a length of 5 characters for fair comparison."
      }, {
        question: "Does punctuation count as errors?",
        answer: "Yes, every character including spaces and punctuation must match exactly to maintain 100% accuracy."
      }, {
