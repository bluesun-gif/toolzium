...
export default function ReactionTimeClient() {
 ...
 <div onClick={handleClick} className={`w-full h-64 rounded-xl flex items-center justify-center text-primary-foreground text-3xl font-bold cursor-pointer transition-colors select-none ${bgColor}`}>
 {message}
 </div>
 ...
 {times.length > 0 && <div className="grid grid-cols-3 sm:grid-cols-5 gap-2">
 {times.slice(-10).map((t, i) => <div key={i} className="bg-muted/50 p-2 rounded text-center text-sm font-mono border border-border/50">
 {t} ms
 </div>)}
 </div>}
 </CardContent>
 ...
 <ToolHowItWorks steps={[{
        step: "01",
        title: "Start",
        description: "Click the blue area to begin the test.",
        icon: Zap
      }, {
        step: "02",
        title: "Wait",
        description: "The screen will turn red. Do NOT click until it turns green.",
        icon: Zap
      }, {
        step: "03",
        title: "React",
        description: "Click as fast as you can when the screen turns green to record your time.",
        icon: Zap
 ...
 <ToolFeatureGuides features={[{
        ...
        description: "Uses high-resolution timestamps for accurate measurement."
      }, {
        icon: Zap,
        title: "Anti-Cheat Logic",
        description: "Clicking before the green screen results in a penalty and resets the trial."
      }, {
        icon: Zap,
        title: "Statistical Tracking",
        description: "Automatically calculates your best and average reaction times."
      }, {
        icon: Zap,
        title: "Visual History",
        description: "Shows your last 10 attempts so you can track your improvement."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        ...
        answer: "Around 200-250ms is average for adults. Anything under 200ms is considered excellent, often seen in competitive gamers."
      }, {
        question: "Why did it say 'Too Early'?",
        answer: "You clicked while the screen was still red. This prevents cheating by anticipating the color change."
      }, {
