...
const WORDS = ["javascript", "typescript", "react", "nextjs", "nodejs", "express", "mongodb", "postgresql", "prisma", "tailwind", "graphql", "restapi", "docker", "kubernetes", "aws", "azure", "gcp", "vercel", "netlify", "git", "github", "gitlab", "bitbucket", "jest", "cypress", "webpack", "vite", "babel", "eslint", "prettier", "redux", "zustand", "recoil", "router", "axios", "fetch", "promise", "async", "await", "closure", "hoisting", "prototype", "class", "object", "array", "string", "number", "boolean", "symbol", "bigint"];
...
export default function HangmanClient() {
 ...
 {gameOver && <Button onClick={initGame} className="gap-2">
 ...
 {ALPHABET.map(letter => {
              ...
              return <Button key={letter} onClick={() => handleGuess(letter)} disabled={isGuessed || gameOver} variant={isWrong ? "destructive" : isCorrect ? "default" : "outline"} className={`h-10 ${isCorrect ? "bg-green-600 hover:bg-green-700" : ""}`}>
 {letter}
 </Button>;
            })}
 </div>
 ...
 <ToolHowItWorks steps={[{
        step: "01",
        title: "Guess Letters",
        description: "Click any letter from the keyboard grid to guess it.",
        icon: Skull
      }, {
        step: "02",
        title: "Avoid Errors",
        description: "You have 7 wrong guesses before the hangman is complete.",
        icon: Skull
      }, {
        step: "03",
        title: "Win the Game",
        description: "Reveal all letters in the hidden word to win and start a new round.",
        icon: Skull
 ...
 <ToolFeatureGuides features={[{
        ...
        description: "Words are drawn from a curated list of programming and tech terms."
      }, {
        icon: Skull,
        title: "Visual Feedback",
        description: "Buttons turn green for correct guesses and red for wrong ones."
      }, {
        icon: Skull,
        title: "Score Tracking",
        description: "Keeps track of your wins and losses across multiple sessions."
      }, {
        icon: Skull,
        title: "ASCII Art",
        description: "Classic text-based hangman drawing updates with every mistake."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        question: "What kind of words are used?",
        answer: "The game uses a curated list of 50 programming, framework, and computer science terms."
      }, {
        question: "How many wrong guesses are allowed?",
        answer: "You can make up to 6 wrong guesses. The 7th wrong guess ends the game."
      }, {
