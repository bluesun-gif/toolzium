...
export function PatternMemoryClient() {
 ...
 {Array(3).fill(0).map((_, i) => <Heart key={i} className={`w-5 h-5 ${i < lives ? 'fill-red-500 text-red-500' : 'text-gray-300 dark:text-gray-700'}`} />)}
 </div>
 <div className="text-center">
 ...
 {phase === "idle" || phase === "gameover" ? <Button onClick={startGame} variant="default" size="sm">
 <Play className="w-4 h-4 mr-2" /> Start Game
 </Button> : <Button onClick={startGame} variant="outline" size="sm">
 ...
 {phase === "recall" && <div className="flex justify-center">
 <Button onClick={checkResult} variant="default" size="lg" disabled={selectedCells.length !== patternSize}>
 Submit Pattern
 </Button>
 </div>}
 </CardContent>
