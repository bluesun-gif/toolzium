...
export default function RandomNumberClient() {
 ...
 <input type="checkbox" id="unique" checked={unique} onChange={e => setUnique(e.target.checked)} className="h-4 w-4 rounded border-border accent-primary" />
 ...
 {results.map((num, i) => <div key={i} className="px-4 py-2 bg-primary/10 text-primary border border-primary/20 rounded-lg font-mono font-bold">
 {num}
 </div>)}
 </div>
 ...
 <ToolHowItWorks steps={[{
        step: "01",
        title: "Define Range",
        description: "Set the minimum and maximum boundaries for your random numbers.",
        icon: Dices
      }, {
        step: "02",
        title: "Set Quantity",
        description: "Choose how many numbers to generate and toggle unique mode if needed.",
        icon: Dices
      }, {
        step: "03",
        title: "Generate & Copy",
        description: "Click generate to see the results in badges and copy them as a CSV list.",
        icon: Dices
 ...
 <ToolFeatureGuides features={[{
        ...
        description: "Define any integer range, from small dice rolls to massive lottery pools."
      }, {
        icon: Dices,
        title: "Unique Mode",
        description: "Ensure no duplicates are generated, perfect for raffle draws and sampling."
      }, {
        icon: Dices,
        title: "Batch Generation",
        description: "Generate hundreds of random numbers simultaneously in a single click."
      }, {
        icon: Dices,
        title: "CSV Export",
        description: "Copy the entire result set as a comma-separated list for easy pasting."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        ...
        answer: "They are pseudo-random numbers generated by the browser's JavaScript engine, which is sufficiently random for almost all non-cryptographic applications like games and sampling."
      }, {
        question: "Can I generate negative numbers?",
        answer: "Yes, simply set the minimum value to a negative integer (e.g., -100 to 100)."
      }, {
