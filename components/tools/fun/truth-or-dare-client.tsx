...
const data = {
  Clean: {
    ...
    dares: [
      ...
      "Speak without closing your mouth for 2 rounds.",
  ...
  Funny: {
    truths: [
      ...
      "Have you ever blamed a fart on a pet?",
      ...
      "Have you ever laughed at a totally inappropriate time?",
      "What's a weird habit you have?",
      "Have you ever accidentally called your teacher Mom/Dad?",
    ...
    dares: [
      "Do an impression of a chicken laying an egg.",
      "Attempt to breakdance for 30 seconds.",
      "Let the group wrap you in toilet paper like a mummy.",
      "Talk to a wall for 2 minutes as if it's a person.",
      "Do your best belly flop onto a bed.",
      "Attempt to juggle shoes.",
      "Let someone paint your nails (or pretend to).",
      "Do a dramatic soap opera scene.",
      "Sing everything you say for the next 3 turns.",
      "Attempt to do the worm.",
      "Walk like a crab across the room.",
      "Let the group give you a nickname for the rest of the night.",
      "Do an impression of a monkey.",
      "Attempt to do a handstand against a wall.",
      "Speak in slow motion for the next round.",
      "Try to lick your nose in front of a mirror.",
      "Do an impression of a baby being born.",
      "Attempt to moonwalk.",
      "Let someone tickle you until you say stop.",
  ...
  Spicy: {
    truths: [
      ...
      "Have you ever cheated on a test or at a game?",
    ...
    dares: [
      "Text your crush 'I miss you' (or a random contact).",
      "Let the group read the last 5 texts you sent.",
      "Do a seductive dance for a chair.",
      "Let someone go through your photo gallery for 1 minute.",
      "Post an ugly selfie on your story.",
      "Call a friend and sing Happy Birthday to them.",
      "Let the group compose a text and send it from your phone.",
      "Do 50 squats while singing a song.",
      "Attempt to flirt with an inanimate object.",
      "Let someone style you using only items in the room.",
      "Do an impression of the person to your right.",
      "Eat a raw clove of garlic.",
      "Let the group look through your YouTube history.",
      "Do a dramatic reading of your most recent email.",
      "Attempt to breakdance to slow music.",
      "Let someone draw a mustache on you that lasts the night.",
      "Do your best impression of a siren.",
      "Attempt to chug a glass of water in 5 seconds.",
      "Let the group pick a song and you must perform it.",
      "Do a plank while reciting the alphabet backwards."
    ]
  }
};
...
export default function TruthOrDareClient() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 px-2 sm:px-4 py-4 sm:py-6">
      ...
      <Card className={cardClass}>
        ...
        <CardContent className="p-4 sm:p-6 space-y-6">
          <div className="flex flex-wrap gap-2 justify-center">
            {(["Clean", "Funny", "Spicy"] as Category[]).map(cat => (
              <Button 
                key={cat} 
          ...
          <div className="grid grid-cols-2 gap-4 mt-6">
            <Button 
              onClick={() => getRandomItem("Truth")} 
              size="lg" 
              className="h-24 text-2xl font-bold bg-blue-600 hover:bg-blue-700 text-white"
            >
              Truth
            </Button>
            <Button 
              ...
              size="lg" 
              className="h-24 text-2xl font-bold bg-red-600 hover:bg-red-700 text-white"
            >
              Dare
            </Button>
          </div>
          ...
          {currentItem && (
            <div className="p-6 rounded-xl bg-muted/30 border border-border/50 text-center space-y-2 mt-6 animate-in fade-in zoom-in duration-300">
              <div className={`text-xs font-bold uppercase tracking-wider ${type === "Truth" ? "text-blue-500" : "text-red-500"}`}>
                {type}
              </div>
          ...
          {history.length > 0 && (
            <div className="mt-8 border-t border-border/50 pt-4 space-y-2">
              ...
              <div className="max-h-40 overflow-y-auto space-y-1">
                {history.map((h, i) => (
                  <div key={i} className="text-sm p-2 bg-background/50 rounded border border-border/30">
                    {h}
                  </div>
                ))}
              </div>
      ...
      <ToolHowItWorks 
        steps={[
          { step: "01", title: "Pick Category", description: "Choose the intensity level: Clean for families, Funny for friends, or Spicy for adults.", icon: Flame },
          { step: "02", title: "Choose Fate", description: "Select either Truth to answer a question, or Dare to perform a challenge.", icon: Flame },
          { step: "03", title: "Perform & Pass", description: "Complete the action, then pass the device to the next player and track your history.", icon: Flame }
        ]} 
        badges={["100% Free", "Client-Side", "Fun"]} 
      />

      <ToolFeatureGuides features={[
        { icon: Flame, title: "Multiple Categories", description: "Tailor the game to your audience with Clean, Funny, and Spicy content libraries." },
        { icon: Flame, title: "Massive Database", description: "Includes over 120 unique prompts to ensure the game stays fresh for hours." },
        { icon: Flame, title: "Session History", description: "Keep track of what has already been asked to avoid repeating questions." },
        { icon: Flame, title: "Instant Reroll", description: "Don't like your prompt? Hit the shuffle button to instantly draw a new one." }
      ]}>
      ...
      <ToolFaqAccordion faqs={[
        { question: "How many questions and dares are included?", answer: "There are 20 truths and 20 dares in each of the 3 categories, totaling 120 unique prompts." },
        { question: "Is the 'Spicy' category safe for work?", answer: "No, the 'Spicy' category contains mature themes and is intended strictly for adult gatherings." },
