...
export default function PasswordGeneratorClient() {
 ...
 <label key={opt.label} className="flex items-center space-x-2 cursor-pointer p-3 rounded-lg border border-border/50 hover:bg-muted/30">
 <input 
 type="checkbox"
 checked={opt.state} 
 ...
 {passwords.map((p, i) => (
 <div key={i} className="flex items-center gap-2 p-3 bg-background rounded-lg border border-border/50">
 ...
 <ToolHowItWorks 
 steps={[
 { step:"01", title:"Set Length", description:"Drag the slider to choose how long your password should be (up to 64 characters).", icon: KeyRound },
 { step:"02", title:"Choose Characters", description:"Toggle the inclusion of uppercase, lowercase, numbers, and special symbols.", icon: KeyRound },
 { step:"03", title:"Generate & Copy", description:"Click generate to create secure passwords and copy them to your clipboard instantly.", icon: KeyRound }
 ]} 
 badges={["100% Free","Client-Side","Secure"]} 
 />

 <ToolFeatureGuides features={[
 { icon: KeyRound, title:"Cryptographic Randomness", description:"Uses the Web Crypto API (window.crypto.getRandomValues) for true, unpredictable entropy."},
 { icon: KeyRound, title:"Strength Meter", description:"Visual feedback indicates how resilient your password configuration is against brute-force attacks."},
 { icon: KeyRound, title:"Batch Generation", description:"Generate up to 10 unique passwords simultaneously for all your accounts."},
 { icon: KeyRound, title:"Zero-Knowledge", description:"Passwords are generated locally in your browser and are never transmitted over the network."}
 ]}>
 ...
 { question:"Are these passwords sent to your server?", answer:"Absolutely not. The generation algorithm runs entirely within your web browser using JavaScript. The passwords never leave your device."},
 { question:"What is a good password length?", answer:"Security experts recommend a minimum of 12-16 characters for standard accounts, and 20+ characters for highly sensitive accounts like email or banking."},
 { question:"Should I include symbols?", answer:"Yes, mixing character types (uppercase, lowercase, numbers, symbols) exponentially increases the entropy and time required to crack a password."}
 ]} />
