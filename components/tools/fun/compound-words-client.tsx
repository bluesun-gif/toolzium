...
const COMPOUND_WORDS = [
 { w1:"Sun", w2:"flower"}, { w1:"Rain", w2:"bow"}, { w1:"Star", w2:"fish"},
 { w1:"Butter", w2:"fly"}, { w1:"Water", w2:"melon"}, { w1:"Snow", w2:"man"},
 { w1:"Fire", w2:"fly"}, { w1:"Bed", w2:"room"}, { w1:"Tooth", w2:"brush"},
 { w1:"Foot", w2:"ball"}, { w1:"Pan", w2:"cake"}, { w1:"Cup", w2:"cake"},
 { w1:"Arm", w2:"chair"}, { w1:"Book", w2:"worm"}, { w1:"Eye", w2:"brow"},
 { w1:"Key", w2:"board"}, { w1:"Sun", w2:"glass"}, { w1:"Mail", w2:"box"},
 { w1:"Sand", w2:"castle"}, { w1:"Straw", w2:"berry"}
];
...
export default function CompoundWordsClient() {
 ...
 useEffect(() => {
 const wrongOptions = COMPOUND_WORDS
 ...
 if (showResult) {
 if (opt === currentWord.w2) btnClass +="bg-green-500/20 border-green-500 text-green-700 dark:text-green-400";
 else if (opt === selected) btnClass +="bg-red-500/20 border-red-500 text-red-700 dark:text-red-400";
 ...
 return (
 <button key={idx} className={btnClass} onClick={() => handleSelect(opt)} disabled={showResult}>
 {opt}
 </button>
 );
 })}
 ...
 <ToolHowItWorks 
 steps={[
 { step:"01", title:"Read the First Half", description:"Look at the first half of the compound word displayed on the screen.", icon: Puzzle },
 { step:"02", title:"Choose the Match", description:"Select the correct second half from the four available options.", icon: CheckCircle2 },
 { step:"03", title:"Beat the Clock", description:"Answer quickly to build your score and complete all 20 rounds.", icon: Timer }
 ]} 
 badges={["100% Free","Client-Side","Fun"]} 
 />

 <ToolFeatureGuides features={[
 { icon: Puzzle, title:"20+ Word Pairs", description:"A diverse collection of common English compound words to test your vocabulary."},
 { icon: Timer, title:"Timed Challenges", description:"A live timer tracks your speed, adding a competitive edge to the learning experience."},
 { icon: CheckCircle2, title:"Instant Validation", description:"Immediately see if your choice was correct and learn the full compound word."},
 { icon: RotateCcw, title:"Replayability", description:"Shuffle the options and play again to improve your reaction time and memory."}
 ]}>
 ...
 { question:"What is a compound word?", answer:"A compound word is created when two or more individual words are combined to form a new word with its own distinct meaning (e.g., rain + bow = rainbow)."},
 { question:"Is this game suitable for children?", answer:"Yes! The game features common, everyday words and is highly beneficial for children developing their reading and vocabulary skills."},
