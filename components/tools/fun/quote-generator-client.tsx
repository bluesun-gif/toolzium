...
const quotes = [{
  ...
  text: "Light travels faster than sound. This is why some people appear bright until you hear them speak.",
  author: "Alan Dundes",
  cat: "Funny"
}, {
...
export default function QuoteGeneratorClient() {
 ...
 {(["All", "Motivational", "Funny", "Life", "Love", "Success"] as Category[]).map(cat => <Button key={cat} variant={category === cat ? "default" : "outline"} size="sm" onClick={() => {
              setCategory(cat);
 ...
 {favorites.length > 0 && <div className="mt-8 border-t border-border/50 pt-4 space-y-2">
 <h3 className="text-sm font-semibold mb-2">Your Favorites ({favorites.length})</h3>
 <div className="space-y-2 max-h-60 overflow-y-auto pr-2">
 {favorites.map((f, i) => <div key={i} className="p-3 bg-background/50 rounded-lg border border-border/30 flex justify-between items-start gap-4">
 <div>
 ...
 <ToolHowItWorks steps={[{
        ...
        description: "Filter the database by mood or theme, such as Funny or Motivational.",
        icon: Quote
      }, {
        step: "02",
        title: "Read & Reflect",
        description: "Take a moment to absorb the wisdom, humor, or perspective of the quote.",
        icon: Quote
      }, {
        step: "03",
        title: "Save or Share",
        description: "Add it to your local favorites list or copy the text to share on social media.",
        icon: Quote
 ...
 <ToolFeatureGuides features={[{
        ...
        description: "Features 40 hand-selected quotes spanning five distinct emotional categories."
      }, {
        icon: Quote,
        title: "Local Favorites",
        description: "Save your most loved quotes to a persistent list during your browsing session."
      }, {
        icon: Quote,
        title: "Smart Filtering",
        description: "Instantly narrow down the randomizer to only show quotes that match your current mood."
      }, {
        icon: Quote,
        title: "One-Click Copy",
        description: "Formats the quote and author perfectly for pasting into tweets, captions, or documents."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        question: "Are these quotes historically accurate?",
        answer: "We strive to attribute quotes correctly, but the internet is full of misattributions. Some are marked 'Unknown' when the original author is debated."
      }, {
        question: "Will my favorites be saved if I close the tab?",
        answer: "The favorites list is stored in the browser's active memory and will reset when you refresh or close the page."
      }, {
