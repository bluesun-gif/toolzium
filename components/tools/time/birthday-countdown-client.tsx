...
export function BirthdayCountdownClient() {
 ...
 description="Set your birthday and see a live countdown to your next birthday along with fun facts."
 actions={
 <>
 ...
 <div className="text-muted-foreground">Not born yet or date not set!</div>
 )}
 </CardContent>
 </GlassCard>
 ...
 <div className="text-muted-foreground">Set your birthday to see facts!</div>
 )}
 </CardContent>
 </GlassCard>
 </div>
