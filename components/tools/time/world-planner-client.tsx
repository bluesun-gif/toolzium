...
export function WorldPlannerClient() {
 ...
 className={cn("flex-1 cursor-pointer border-r border-background/20 relative group", getHourColor(localH), (isSelected ?"ring-2 ring-primary ring-inset z-10 opacity-100":"opacity-70 hover:opacity-90"))}
 >
