    ...
    <div className="max-w-6xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className={`${cardClass} flex flex-col`}>
          ...
          <CardContent className="p-8 flex-1 flex items-center justify-center relative bg-slate-900 overflow-hidden" style={{ perspective: `${perspective}px` }}>
            <div 
        ...
        <Card className={cardClass}>
          ...
          <CardContent className="p-4 space-y-4 max-h-[600px] overflow-y-auto">
            ...
            <div className="pt-4 border-t border-border/40">
              ...
              <pre className="w-full rounded-lg border border-border/70 bg-slate-950 p-3 text-[10px] text-cyan-400 overflow-x-auto h-48 leading-relaxed font-mono">
                {cssOutput}
              </pre>
            </div>
          </CardContent>
