...
"Works offline",
 ...
 <tbody>
 {[
 ["Unix (seconds)","1710499200","1 second","Unix/Linux, databases, APIs"],
 ["Unix (ms)","1710499200000","1 millisecond","JavaScript Date.now(), Java"],
 ["ISO 8601 (UTC)","2024-03-15T10:00:00Z","1 second","REST APIs, JSON, XML"],
 ["ISO 8601 (offset)","2024-03-15T16:00:00+06:00","1 second","Localized API responses"],
 ["RFC 2822","Fri, 15 Mar 2024 10:00:00 +0000","1 second","Email headers, HTTP dates"],
 ["RFC 3339","2024-03-15T10:00:00.000Z","1 ms","Internet protocols, IETF"],
 ].map(([fmt, ex, prec, use]) => (
 ...
 ["Rust","SystemTime::UNIX_EPOCH.elapsed().unwrap().as_secs()",".as_millis()"],
 ["SQL (PostgreSQL)","EXTRACT(EPOCH FROM NOW())","... * 1000"],
 ].map(([lang, secs, ms]) => (
 <tr key={lang} className="odd:bg-muted/20">
