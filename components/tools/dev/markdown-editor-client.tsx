...
import { FileText, Bold, Italic, Heading1, Heading2, Heading3, Link as LinkIcon, Image as ImageIcon, Code, List, ListOrdered, Quote, Minus, Download, Copy, Trash2, Maximize, Minimize } from "lucide-react";
