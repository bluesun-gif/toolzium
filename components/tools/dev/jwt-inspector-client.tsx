...
export default function JwtInspectorClient() {
 ...
 <Input type="text" value={token} onChange={e => setToken(e.target.value)} placeholder="eyJhbGciOiJIUzI1Ni..." className="h-11 font-mono text-xs" />

 <div className="flex justify-end pt-1">
 <Button onClick={auditWithAi} disabled={loading || !payloadJson} className="gap-2 font-bold h-10 px-5 shadow-md">
...
=======
 {aiAnalysis.length > 0 && <AiOutputDisplay title="AI JWT Security Audit Report" subtitle="Real-time LLM security vulnerability and token risk assessment" content={aiAnalysis} loading={loading} onRegenerate={auditWithAi} variant="prose" />}
