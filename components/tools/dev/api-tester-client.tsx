        ...
        <Card className={cardClass}>
          ...
          <CardContent className="p-4 space-y-4">
            <div className="flex flex-wrap gap-4 text-sm">
              <div className={`px-3 py-1 rounded-full font-bold ${response.status < 300 ? 'bg-green-500/20 text-green-500' : response.status < 400 ? 'bg-blue-500/20 text-blue-500' : response.status < 500 ? 'bg-yellow-500/20 text-yellow-500' : 'bg-red-500/20 text-red-500'}`}>
            ...
            <div className="border border-border/50 rounded-lg overflow-hidden">
              ...
              <div className="p-4 bg-slate-950 text-slate-100 max-h-96 overflow-auto">
