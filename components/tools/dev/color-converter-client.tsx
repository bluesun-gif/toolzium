...
export function ColorConverterClient() {
  ...
  const contrast = useMemo(() => {
    const bgParsed = hexToRgb(bgColorHex) || {
      r: 255,
      g: 255,
      b: 255
    };
 ...
 <input type="range" min="0" max="1" step="0.01" value={color.a} onChange={e => setColor({
                ...color,
 ...
 {Object.entries(formats).map(([key, val]) => <Card key={key} className={cardClass}>
 <CardHeader className={headerClass}>
 ...
 <div className="w-12 h-12 rounded-lg border" style={{
                backgroundColor: harmonies.complementary
              }} title="Complementary" />
 ...
 <div className="flex gap-2">
 <div className="w-12 h-12 rounded-lg border" style={{
                backgroundColor: harmonies.analogous1
              }} />
 <div className="w-12 h-12 rounded-lg border" style={{
                backgroundColor: harmonies.analogous2
              }} />
 <div className="flex-1">
 ...
 <div className="flex gap-2">
 <div className="w-12 h-12 rounded-lg border" style={{
                backgroundColor: harmonies.triadic1
              }} />
 <div className="w-12 h-12 rounded-lg border" style={{
                backgroundColor: harmonies.triadic2
              }} />
 <div className="flex-1">
 ...
 <div className="p-4 rounded-lg text-center font-bold" style={{
 ...
 {history.map((c, i) => <div key={i} className="w-10 h-10 rounded-lg border cursor-pointer hover:scale-110 transition-transform" style={{
 ...
 <ToolHowItWorks steps={[{
        ...
        description: "Instantly see your color translated into all major web and print formats.",
        icon: Palette
      }, {
        step: "03",
        title: "Check Accessibility",
        description: "Verify WCAG compliance against your background color to ensure readability.",
        icon: Contrast
 ...
 <ToolFeatureGuides features={[{
        ...
        description: "Seamlessly translate between HEX, RGB, HSL, HSV, and CMYK color spaces."
      }, {
        icon: Contrast,
        title: "WCAG Compliance",
        description: "Built-in contrast ratio calculator ensures your text is accessible to all users."
      }, {
        icon: Droplet,
        title: "Color Harmonies",
        description: "Generate complementary, analogous, and triadic color schemes instantly."
      }, {
        icon: History,
        title: "Local History",
        description: "Keep track of your recently used colors for fast iteration and consistency."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        ...
        answer: "RGB defines color by mixing red, green, and blue light, which is how screens work. HSL defines color by its position on the color wheel (Hue), its intensity (Saturation), and its brightness (Lightness), which is much easier for humans to adjust."
      }, {
        question: "Why does my color look different in print?",
        answer: "Screens use an additive RGB color model (emitting light), while printers use a subtractive CMYK model (absorbing light with ink). The CMYK gamut is smaller than RGB, meaning some vibrant screen colors physically cannot be reproduced with standard ink."
      }, {
