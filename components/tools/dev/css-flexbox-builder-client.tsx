...
export function CssFlexboxBuilderClient() {
 ...
 {items.map((item, index) => <div key={item.id} className="p-3 border border-border/50 rounded-lg space-y-2 bg-muted/10">
 ...
 {sortedItems.map((item, i) => <div key={item.id} style={{
                  flexGrow: item.grow,
 ...
 <ToolHowItWorks steps={[{
        step: "01",
        title: "Set Container Rules",
        description: "Define how the flex container distributes space using direction, wrap, and justify.",
        icon: LayoutGrid
      }, {
        step: "02",
        title: "Tweak Child Items",
        description: "Adjust individual item properties like flex-grow, shrink, and align-self.",
        icon: Plus
      }, {
        step: "03",
        title: "Export Code",
        description: "Copy the generated standard CSS or Tailwind classes directly into your project.",
        icon: Copy
 ...
 <ToolFeatureGuides features={[{
        ...
        description: "See your flexbox layout update in real-time as you adjust container and child properties."
      }, {
        icon: Sparkles,
        title: "Layout Presets",
        description: "Instantly apply common layouts like Navigation Bars, Card Grids, and Holy Grail."
      }, {
        icon: Copy,
        title: "Dual Code Export",
        description: "Generate both raw CSS properties and modern Tailwind CSS utility classes."
      }, {
        icon: Plus,
        title: "Per-Item Control",
        description: "Manage up to 8 individual flex items with unique grow, shrink, basis, and order values."
      }]}>
 ...
 <ToolFaqAccordion faqs={[{
        ...
        answer: "justify-content distributes space along the main axis (the direction defined by flex-direction), while align-items aligns items along the cross axis (perpendicular to the main axis)."
      }, {
        question: "When should I use Flexbox vs CSS Grid?",
        answer: "Use Flexbox for one-dimensional layouts (a single row or column of items). Use CSS Grid for two-dimensional layouts where you need precise control over both rows and columns simultaneously."
      }, {
