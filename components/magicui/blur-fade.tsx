...
/**
 * BlurFade — wraps children with a scroll-triggered blur + fade + slide-up entrance.
 * Use on any section (ToolHowItWorks, ToolFeatureGuides, etc.) to add smooth entrance.
