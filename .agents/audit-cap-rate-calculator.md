# Audit — AI Real Estate Cap Rate & Cash-on-Cash Investment Auditor (`/tools/finance/cap-rate-calculator`)
...
## Verification
- HTTP 200 on http://localhost:3000/tools/finance/cap-rate-calculator ✓
