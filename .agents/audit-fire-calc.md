# Audit — FIRE Calculator (`/tools/finance/fire-calc`)
...
3. BUILD/FIX —
   ...
   - Bug fix: Fixed savings-rate divide-by-zero when annualIncome=0 (was NaN). Guarded with annualIncome>0.
...
## Verification
- HTTP 200 on http://localhost:3000/tools/finance/fire-calc ✓
