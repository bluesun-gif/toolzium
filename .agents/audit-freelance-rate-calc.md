# Audit — Freelance Hourly Rate & Project Pricing Calculator (`/tools/finance/freelance-rate-calc`)
...
3. BUILD/FIX —
   ...
   - Bug fix: Fixed invalid Tailwind class border-primary/50/30 -> border-primary/30.
...
## Verification
- HTTP 200 on http://localhost:3000/tools/finance/freelance-rate-calc ✓
