# Audit — Currency Pair Chart (`/tools/finance/currency-chart`)
...
3. BUILD/FIX —
   ...
   - Bug fix: Rewired to live FX via /api/rates (was charCode mock + hardcoded +2.4%/-1.8% trend). Now shows real mid-market rate, source, clearly-labelled illustrative path.
...
## Verification
- HTTP 200 on http://localhost:3000/tools/finance/currency-chart ✓
