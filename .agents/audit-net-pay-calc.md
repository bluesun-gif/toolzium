# Audit — Salary / Net Pay Calculator — Free Take-Home Paycheck Calculator (`/tools/finance/net-pay-calc`)
...
## Verification
- HTTP 200 on http://localhost:3000/tools/finance/net-pay-calc ✓
