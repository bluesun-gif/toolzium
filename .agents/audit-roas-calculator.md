# Audit — Shopify & Amazon Profit Margin & Ad Spend (ROAS) Calculator (`/tools/finance/roas-calculator`)
...
## Verification
- HTTP 200 on http://localhost:3000/tools/finance/roas-calculator ✓
