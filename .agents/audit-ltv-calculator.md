# Audit — Free LTV Calculator (2026) — Calculate Loan-to-Value & CLTV Ratio (`/tools/finance/ltv-calculator`)
...
## Verification
- HTTP 200 on http://localhost:3000/tools/finance/ltv-calculator ✓
