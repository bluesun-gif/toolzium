...
export const ToolsData = [
  ...
  },
  {
    ...
    url: "/tools#cat-intelligence",
    icon: Shield,
    isActive: true,
    items: [
      {
        title: "Reverse Phone Lookup & Scam Checker",
        url: "/lookup/phone",
        description: "Identify callers, uncover telecom carriers, detect robocalls, and check live scam risk scores for any phone number.",
        popular: true,
      },
      {
        title: "IP Geolocation & Threat Intelligence",
        url: "/lookup/ip",
        description: "Lookup geographic location, ISP, ASN, and VPN/Proxy/Tor security flags for any IPv4 or IPv6 address.",
        popular: true,
      },
      {
        title: "WHOIS & RDAP Domain Intelligence",
        url: "/lookup/whois",
        description: "Inspect ICANN domain registration dates, registrar authority, nameservers, and domain age.",
        popular: true,
      },
      {
        title: "Username OSINT & Social Scanner",
        url: "/lookup/username",
        description: "Check username availability and find profiles across GitHub, Twitter/X, Reddit, TikTok, Instagram, and 20+ networks.",
        popular: true,
      },
      {
        title: "Password Breach & Pwned Checker",
        url: "/security/password",
        description: "Check if your password was leaked in data breaches using zero-knowledge SHA-1 k-anonymity.",
        popular: true,
      },
      {
        title: "Email & Account Breach Scanner",
        url: "/security/breach",
        description: "Search public breach archives to see if your email address or corporate accounts were compromised.",
        popular: true,
      },
      {
        title: "Email Domain Security Scanner (SPF/DKIM/DMARC)",
        url: "/security/email",
        description: "Audit any domain's email authentication — MX, SPF, DKIM, DMARC, and disposable-email risk — via live DNS.",
        popular: true,
      },
      {
        title: "SSL Certificate Scanner & Expiry Monitor",
        url: "/security/ssl",
        description: "Live TLS handshake that reveals issuer, validity, expiry countdown, cipher strength, and SAN coverage.",
        popular: true,
      },
      {
        title: "Free Software Alternatives Directory",
        url: "/alternatives",
        description: "Discover free and open-source replacements for Photoshop, Canva, Notion, Office, and Premiere.",
        popular: true,
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "AI SQL & Regex Builder",
        url: "/tools/ai/sql-regex-builder",
        description: "Convert natural language requirements into production-ready SQL queries and Regex expressions with explanations.",
        popular: true,
      },
      {
        title: "AI Resume & ATS Checker",
        url: "/tools/ai/ats-checker",
        description: "Calculate your ATS match score against target job descriptions, find missing keywords, and optimize your resume.",
        popular: true,
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        url: "/tools/writing/ai-detector",
        description:
          "Detect text generated by ChatGPT (GPT-4o), Claude 3.5, Gemini, and DeepSeek with sentence-by-sentence perplexity heatmaps and burstiness analysis.",
        popular: true,
      },
      {
        title: "AI Text Humanizer — Bypass AI Detectors",
        url: "/tools/writing/ai-text-humanizer",
        description:
          "Rewrite robotic AI-generated text into natural, human-sounding writing that bypasses GPTZero, Turnitin, and Originality.ai detectors.",
        popular: true,
      },
      {
      ...
      {
        title: "Readability Score & Grade Level Analyzer",
        url: "/tools/text/readability-score",
        description:
          "Calculate Flesch Reading Ease, Flesch-Kincaid Grade Level, Gunning Fog, Coleman-Liau, and SMOG scores. Free online readability analyzer.",
        popular: true,
      },
      {
      ...
      },
      {
        ...
        url: "/tools/text/palindrome-checker",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Generate and export WCAG 2.1 design system color contrast sheets. Use contrast sheet exporter on Toolzium — no signup, no watermarks, works on any device.",
        popular: false,
      },
      {
      ...
      },
      {
        ...
        url: "/tools/image/placeholder-image",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        url: "/tools/dev/box-shadow-generator",
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "HELOC (Home Equity Line of Credit) Payment Calculator",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Calculate optimal sleep and wake cycles for shift workers. Use shift circadian on Toolzium — no signup, no watermarks, works on any device.",
        popular: false,
      },
      {
        title: "Sleep Debt & Recovery Calculator",
        url: "/tools/time/sleep-debt",
        description: "Calculate accumulated sleep debt over a 7-day week and recovery plan. Use sleep debt on Toolzium — no signup, no watermarks, works on any device.",
        popular: false,
      },
      {
        title: "Sleep Efficiency & Quality Score Calculator",
      ...
      },
      {
        ...
        description: "Create digital time capsule messages locked until a future date. Use time capsule on Toolzium — no signup, no watermarks, works on any device.",
        popular: false,
      },
],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Generate secure passwords with NATO phonetic spelling soundout. Use nato phonetic password on Toolzium — no signup, no watermarks, works on any device.",
        popular: false,
      },
      {
        title: "Phonetic Password Generator & NATO Guide",
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "Contractor Scope of Work & Deliverables Builder",
        url: "/tools/office/contractor-sow-builder",
        description:
          "Formal Statement of Work (SOW) document generator for independent contractors & freelancers. Deliverables timeline, milestone payments, print view.",
        popular: true,
      },],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Multi-item travel cost converter and comparison sheet. Use currency price matrix on Toolzium — no signup, no watermarks, works on any device.",
        popular: false,
      },
      {
      ...
      {
        title: "Multi-Currency Travel Budget Calculator",
        url: "/tools/travel/travel-budget-calc-sheet",
        description: "Multi-currency travel expense comparison and trip budgeting sheet. Use travel budget calc sheet on Toolzium — no signup, no watermarks, works on any device.",
        popular: false,
      },
      {
        title: "Travel Budget Currency Comparison Matrix",
        url: "/tools/travel/travel-budget-matrix",
        description: "Compare travel budgets across multiple destination currencies. Use travel budget matrix on Toolzium — no signup, no watermarks, works on any device.",
        popular: false,
      },
      {
        title: "Travel Budget Multi-Currency Comparison Sheet",
        url: "/tools/travel/travel-budget-sheet",
        description: "Multi-currency travel expense comparison and trip budgeting sheet. Use travel budget sheet on Toolzium — no signup, no watermarks, works on any device.",
        popular: false,
      },
      {
        title: "Currency Trip Budget & Spending Matrix",
        url: "/tools/travel/trip-budget-matrix",
        description: "Comprehensive multi-destination travel budget converter matrix. Use trip budget matrix on Toolzium — no signup, no watermarks, works on any device.",
        popular: false,
      },
],
  },
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "Tile Sequence Pattern Memory Challenge",
        url: "/tools/fun/pattern-tile-memory",
        description:
          "Interactive spatial memory sequence puzzle game. 3x3, 4x4, and 5x5 tile grids, speed settings, streak multipliers, best high scores.",
        popular: true,
      },      {
      ...
      },
      {
        ...
        description: "Test your vocabulary with this fun compound words puzzle game. Use compound words on Toolzium — no signup, no watermarks, works on any device.",
        popular: false,
      },
      {
      ...
      },
      {
        ...
        description: "Convert text to Morse code with audio playback. Listen and learn. Use morse audio on Toolzium — no signup, no watermarks, works on any device.",
        popular: false,
      },
],
  },
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "Running vs Walking Pace & Calorie Calculator",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Organize tasks effectively using the Eisenhower Matrix methodology. Use eisenhower checklist on Toolzium — no signup, no watermarks, works on any device.",
        popular: false,
      },
      {
      ...
      },
      {
        ...
        description: "Organize tasks using the 4-quadrant Eisenhower method. Use eisenhower list on Toolzium — no signup, no watermarks, works on any device.",
        popular: false,
      },
      {
        title: "Eisenhower Matrix Planner",
      ...
      },
      {
        ...
        description: "Organize tasks by priority with this simple kanban board. Use priority kanban on Toolzium — no signup, no watermarks, works on any device.",
        popular: false,
      },
      {
      ...
      },
      {
        ...
        description: "Interactive 4-quadrant task board with priority sorting. Use priority quadrant board on Toolzium — no signup, no watermarks, works on any device.",
        popular: false,
      },
],
  },
