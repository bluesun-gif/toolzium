...
- Name: debug.spec.ts >> Debug Failed Tools >> debug /tools/text/lorem-ipsum
    ...
    - generic [ref=e1626]:
      ...
      - main [ref=e1649]:
        - generic [ref=e1651]:
          - generic [ref=e1653]:
            - generic [ref=e1655]:
              - heading "Lorem Ipsum Generator" [level=1] [ref=e1656]
              - paragraph [ref=e1659]: Generate custom placeholder dummy text for design mockups, wireframes, and layouts. Choose paragraphs, sentences, words, or lists with optional HTML tags.
            - generic [ref=e1660]:
              - generic [ref=e1661]:
                - generic [ref=e1662]:
                  - generic [ref=e1663]: Generator Settings
                  - generic [ref=e1665]:
                    - generic [ref=e1666]:
                      - text: Type of Content
                      - generic [ref=e1667]:
                        - button "Paragraphs" [ref=e1668]
                        - button "Sentences" [ref=e1669]
                        - button "Words" [ref=e1670]
                        - button "Bullet List" [ref=e1671]
                    - generic [ref=e1672]:
                      - generic [ref=e1673]:
                        - generic [ref=e1674]: Quantity (paragraphs)
                        - generic [ref=e1675]: "5"
                      - slider [ref=e1676] [cursor=pointer]: "5"
                    - generic [ref=e1677]:
                      - generic [ref=e1678]:
                        - paragraph [ref=e1680]: Start with 'Lorem ipsum...'
                        - paragraph [ref=e1681]: Begin text with classic Latin phrase
                      - switch [checked] [ref=e1682]
                    - generic [ref=e1683]:
                      - generic [ref=e1684]:
                        - paragraph [ref=e1686]: Include HTML Tags
                        - paragraph [ref=e1687]: Wrap output with <p> or <ul><li> tags
                      - switch [ref=e1688]
                    - button "Regenerate Text" [ref=e1690]
                - generic [ref=e1693]:
                  - generic [ref=e1694]:
                    - generic [ref=e1695]: Total Words
                    - generic [ref=e1700]: "23"
                  - generic [ref=e1701]:
                    - generic [ref=e1702]: Total Characters
                    - generic [ref=e1707]: 1,364
              - generic [ref=e1709]:
                - generic [ref=e1710]:
                  - generic [ref=e1711]:
                    - generic [ref=e1712]: Generated Text
                    - generic [ref=e1713]: Instant copy-ready placeholder text
                  - button "Copy Text" [ref=e1714]
                - textbox [ref=e1718]: Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.Eueamagnaautedoloreestullamcosintsuntet.Consequattemporexculpapariatursuntelit.Cillumcillumsinttemporautealiquipfugiatexercitationestincididuntduisincididuntlorem.Cupidatatdeseruntsintipsumduisminimesse.Exercitationanimminimlaborumoccaecatnonenimsint.Occaecatessecommodovoluptateconsequatvoluptateenimdolorenullaadipiscing. Utauteetlaboreanimetnon.Laborisloremincididuntnullainquiexet.Sitinquiseaexercitationfugiatnonelitnonveniameuid.Ullamcocupidatatvoluptatecupidatatlaborismollitloremeareprehenderitduisdolorecupidatatinmagna.Reprehenderitelitinsitessealiquipcupidatatsedmollitametautelaborum. Etnisiexcupidatatirurepariatur.Idinnisideserunttempornostrud.Ullamcomagnaelitsintestlaborum. Utconsequatpariaturaliquaoccaecatutnostrudreprehenderitdolorevelitmagnasint.Reprehenderitcommodoincididuntnostrudanimcupidatatduiseavelitidconsecteturconsectetur.Minimeuadullamcoexlaboreexercitationeliteuesteu.Officiacommododolordeseruntipsumaddoexdoloredolore.Culpanisiconsecteturnostruddolorealiquipfugiatinconsecteturoccaecatenim.Loremconsequatdodononaliquaelitautevelitsunteaaliquaconsecteturdolor. Commodoloremeiusmodutsuntveniamconsequatid.Animelitincididuntexestnostrudaliquip.Consecteturautedeseruntidutirurevoluptatevoluptatelaborefugiat.
            - generic [ref=e1719]:
              - generic [ref=e1720]:
                - heading "How It Works" [level=2] [ref=e1721]
                - paragraph [ref=e1722]: Simple, fast, and 100% secure in 3 steps.
              - generic [ref=e1723]:
                - generic [ref=e1730]:
                  - generic [ref=e1731]: "01"
                  - generic [ref=e1737]:
                    - heading "Choose Your Format" [level=3] [ref=e1738]
                    - paragraph [ref=e1739]: "Select the output type: paragraphs, sentences, or words. Set the count (e.g., 3 paragraphs, 10 sentences, 50 words). Choose between classic Lorem Ipsum or randomized Latin-style placeholder text."
                - generic [ref=e1744]:
                  - generic [ref=e1745]: "02"
                  - generic [ref=e1750]:
                    - heading "Customize Options" [level=3] [ref=e1751]
                    - paragraph [ref=e1752]: Toggle whether to start with the classic 'Lorem ipsum dolor sit amet...' opening. Enable HTML output to wrap paragraphs in p tags for direct use in code editors and CMS platforms.
                - generic [ref=e1758]:
                  - generic [ref=e1759]: "03"
                  - generic [ref=e1765]:
                    - heading "Copy and Use" [level=3] [ref=e1766]
                    - paragraph [ref=e1767]: Click Generate to produce your placeholder text, then copy with one click. Paste directly into Figma, Adobe XD, WordPress, HTML files, Word documents, or any design and development tool.
              - generic [ref=e1768]:
                - generic [ref=e1769]: Paragraphs, sentences, words
                - generic [ref=e1774]: HTML output
                - generic [ref=e1779]: Classic and random modes
            - generic [ref=e1784]:
              - generic [ref=e1785]:
                - generic [ref=e1786]:
                  - heading "Key Features & Capabilities" [level=2] [ref=e1787]
                  - paragraph [ref=e1793]: Designed for accuracy, privacy, and maximum efficiency.
                - generic [ref=e1794]:
                  - generic [ref=e1795]:
                    - heading "Multiple Output Formats" [level=3] [ref=e1801]
                    - paragraph [ref=e1802]: Generate placeholder text as paragraphs (with natural line breaks), individual sentences, or a word count. Each format suits different design contexts from full page mockups to button labels.
                  - generic [ref=e1803]:
                    - heading "Classic and Random Modes" [level=3] [ref=e1808]
                    - paragraph [ref=e1809]: Classic mode starts with the authentic Lorem ipsum dolor sit amet opening from Cicero. Random mode generates varied Latin-derived placeholder text for variety across multiple sections.
                  - generic [ref=e1810]:
                    - heading "HTML Paragraph Output" [level=3] [ref=e1816]
                    - paragraph [ref=e1817]: Enable HTML mode to wrap each paragraph in p tags. Output is ready to paste directly into HTML files, WordPress editors, React JSX, or any CMS that accepts HTML content.
                  - generic [ref=e1818]:
                    - heading "Instant Generation" [level=3] [ref=e1823]
                    - paragraph [ref=e1824]: Text is generated instantly in your browser with no API calls. Generate as many paragraphs, sentences, or words as needed with zero latency.
                  - generic [ref=e1825]:
                    - heading "Authentic Latin Text" [level=3] [ref=e1830]
                    - paragraph [ref=e1831]: Classic Lorem Ipsum derives from Cicero's De Finibus Bonorum et Malorum (45 BC). The standard passage starting with Lorem ipsum dolor sit amet has been used in typesetting since the 1500s.
                  - generic [ref=e1832]:
                    - heading "Client-Side and Private" [level=3] [ref=e1837]
                    - paragraph [ref=e1838]: All generation happens in your browser. Nothing is sent to a server. Works fully offline once the page is loaded.
              - generic [ref=e1842]:
                - heading "Lorem Ipsum Complete Guide" [level=3] [ref=e1843]
                - paragraph [ref=e1844]: Lorem Ipsum is dummy text used in typesetting and graphic design to fill space when the actual content is not yet available. Its purpose is to allow designers, developers, and clients to focus on visual layout and typography without being distracted by readable content. The words are deliberately meaningless to the reader, preventing the content from influencing design decisions.
                - paragraph [ref=e1845]:
                  - text: The standard Lorem Ipsum passage originates from Cicero's
                  - emphasis [ref=e1846]: De Finibus Bonorum et Malorum
                  - text: (On the Ends of Good and Evil), written in 45 BC. The text was scrambled and altered to be unrecognizable, but the Latin origin gives it a natural word-length distribution similar to English, making it ideal for realistic layout mockups.
                - heading "When to Use Each Output Format" [level=3] [ref=e1847]
                - table [ref=e1849]:
                  - rowgroup [ref=e1850]:
                    - row [ref=e1851]:
                      - columnheader "Format" [ref=e1852]
                      - columnheader "Best For" [ref=e1853]
                      - columnheader "Typical Count" [ref=e1854]
                  - rowgroup [ref=e1855]:
                    - row [ref=e1856]:
                      - cell "Paragraphs" [ref=e1857]
                      - cell "Page layouts, article mockups, blog designs" [ref=e1858]
                      - cell "3-5 paragraphs" [ref=e1859]
                    - row [ref=e1860]:
                      - cell "Sentences" [ref=e1861]
                      - cell "Card components, tooltips, sidebar content" [ref=e1862]
                      - cell "2-4 sentences" [ref=e1863]
                    - row [ref=e1864]:
                      - cell "Words" [ref=e1865]
                      - cell "Button labels, nav items, short UI text" [ref=e1866]
                      - cell "3-8 words" [ref=e1867]
                    - row [ref=e1868]:
                      - cell "HTML output" [ref=e1869]
                      - cell "CMS editors, HTML templates, React/JSX" [ref=e1870]
                      - cell "Any" [ref=e1871]
                - heading "Lorem Ipsum in Design Workflows" [level=3] [ref=e1872]
                - list [ref=e1873]:
                  - listitem [ref=e1874]:
                    - strong [ref=e1875]: Figma and Adobe XD
                    - text: ": Paste Lorem Ipsum into text layers to simulate real content density. Use word-count mode for headlines and paragraph mode for body text areas."
                  - listitem [ref=e1876]:
                    - strong [ref=e1877]: WordPress and CMS
                    - text: ": Paste in classic or HTML mode directly into the block editor. HTML mode ensures correct paragraph formatting."
                  - listitem [ref=e1878]:
                    - strong [ref=e1879]: Email templates
                    - text: ": Use 2-3 sentences per section to simulate newsletter content. Avoid full paragraphs in email mockups as line wrapping differs across email clients."
                  - listitem [ref=e1880]:
                    - strong [ref=e1881]: React and Next.js
                    - text: ": Use HTML output and parse it as dangerouslySetInnerHTML, or use word/sentence mode and assign text directly to string props."
                  - listitem [ref=e1882]:
                    - strong [ref=e1883]: Print design
                    - text: ": For brochures and books, use 5-8 paragraphs in classic mode to fill realistic page space. Random mode avoids repetition across multiple pages."
                - heading "Alternatives to Lorem Ipsum" [level=3] [ref=e1884]
                - table [ref=e1886]:
                  - rowgroup [ref=e1887]:
                    - row [ref=e1888]:
                      - columnheader "Alternative" [ref=e1889]
                      - columnheader "Description" [ref=e1890]
                      - columnheader "When to Use" [ref=e1891]
                  - rowgroup [ref=e1892]:
                    - row [ref=e1893]:
                      - cell "Cupcake Ipsum" [ref=e1894]
                      - cell "Food-themed placeholder text" [ref=e1895]
                      - cell "Fun or food-related projects" [ref=e1896]
                    - row [ref=e1897]:
                      - cell "Hipster Ipsum" [ref=e1898]
                      - cell "Trendy buzzword-filled text" [ref=e1899]
                      - cell "Tech startup mockups" [ref=e1900]
                    - row [ref=e1901]:
                      - cell "Samuel L. Ipsum" [ref=e1902]
                      - cell "Movie quote-based text" [ref=e1903]
                      - cell "Entertainment projects" [ref=e1904]
                    - row [ref=e1905]:
                      - cell "Bacon Ipsum" [ref=e1906]
                      - cell "Meat-themed placeholder" [ref=e1907]
                      - cell "Restaurant or food sites" [ref=e1908]
                    - row [ref=e1909]:
                      - cell "Real content" [ref=e1910]
                      - cell "Actual project copy" [ref=e1911]
                      - cell "Final design review stages" [ref=e1912]
            - generic [ref=e1913]:
              - generic [ref=e1914]:
                - heading "Frequently Asked Questions" [level=2] [ref=e1915]
                - paragraph [ref=e1921]: Everything you need to know about using this tool.
              - generic [ref=e1922]:
                - generic [ref=e1923]:
                  - button "What is Lorem Ipsum and where does it come from?" [expanded] [ref=e1924]
                  - region "What is Lorem Ipsum and where does it come from?" [ref=e1929]:
                    - generic [ref=e1930]: Lorem Ipsum is placeholder text derived from Cicero's De Finibus Bonorum et Malorum, written in 45 BC. The standard Lorem ipsum dolor sit amet passage is a scrambled, altered version of the original Latin. It has been used in typesetting since the 1500s when an unknown printer scrambled a passage of Cicero to create a type specimen book. It became the standard placeholder text for the desktop publishing industry.
                - generic [ref=e1932]:
                  - button "Should I use Lorem Ipsum or real content for mockups?" [ref=e1933]
                  - region "Should I use Lorem Ipsum or real content for mockups?":
                    - generic: Use Lorem Ipsum in early design stages to focus on layout and typography decisions without content bias. Switch to real content before final client review, because stakeholders often approve incorrect layouts when using placeholder text. The final design should always be validated with actual content, as real text has different lengths and patterns that may reveal layout issues not apparent with Lorem Ipsum.
                - generic [ref=e1939]:
                  - button "What is the difference between paragraphs, sentences, and words mode?" [ref=e1940]
                  - region "What is the difference between paragraphs, sentences, and words mode?":
                    - generic: Paragraphs mode generates full blocks of text with 4-8 sentences each, suitable for article body and page layout mockups. Sentences mode generates individual sentences without grouping, suitable for card components, tooltips, and captions. Words mode generates a specific number of words without sentence structure, suitable for headlines, button labels, and short UI text elements.
                - generic [ref=e1946]:
                  - button "What does the HTML output option do?" [ref=e1947]
                  - region "What does the HTML output option do?":
                    - generic: "HTML output wraps each paragraph in p tags: the text becomes paragraph content paragraph. This lets you paste directly into HTML files, CMS editors like WordPress, or React components without manually adding markup. Without HTML mode, the output is plain text with line breaks between paragraphs."
                - generic [ref=e1953]:
                  - button "Is Lorem Ipsum Latin? Does it mean anything?" [ref=e1954]
                  - region "Is Lorem Ipsum Latin? Does it mean anything?":
                    - generic: Lorem Ipsum is derived from Latin but is deliberately scrambled to be meaningless. The original Cicero passage discusses the nature of good and evil in philosophy. The standard Lorem ipsum passage starting text was extracted, altered, and randomized so it reads as authentic-looking Latin while conveying no actual meaning, preventing readers from being influenced by the content during design review.
          - generic [ref=e1962]:
            - generic [ref=e1963]: "Share:"
            - link "Share on Twitter / X" [ref=e1964] [cursor=pointer]:
              - /url: https://twitter.com/intent/tweet?text=Tool%20%E2%80%94%20Free%20Online%20Tool%20%7C%20Toolzium&url=https%3A%2F%2Ftoolzium.com%2Ftools%2Ftext%2Florem-ipsum
            - link "Share on Facebook" [ref=e1965] [cursor=pointer]:
              - /url: https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Ftoolzium.com%2Ftools%2Ftext%2Florem-ipsum
            - link "Share on LinkedIn" [ref=e1966] [cursor=pointer]:
              - /url: https://www.linkedin.com/sharing/share-offsite/?url=https%3A%2F%2Ftoolzium.com%2Ftools%2Ftext%2Florem-ipsum
            - button "Copy link" [ref=e1967]
  - alert [ref=e1968]
```
